package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_380:IRoomObject;
      
      private var var_784:IGraphicAssetCollection;
      
      protected var var_506:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_218 != null)
         {
            ...
            {
               _loc1_ = this.var_218[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_784.removeReference();
         }
         this.var_784 = param1;
         if(this.var_784 != null)
         {
            this.var_784.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_218.length > param1)
         {
            _loc2_ = this.var_218[this.var_218.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
