package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      private var var_683:IRoomObjectEventHandler;
      ...
      {
         this.var_1965.assign(this.var_107);
         return this.var_1965;
      }
      
      public function getDirection() : IVector3d
      {
         this.var_1964.assign(this.var_490);
      ...
      {
         if(param1 == this.var_683)
         {
            return;
         }
         var _loc2_:IRoomObjectEventHandler = this.var_683;
         if(_loc2_ != null)
         {
            this.var_683 = null;
            _loc2_.object = null;
