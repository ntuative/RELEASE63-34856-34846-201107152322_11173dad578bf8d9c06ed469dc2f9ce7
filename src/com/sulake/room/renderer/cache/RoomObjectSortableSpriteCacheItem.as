package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectSortableSpriteCacheItem
   {
      ...
      private var var_2968:int = -1;
      
      private var var_2969:int = -1;
      ...
      {
         if(param1 != this.var_2968 || param2 != this.var_2969)
         {
            this.var_2968 = param1;
            this.var_2969 = param2;
            return true;
         }
         return false;
      }
      ...
      public function setSpriteCount(param1:int) : void
      {
         ...
         if(param1 < this.var_218.length)
         {
            ...
            this.var_218.splice(param1,this.var_218.length - param1);
         }
