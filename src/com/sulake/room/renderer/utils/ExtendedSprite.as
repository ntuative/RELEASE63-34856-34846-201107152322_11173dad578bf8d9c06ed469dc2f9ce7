package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1626:int = 128;
      
      private var var_1625:Boolean = false;
      
      private var var_3090:Point;
      ...
      {
         if(param1 != this.var_2025 || param2 != this.var_2026)
         {
      ...
      {
         if(this.var_1626 > 255 || bitmapData == null)
         {
            return false;
         }
