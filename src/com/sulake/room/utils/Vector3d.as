package com.sulake.room.utils
{
   public class Vector3d implements IVector3d
   {
      ...
      public function get length() : Number
      {
         ...
         {
            this._length = Math.sqrt(this._x * this._x + this.var_187 * this.var_187 + this.var_186 * this.var_186);
         }
         return this._length;
      }
      ...
      {
         this._x = -this._x;
         this.var_187 = -this.var_187;
         this.var_186 = -this.var_186;
      }
      ...
      {
         return "(" + [this._x,this.var_187,this.var_186].join(",") + ")";
      }
   }
}
