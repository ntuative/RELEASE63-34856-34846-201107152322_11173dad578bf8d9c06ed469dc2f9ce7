package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_663:Number = 64;
      
      public static const const_1285:Number = 32;
      ...
      private var var_487:Number = 1.0;
      
      private var var_486:Number = 1.0;
      
      private var var_2150:Number = 1.0;
      
      private var var_2149:Number = 1.0;
      ...
      private var var_3096:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_488 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1364 = new Vector3d();
         this.var_2150 = 1;
         this.var_2149 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_2151 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_488.assign(this.var_107);
         this.var_488.x *= this.var_489;
         this.var_488.y *= this.var_487;
         this.var_488.z *= this.var_486;
         return this.var_488;
      }
      ...
      {
         if(this.var_489 != param1 * this.var_2150)
         {
            this.var_489 = param1 * this.var_2150;
            ++this.var_188;
         }
      }
      ...
      {
         if(this.var_487 != param1 * this.var_2149)
         {
            this.var_487 = param1 * this.var_2149;
            ++this.var_188;
         }
      }
      ...
      {
         if(this.var_486 != param1 * this.var_2151)
         {
            this.var_486 = param1 * this.var_2151;
            ++this.var_188;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_107.x /= this.var_489;
         this.var_107.y /= this.var_487;
         this.var_107.z /= this.var_486;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_490.x;
         var _loc3_:Number = this.var_490.y;
         var _loc4_:Number = this.var_490.z;
         this.var_490.assign(param1);
         this._direction.assign(param1);
         if(this.var_490.x != _loc2_ || this.var_490.y != _loc3_ || this.var_490.z != _loc4_)
         {
            ++this.var_188;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1365.assign(this.var_186);
         }
         else
         {
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_589 != null)
         {
            ...
            this.var_589.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_589.add(_loc3_,_loc4_);
            ++this.var_188;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_589 != null)
         {
            ...
            return this.var_589.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1364.assign(_loc22_);
         }
         else
         {
            this.var_1364.assign(_loc17_);
         }
         ++this.var_188;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= this.var_487;
         _loc2_.z *= this.var_486;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1364);
         if(_loc3_ < this.var_3097 || _loc3_ > this.var_3096)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_487;
            _loc2_.z *= this.var_486;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1364);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_107.x * this.var_489,this.var_107.y * this.var_487,this.var_107.z * this.var_486);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_186;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_489,param2.y * this.var_487,param2.z * this.var_486);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_489,param3.y * this.var_487,param3.z * this.var_486);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_489,param4.y * this.var_487,param4.z * this.var_486);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1285;
         }
         else
         {
            this.scale = const_663;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_663;
      }
