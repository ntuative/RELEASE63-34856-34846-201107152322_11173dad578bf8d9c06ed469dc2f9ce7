package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_708:Map = new Map();
      
      private static const const_391:Map = new Map();
      
      private static var var_1322:Boolean = false;
      ...
      {
         return const_708.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1322)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_708.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1322 = true;
         }
