package com.sulake.core.utils.debug
{
   ...
   public class GarbageMonitor implements IDisposable
   {
      ...
      private var var_1020:Dictionary;
      
      public function GarbageMonitor()
      {
         super();
         this.var_1020 = new Dictionary(true);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for each(_loc1_ in this.var_1020)
            {
      ...
      {
         this.var_1020[param1] = param2 == null ? param1.toString() : param2;
      }
      ...
      public function get list() : Array
      {
         ...
         for each(_loc2_ in this.var_1020)
         {
            _loc1_.push(_loc2_);
         }
         return _loc1_;
