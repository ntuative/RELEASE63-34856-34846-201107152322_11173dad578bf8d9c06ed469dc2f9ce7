package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2056:uint = 1;
      
      protected static const const_2053:uint = 2;
      
      protected static const const_2055:uint = 4;
      
      protected static const const_2054:uint = 3;
      
      protected static const name_5:uint = 7;
      
      public static const const_2025:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1311:Boolean = false;
      
      public static const const_1814:int = 2;
      
      private static var var_1071:Array = new Array();
      
      private static var var_856:Array = new Array();
      ...
      protected var var_630:Class;
      
      protected var var_513:uint = 0;
      ...
      protected var var_1149:Boolean = false;
      
      protected var var_3055:String = "";
      
      protected var var_3057:String = "";
      ...
      protected var var_3056:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1311)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_856[_loc2_] as LibraryLoader;
            ...
            while(var_856.length < const_1814 && false)
            {
               _loc1_ = var_1071.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1148 ? uint(this.var_1419 - this.var_2261) : uint(getTimer() - this.var_2261);
      }
      ...
      {
         if(this.var_1149 && !_disposed)
         {
            this.var_1149 = false;
            if(!this.var_1148 && this.var_268)
            {
               this.var_1419 = -1;
               this.var_2261 = getTimer();
               queue(this);
            }
         }
      }
      ...
      protected function retry() : Boolean
      {
         if(!this.var_1148 && !_disposed && this.var_1418 > 0)
         {
            ...
            this.addRequestCounterToUrlRequest(this.var_268,const_2025 - this.var_1418);
            if(this.var_3056)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_513 = LibraryLoader.name_5;
         ...
         if(this.var_513 == LibraryLoader.const_2054)
         {
         ...
         if(this.var_513 == LibraryLoader.name_5)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_630 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_630.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
