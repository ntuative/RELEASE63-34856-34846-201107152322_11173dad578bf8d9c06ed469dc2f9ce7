package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1295:String = "AssetLibraryReady";
      
      public static const const_995:String = "AssetLibraryLoaded";
      
      public static const const_1773:String = "AssetLibraryUnloaded";
      
      public static const const_2022:String = "AssetLibraryLoadError";
      
      private static const const_682:String = "name";
      
      private static const const_1051:String = "asset";
      
      private static const const_1049:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1050:String = "library";
      
      private static var var_320:Dictionary;
      
      private static var var_1774:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_530:uint = 0;
      
      private static var var_970:Array = new Array();
      ...
      private var var_630:Class;
      
      private var var_971:Dictionary;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_529 = new Dictionary(false);
         this.var_971 = new Dictionary(false);
         this.var_171 = new Dictionary(false);
         var_970.push(this);
      }
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_631 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1050);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1051);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_682);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1049);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_631 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_970.splice(var_970.indexOf(this),1);
            --var_530;
            this.var_529 = null;
            this.var_971 = null;
            this.var_171 = null;
      ...
      {
         if(this.var_631 == param1.url && this.var_969)
         {
            if(!this.var_972 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_630);
            }
            this.var_972 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1295));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_529)
         {
            _loc2_ = this.var_529[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_529[_loc1_];
         }
         for(_loc1_ in this.var_171)
         {
            delete this.var_171[_loc1_];
         }
         for(_loc1_ in this.var_971)
         {
            delete this.var_971[_loc1_];
         }
         if(this.var_44 != null)
         {
            this.var_44.dispose();
         ...
         this.var_969 = false;
         this.var_631 = null;
         dispatchEvent(new Event(AssetLibrary.const_1773));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_971[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_529[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1314,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1171,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1365,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1364,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_529[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_529[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_171[struct.assetName] == null)
                  {
                     ++this.var_440;
                     this.var_441.push(struct.assetName);
                  }
                  this.var_171[struct.assetName] = asset;
               }
               else
               {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_529[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_171[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_441.length ? this.getAssetByName(this.var_441[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_171)
         {
            if(this.var_171[_loc2_] == param1)
            {
               return this.var_441.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_171[param1] != null || (this.var_630 != null ? this.var_630[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_171[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            ...
            this.var_171[param1] = param2;
            if(param2 is ILazyAsset)
            {
               var_1774.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_171)
            {
               if(this.var_171[_loc2_] == param1)
               {
                  this.var_441.splice(this.var_441.indexOf(_loc2_),1);
                  delete this.var_171[_loc2_];
                  --this.var_440;
                  return param1;
               }
            }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_320.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_320[param1.mimeType] = param1;
         }
         else
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_320[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_320)
            {
               _loc3_ = AssetTypeDeclaration(var_320[_loc4_]);
               if(_loc3_ != null)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_320)
            {
               _loc4_ = AssetTypeDeclaration(var_320[_loc5_]);
               if(_loc4_ != null)
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_630 = _loc2_.resource;
         this.var_631 = _loc2_.url;
         if(this.var_972)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_630);
         }
         this.var_969 = true;
         dispatchEvent(new Event(AssetLibrary.const_995));
         dispatchEvent(new Event(AssetLibrary.const_1295));
         if(this.var_972)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_2022));
         this.var_44 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1050);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1051);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_682) && _loc3_.attribute(const_682).toString() == param1)
                  {
                     _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_631 + "!");
                     }
                     _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_630[param1]);
                     _loc6_ = _loc3_.child(const_1049);
