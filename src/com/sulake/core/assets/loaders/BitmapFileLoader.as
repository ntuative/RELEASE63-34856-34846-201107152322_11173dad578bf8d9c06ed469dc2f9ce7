package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1144 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_44 = new Loader();
         this.var_1145 = new LoaderContext();
         this.var_1145.checkPolicyFile = true;
         ...
         {
            this.var_44.load(param2,this.var_1145);
         }
      }
      ...
      {
         this.var_1144 = param1.url;
         var_362 = 0;
         this.var_44.load(param1,this.var_1145);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_362 < var_3054)
            {
               ...
               this.var_44.load(new URLRequest(this.var_1144 + (this.var_1144.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_362),this.var_1145);
               return true;
            }
         }
         return false;
