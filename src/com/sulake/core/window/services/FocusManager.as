package com.sulake.core.window.services
{
   ...
   public class FocusManager extends ChildEntityArrayReader implements IFocusManagerService
   {
      ...
      private var var_158:Stage;
      
      public function FocusManager(param1:DisplayObject)
      {
         this.var_158 = param1.stage;
         this.var_158.addEventListener(Event.ACTIVATE,this.onActivateEvent);
         this.var_158.addEventListener(FocusEvent.FOCUS_OUT,this.onFocusEvent);
         this.var_158.addEventListener(FocusEvent.KEY_FOCUS_CHANGE,this.onFocusEvent);
         this.var_158.addEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.onFocusEvent);
         super();
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            this.var_158.removeEventListener(Event.ACTIVATE,this.onActivateEvent);
            this.var_158.removeEventListener(FocusEvent.FOCUS_OUT,this.onFocusEvent);
            this.var_158.removeEventListener(FocusEvent.KEY_FOCUS_CHANGE,this.onFocusEvent);
            this.var_158.removeEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.onFocusEvent);
            this.var_158 = null;
            this._disposed = true;
            var_34 = null;
         }
