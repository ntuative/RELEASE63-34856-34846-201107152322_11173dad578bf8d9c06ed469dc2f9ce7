package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1327:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1418:String = "_COLORIZE";
      
      protected static const const_1417:String = "_IGNORE_INHERITED_STYLE";
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_413 = new Rectangle();
         if(_loc12_ != null)
         {
            var_429 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_68 = var_429.clone();
            var_10 = var_429.clone();
      ...
      {
         return this.var_758 != null ? this.var_758 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_10,WindowRedrawFlag.const_1257);
      }
      ...
      {
         var_509 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_10,WindowRedrawFlag.const_942);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_92)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1417) == -1)
               {
                  _loc4_.style = var_92;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_413 = this._parent.rectangle.clone();
               var_68.x = var_10.x;
               var_68.y = var_10.y;
               var_68.width = var_10.width;
               var_68.height = var_10.height;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_571,this,this._parent);
            ...
            else
            {
               this.var_413.x = 0;
               this.var_413.y = 0;
               this.var_413.width = 0;
               this.var_413.height = 0;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1948,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_780,var_10);
            this.var_21.visible = var_339;
         }
         return this.var_21;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_92,var_20,_context,var_10,null,this.var_758,this.properties,var_933.concat(),_id) as WindowController;
         _loc2_.var_509 = var_509;
         _loc2_.var_193 = this.var_193;
         _loc2_._debug = this._debug;
         _loc2_.var_413 = this.var_413.clone();
         _loc2_.var_10 = var_10.clone();
         _loc2_.var_429 = var_429.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + _name + " " + this.var_2871 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_602)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_600)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_20 & 0);
            if(_loc7_ == WindowParam.const_582)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_491)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1194,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_431,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param3 != null && var_168 != null)
         {
            param3.x = var_168.x;
            param3.y = var_168.y;
            param3.width = var_168.width;
            param3.height = var_168.height;
         }
         if(param4 != null && var_169 != null)
         {
            param4.x = var_169.x;
            param4.y = var_169.y;
            param4.width = var_169.width;
            param4.height = var_169.height;
         }
      }
      ...
      public function setRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null) : void
      {
         if(param3 != null)
         {
            ...
            var_169.x = param3.x;
            var_169.y = param3.y;
            var_169.width = param3.width;
            var_169.height = param3.height;
         }
         if(param2 != null)
         {
            ...
            var_168.x = param2.x;
            var_168.y = param2.y;
            var_168.width = param2.width;
            var_168.height = param2.height;
         }
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = 0;
         if(!testParamFlag(WindowParam.const_992))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_46:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1309;
                  if(testParamFlag(WindowParam.const_455))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                  ...
                  if((var_20 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_381))
                        {
               ...
               case WindowMouseEvent.const_56:
                  ...
                  if(testParamFlag(WindowParam.const_381))
                  {
                     _context.getWindowServices().getMouseScalingService().end(this);
                  }
                  break;
               case WindowMouseEvent.const_25:
                  if(testStateFlag(WindowState.const_94))
                  {
         ...
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_40:
                  ...
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_586,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_212,WindowParam.const_190))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_204,WindowParam.const_186))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc7_ = uint(var_20);
                        var_20 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_614))
                        {
                           this._parent.width += 0 - 0;
                        }
                        if(testParamFlag(WindowParam.const_541))
                        {
                           this._parent.height += 0 - 0;
                        }
                        var_20 = _loc7_;
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_159,this._parent,this);
               ...
               case WindowEvent.const_431:
                  ...
                  _context.invalidate(this,_loc6_,WindowRedrawFlag.const_1273);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1750,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_224,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_548:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1304,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_370,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
               ...
               case WindowEvent.const_571:
                  ...
                  _context.invalidate(this,var_10,WindowRedrawFlag.const_62);
                  break;
               case WindowEvent.const_586:
                  this._parent.getRegionProperties(null,this.var_413);
                  this.updateScaleRelativeToParent();
                  break;
               case WindowEvent.const_603:
               ...
               case WindowEvent.const_449:
                  break;
               case WindowEvent.const_370:
                  this.activate();
                  break;
               case WindowEvent.const_159:
                  if(testParamFlag(WindowParam.WINDOW_PARAM_RESIZE_TO_ACCOMMODATE_CHILDREN))
                  {
                     expandToAccommodateChild(this,param2.related);
                  }
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_509);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_509);
      }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_92 != _loc3_)
         {
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1417) == -1)
               {
                  _loc6_.style = var_92;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_168,WindowParam.const_190);
         var _loc2_:* = !testParamFlag(WindowParam.const_179,WindowParam.const_186);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_10.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_413.width;
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.const_454)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_413)
               {
                  _loc3_.x += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_212)
               {
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_413.height;
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.const_375)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_294)
               {
                  _loc3_.y += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_204)
               {
      ...
      {
         if(_state == WindowState.const_534)
         {
            return true;
         }
         _state = WindowState.const_534;
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1947,this,null);
      ...
      public function minimize() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1792,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function maximize() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_74,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1812,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_2019,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1851,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_548,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1869,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_500,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1844,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_74,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1964,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_74,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1842,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_902,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_289,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_848,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_262,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         if(this.getStateFlag(WindowState.const_90))
         {
            return true;
         }
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_359,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1764,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1328 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_603,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1328 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_603,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_449,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
