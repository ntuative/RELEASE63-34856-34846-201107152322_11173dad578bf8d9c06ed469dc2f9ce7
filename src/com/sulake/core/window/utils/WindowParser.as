package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_2242:String = "_INCLUDE";
      
      public static const const_2234:String = "_TEMP";
      
      private static const const_1652:String = "layout";
      
      private static const const_1130:String = "window";
      
      private static const const_1129:String = "variables";
      
      private static const const_1131:String = "filters";
      
      private static const const_682:String = "name";
      
      private static const const_1658:String = "style";
      
      private static const const_713:String = "params";
      
      private static const const_1654:String = "tags";
      ...
      private static const const_1648:String = "visible";
      
      private static const const_1659:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1257:String = "blend";
      
      private static const const_1655:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1653:String = "treshold";
      
      private static const const_1656:String = "children";
      
      private static const const_1649:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1650:String = "height_min";
      
      private static const const_1651:String = "height_max";
      ...
      private static const const_1660:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1647:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1429:Dictionary;
      
      protected var var_1428:Dictionary;
      
      protected var var_1152:Dictionary;
      
      protected var var_1715:Dictionary;
      
      protected var var_2269:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1429 = new Dictionary();
         this.var_1428 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1429,this.var_1428);
         this.var_1152 = new Dictionary();
         this.var_1715 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1152,this.var_1715);
         this.var_2269 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1647,const_50);
         return param1.replace(const_1660,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1429)
            {
               delete this.var_1429[_loc1_];
            }
            for(_loc1_ in this.var_1428)
            {
               delete this.var_1428[_loc1_];
            }
            for(_loc1_ in this.var_1152)
            {
               delete this.var_1152[_loc1_];
            }
            for(_loc1_ in this.var_1715)
            {
               delete this.var_1715[_loc1_];
            }
            this.var_2269.dispose();
            this.var_2269 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1652)
         {
            _loc8_ = param1.child(const_1129);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1131).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1130);
         ...
         if(param1.localName() == const_1130)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1429[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_682,variables,"")));
         style = uint(this.parseAttribute(xml,const_1658,variables,style));
         params = uint(this.parseAttribute(xml,const_713,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1654,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1648,variables,visible.toString()) == const_714;
         ...
         if(xml.child(const_713).length() > 0)
         {
            ...
            {
               node = list[i];
               param = this.parseAttribute(node,const_682,variables,"") as String;
               if(this.var_1152[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_682)) + "\"!");
               }
         ...
         caption = unescape(String(this.parseAttribute(xml,const_1659,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1456);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1129)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1649,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1650,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1651,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_714;
         blend = Number(this.parseAttribute(xml,const_1257,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1655,variables,window.clipping.toString()) == const_714;
         ...
         list = xml.child(const_1131).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_212)
                     {
                        window.x = rect.x;
                     }
                     if((params & 0) == WindowParam.const_204)
                     {
                        window.y = rect.y;
                     }
                  }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1428[param1.type];
