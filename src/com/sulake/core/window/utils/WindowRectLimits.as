package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      {
         this.var_325 = param1;
         if(this.var_325 > int.MIN_VALUE && !this._target.disposed && this._target.width < this.var_325)
         {
            this._target.width = this.var_325;
         }
      }
      ...
      {
         this.var_324 = param1;
         if(this.var_324 < int.MAX_VALUE && !this._target.disposed && this._target.height > this.var_324)
         {
            this._target.height = this.var_324;
         }
      }
      
      public function get isEmpty() : Boolean
      {
         return this.var_325 == int.MIN_VALUE && this.var_326 == int.MAX_VALUE && this.var_323 == int.MIN_VALUE && this.var_324 == int.MAX_VALUE;
      }
      ...
      public function limit() : void
      {
         ...
         {
            if(this._target.width < this.var_325)
            {
               this._target.width = this.var_325;
            }
            ...
            else if(this._target.height > this.var_324)
            {
               this._target.height = this.var_324;
            }
         }
