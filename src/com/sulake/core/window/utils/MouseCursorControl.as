package com.sulake.core.window.utils
{
   ...
   public class MouseCursorControl
   {
      ...
      private static var var_339:Boolean = true;
      ...
      private static var var_1602:Dictionary = new Dictionary();
            ...
            else
            {
               ...
               switch(_type)
               {
                  ...
                  case MouseCursorType.ARROW:
                     ...
                     break;
                  case MouseCursorType.const_323:
                     Mouse.cursor = MouseCursor.BUTTON;
                     break;
                  case MouseCursorType.const_985:
                  case MouseCursorType.const_309:
                  case MouseCursorType.const_2005:
