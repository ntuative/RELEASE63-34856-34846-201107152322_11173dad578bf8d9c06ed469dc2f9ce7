package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_757:Point;
      
      protected var var_192:WindowController;
      
      protected var var_71:WindowController;
      
      protected var var_177:IWindowRenderer;
      
      protected var var_96:IDesktopWindow;
      
      protected var var_937:IWindowContextStateListener;
      ...
      {
         super();
         this.var_757 = new Point();
         if(var_366 == null)
         {
            var_366 = new Array();
            var_366[0] = MouseCursorType.const_323;
            var_366[1] = MouseCursorType.const_31;
            var_366[2] = MouseCursorType.const_323;
            var_366[3] = MouseCursorType.const_323;
            var_366[4] = MouseCursorType.const_323;
            var_366[5] = MouseCursorType.const_31;
            var_366[6] = MouseCursorType.const_323;
         }
         if(var_318 == null)
         {
            var_318 = new Array();
            var_318[0] = WindowState.const_89;
            var_318[1] = WindowState.const_90;
            var_318[2] = WindowState.const_94;
            var_318[3] = WindowState.const_74;
            var_318[4] = WindowState.const_57;
            var_318[5] = WindowState.const_95;
            var_318[6] = WindowState.const_92;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_291;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_192 = state.var_1409 as WindowController;
         this.var_177 = state.renderer;
         this.var_937 = state.var_1411;
         eventQueue.begin();
         this.var_757.x = -1;
         this.var_757.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_757.x || event.stageY != this.var_757.y)
            {
               this.var_757.x = event.stageX;
               this.var_757.y = event.stageY;
               array = new Array();
               this.var_96.groupParameterFilteredChildrenUnderPoint(this.var_757,array,WindowParam.const_30);
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_71 && !this.var_71.disposed)
                     {
                        ...
                        {
                           this.var_937.mouseEventReceived(event.type,this.var_71);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1409 = this.var_192;
         state.renderer = this.var_177;
         state.var_1411 = this.var_937;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         var _loc5_:BitmapData = this.var_177.getDrawBufferForRenderable(param1);
         if(!param1.validateLocalPointIntersection(_loc4_,_loc5_))
         {
            return null;
         }
         if(param1.testParamFlag(WindowParam.const_503))
         {
