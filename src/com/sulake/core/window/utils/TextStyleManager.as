package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_97:Map;
      
      private static var var_536:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_688:String = "{";
      
      private static const const_689:String = "}";
      
      private static const const_1471:String = "/*";
      
      private static const const_1470:String = "*/";
      ...
      {
         return var_97.getWithIndex(param1);
      }
      
      public static function setStyle(param1:String, param2:TextStyle) : void
      {
         var _loc3_:* = var_97.getKeys().indexOf(param1) == -1;
         param2.name = param1;
         var_97[param1] = param2;
         if(_loc3_)
         {
            var_536.push(param1);
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_97[const_210],var_97[ITALIC],var_97[BOLD]];
            var_97.reset();
            var_97[const_210] = _loc5_[0];
            var_97[ITALIC] = _loc5_[1];
            var_97[BOLD] = _loc5_[2];
         }
         var _loc3_:int = 0;
         for each(_loc4_ in param1)
         {
            var_97[_loc4_.name] = _loc4_;
      ...
      public static function enumerateStyles() : Array
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_.push(var_97.getWithIndex(_loc3_));
            _loc3_++;
         }
         return _loc1_;
      }
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_689);
         if(countSubStrings(param1,const_688) != countSubStrings(param1,const_689))
         {
            throw new Error("Mismatching amount of \"" + const_688 + "\" versus \"" + const_689 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1471) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1470) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_688)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
