package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_429:Rectangle;
      ...
      protected var var_509:uint = 10;
      
      protected var var_751:Boolean = true;
      
      protected var var_339:Boolean = true;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this.var_92 = param4;
         this.var_933 = param8 == null ? new Array() : param8;
         this._context = param6;
         this.var_10 = param7.clone();
         this.var_429 = param7.clone();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this.var_10 = null;
            this._context = null;
            this._state = WindowState.const_534;
            this.var_933 = null;
         }
      }
      ...
      {
         return this.var_429.width;
      }
      
      public function getInitialHeight() : int
      {
         return this.var_429.height;
      }
