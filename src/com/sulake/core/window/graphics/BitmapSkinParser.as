package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_90:String = "focused";
      
      public static const const_94:String = "hovering";
      
      public static const const_57:String = "selected";
      
      public static const const_95:String = "pressed";
      
      public static const const_92:String = "disabled";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_359 = SkinLayoutEntity.const_592;
                  break;
               case "move":
                  _loc5_.var_359 = SkinLayoutEntity.const_351;
                  break;
               case "strech":
                  _loc5_.var_359 = SkinLayoutEntity.const_654;
                  break;
               case "tiled":
                  _loc5_.var_359 = SkinLayoutEntity.const_365;
                  break;
               case "center":
            ...
            {
               case "fixed":
                  _loc5_.var_358 = SkinLayoutEntity.const_592;
                  break;
               case "move":
                  _loc5_.var_358 = SkinLayoutEntity.const_351;
                  break;
               case "strech":
                  _loc5_.var_358 = SkinLayoutEntity.const_654;
                  break;
               case "tiled":
                  _loc5_.var_358 = SkinLayoutEntity.const_365;
                  break;
               case "center":
                  _loc5_.var_358 = SkinLayoutEntity.const_594;
            }
         }
