package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1953:uint = 0;
      
      public static const const_780:uint = 1;
      
      public static const const_1205:uint = 2;
      
      public static const const_920:uint = 4;
      
      public static const const_1745:uint = 8;
      
      public static const const_1755:uint = 16;
      
      public static const const_2183:uint = 64;
      
      public static const const_2250:uint = 128;
      
      public static const const_1263:uint = 256;
         ...
         if(this.var_932)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2252,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2252,16777215);
                  }
                  var_364 += bitmap.width * bitmap.height * 4;
               }
