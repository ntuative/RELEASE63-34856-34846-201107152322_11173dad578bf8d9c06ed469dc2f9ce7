package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_942:Dictionary;
      
      private var var_302:Matrix;
      ...
      public function BitmapSkinRenderer(param1:String)
      {
         ...
         this.var_942 = new Dictionary(false);
         this.var_302 = new Matrix();
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            this.var_941 = null;
            for(_loc1_ in this.var_942)
            {
               _loc2_ = this.var_942[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_942[_loc1_];
            }
            this.var_942 = null;
         }
      }
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_510[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_883.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_883.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_883.blueMultiplier = (param1.color & 255) / 255;
               this.var_883.alphaMultiplier = 1;
            }
            _loc17_ = 0;
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_883);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_359 == SkinLayoutEntity.const_351)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_359 == SkinLayoutEntity.const_654)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_359 == SkinLayoutEntity.const_365)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.var_359 == SkinLayoutEntity.const_594)
                  {
                     REGION.x = param3.width / 2 - 0;
                  }
                  if(_loc10_.var_358 == SkinLayoutEntity.const_351)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_358 == SkinLayoutEntity.const_654)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_358 == SkinLayoutEntity.const_365)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_358 == SkinLayoutEntity.const_594)
                  {
                  ...
                  else if(_loc10_.var_358 == SkinLayoutEntity.const_365 || _loc10_.var_359 == SkinLayoutEntity.const_365)
                  {
                  ...
                  {
                     this.var_302.a = REGION.width;
                     this.var_302.d = REGION.height;
                     this.var_302.tx = REGION.x;
                     this.var_302.ty = REGION.y;
                     ALPHA.alphaMultiplier = (_loc19_.getPixel32(0,0) >>> 24) / 255;
                     _loc6_.draw(_loc18_,this.var_302,ALPHA);
                  }
                  else
                  {
                     this.var_302.a = 0 / _loc18_.width;
                     this.var_302.d = 0 / _loc18_.height;
                     this.var_302.tx = 0;
                     this.var_302.ty = 0;
                     _loc31_ = new BitmapData(REGION.width,REGION.height,_loc18_.transparent);
                     _loc31_.draw(_loc18_,this.var_302);
                     _loc32_ = new BitmapData(REGION.width,REGION.height,true,0);
                     _loc32_.draw(_loc19_,this.var_302,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_359 == SkinLayoutEntity.const_351)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_358 == SkinLayoutEntity.const_351)
               {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_942[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
