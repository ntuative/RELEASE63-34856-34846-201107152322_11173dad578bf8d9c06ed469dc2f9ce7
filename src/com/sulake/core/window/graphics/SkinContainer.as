package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1091:uint = 8;
      
      private static const const_1547:String = "skin";
      
      private static const const_1548:String = "bitmap";
      
      private static const const_1546:String = "fill";
      
      private static const const_1543:String = "text";
      
      private static const const_1545:String = "label";
      
      private static const const_1544:String = "shape";
      
      private static const RENDERER_TYPE_UNKNOWN:String = "unknown";
      
      private static const RENDERER_TYPE_NULL:String = "HabboRoomUICom_badge_details";
      ...
      private var var_1928:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1928 = new Dictionary();
         this.var_2625 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1928,this.var_2625);
         this.var_2626 = new Dictionary();
         this.var_2624 = new Dictionary();
         StateCodeTable.fillTables(this.var_2626,this.var_2624);
         this.var_460 = new Dictionary();
         this.var_460[const_1547] = BitmapSkinRenderer;
         this.var_460[const_1548] = BitmapDataRenderer;
         this.var_460[const_1546] = FillSkinRenderer;
         this.var_460[const_1543] = TextSkinRenderer;
         this.var_460[const_1545] = LabelRenderer;
         this.var_460[const_1544] = ShapeSkinRenderer;
         this.var_460[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_460[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_365 == null)
         {
            var_365 = new Array();
            var_365.push(WindowState.const_74);
            var_365.push(WindowState.const_92);
            var_365.push(WindowState.const_95);
            var_365.push(WindowState.const_57);
            var_365.push(WindowState.const_94);
            var_365.push(WindowState.const_90);
            var_365.push(WindowState.const_89);
         ...
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_3043 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1928[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_1026[param1] = new Array(const_1091);
         }
         this.var_1026[param1][param2] = param3;
         if(this.var_1027[param1] == null)
         {
            this.var_1027[param1] = new Array(const_1091);
         }
