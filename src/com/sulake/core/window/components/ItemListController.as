package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2264:int = 0;
      
      protected var var_2263:int = 0;
      
      protected var var_1426:Number;
      
      protected var var_1427:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_126 = 0;
         this.var_108 = 0;
         this._horizontal = param2 == WindowType.const_442;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_193 = var_508 || !testParamFlag(WindowParam.const_33);
         this._container = _context.create("_CONTAINER","",WindowType.const_434,WindowStyle.const_101,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_159,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_224,this.containerEventHandler);
      ...
      {
         return new Rectangle(this.var_753 * this.maxScrollH,this.var_755 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_753 = param1;
            this._container.x = -this.var_753 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_62);
            _loc2_ = WindowEvent.allocate(WindowEvent.const_591,this,null);
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_614,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_541,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_159,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_224,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_46:
               this.var_2264 = _loc3_;
               this.var_2263 = _loc4_;
               this.var_1426 = 0;
               this.var_1427 = 0;
               this.var_1425 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_200:
               if(this.var_1425)
               {
                  this.var_1426 = this.var_2264 - _loc3_;
                  this.var_1427 = this.var_2263 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1426 != 0 && this.var_126 != 0)
                     {
                        this.scrollH += this.var_1426 / this.var_126;
                     }
                  }
                  else if(this.var_1427 != 0 && this.var_108 != 0)
                  {
                     this.scrollV += this.var_1427 / this.var_108;
                  }
                  this.var_2264 = _loc3_;
                  this.var_2263 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_291:
               if(this.var_1425)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1426,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1427);
                  }
                  this.var_1425 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1151 && !this.var_609 && this._container)
         {
            this.var_609 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_846)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_444,this._spacing,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1203);
         }
         if(this.var_1151 != PropertyDefaults.const_1241)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_785,this.var_1151,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1856);
         }
         if(this.var_515 != PropertyDefaults.const_1352)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_746,this.var_515,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1905);
         }
         if(this.var_1424 != PropertyDefaults.const_1260)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_1000,this.var_1424,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1965);
         }
         if(this.var_756 != PropertyDefaults.const_1242)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_1030,this.var_756,PropertyStruct.const_138,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1934);
         }
         if(this.var_754 != PropertyDefaults.const_1224)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_763,this.var_754,PropertyStruct.const_138,true));
         }
         else
         {
