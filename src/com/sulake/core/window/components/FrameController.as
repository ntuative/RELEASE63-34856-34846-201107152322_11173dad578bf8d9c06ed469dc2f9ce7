package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1626:String = "_TITLE";
      
      private static const const_1629:String = "_HEADER";
      
      private static const const_1627:String = "_CONTENT";
      
      private static const const_1628:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1646:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1626) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1646 = findChildByTag(const_1629) as IHeaderWindow;
            if(!this.var_1646)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_209 = findChildByTag(const_1627) as IWindowContainer;
            if(!this.var_209)
            {
      ...
      {
         return findChildByTag(const_1628) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1418,_loc2_,false);
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_381);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_302);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_269);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_302,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_302,false);
            }
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_269,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_269,false);
            }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_353,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_307,_loc3_.left,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_303,_loc3_.top,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_260,0 - _loc3_.right,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_312,0 - _loc3_.bottom,PropertyStruct.const_37,_loc2_));
         return _loc1_;
      }
