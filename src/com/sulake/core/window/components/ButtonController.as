package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_1423:Number = 0.5;
         ...
         if(event is WindowEvent)
         {
            switch(event.type)
            {
               case WindowEvent.const_159:
                  width = 0;
                  break;
               case WindowEvent.const_289:
                  try
                  {
                     getChildByName(const_468).blend = getChildByName(const_468).blend + const_1423;
                  }
                  catch(e:Error)
                  {
                  }
         ...
         else if(event is WindowTouchEvent)
         {
            ...
            switch(event.type)
            {
               ...
               case WindowTouchEvent.const_1214:
                  type = "null";
                  break;
               case WindowTouchEvent.const_803:
                  type = "null";
            }
