package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1010:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_812:String;
      
      private var var_1229:String = null;
      
      private var var_1893:StyleSheet = null;
      ...
      {
         this.var_812 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1229 == param2)
         {
            return;
         }
         param1.var_1229 = param2;
         param1.var_1893 = null;
         if(param1.var_1229 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1229);
            param1.var_1893 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_871.indexOf(param1) > -1)
         {
            this.var_812 = param1;
         }
      }
      ...
      {
         return this.var_812 == LinkTarget.const_31 ? defaultLinkTarget : this.var_812;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1893;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1253)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_812 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_827,this.var_812,PropertyStruct.const_51,true,PropertyDefaults.const_871));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1893);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_827)
            {
