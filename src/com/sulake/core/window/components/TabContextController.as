package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1676:String = "_SELECTOR";
      
      private static const const_1677:String = "_CONTENT";
       
      
      protected var var_1153:ITabSelectorWindow;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1153 = findChildByTag(const_1676) as ITabSelectorWindow;
            if(this.var_1153 != null)
            {
               this.var_1153.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2270 = findChildByTag(const_1677) as IWindowContainer;
         }
      ...
      {
         return !!this.var_800 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1153.numSelectables;
      }
