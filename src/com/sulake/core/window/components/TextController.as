package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1416:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_936:Number;
      
      protected var var_608:Number;
      
      protected var var_607:Boolean;
      
      protected var var_42:TextMargins;
      
      protected var _autoSize:String = "none";
      
      protected var var_149:Boolean = false;
      
      protected var var_1150:Boolean = false;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_481,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_481 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_481,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_1022 ? true : null;
         }
      ...
      {
         this.var_936 = param1;
         this._field.scrollH = this.var_936 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_936 * this.maxScrollH,this.var_608 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("always_show_selection",this._field.alwaysShowSelection,PropertyStruct.const_38,this._field.alwaysShowSelection != false));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_903,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1169));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1172 ? new PropertyStruct(PropertyDefaults.const_749,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1177) : PropertyDefaults.const_1752);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_38,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_176,this._field.borderColor != 0));
         _loc1_.push(new PropertyStruct("condense_white",this._field.condenseWhite,PropertyStruct.const_38,this._field.condenseWhite != false));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_285,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1245 ? new PropertyStruct(PropertyDefaults.const_1305,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1350) : PropertyDefaults.const_1830);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_991) ? new PropertyStruct(PropertyDefaults.const_450,this._field.textColor,PropertyStruct.const_176,true) : PropertyDefaults.const_1213);
         ...
         _loc1_.push(this.var_42.left != PropertyDefaults.const_1025 ? new PropertyStruct(PropertyDefaults.const_307,this.var_42.left,PropertyStruct.const_37,true) : PropertyDefaults.const_892);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_889 ? new PropertyStruct(PropertyDefaults.const_303,this.var_42.top,PropertyStruct.const_37,true) : PropertyDefaults.const_894);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_884 ? new PropertyStruct(PropertyDefaults.const_260,this.var_42.right,PropertyStruct.const_37,true) : PropertyDefaults.const_982);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_952 ? new PropertyStruct(PropertyDefaults.const_312,this.var_42.bottom,PropertyStruct.const_37,true) : PropertyDefaults.const_824);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1232 ? new PropertyStruct(PropertyDefaults.const_1027,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1935);
         _loc1_.push(new PropertyStruct("max_chars",this._field.maxChars,PropertyStruct.const_37,this._field.maxChars != 0));
         _loc1_.push(new PropertyStruct("multiline",this._field.multiline,PropertyStruct.const_38,this._field.multiline != false));
         ...
         _loc1_.push(new PropertyStruct("word_wrap",this._field.wordWrap,PropertyStruct.const_38,this._field.wordWrap != false));
         _loc1_.push(new PropertyStruct("bold",this._field.defaultTextFormat.bold != false,PropertyStruct.const_38,this._field.defaultTextFormat.bold != false && _loc2_.fontWeight != FontStyle.BOLD));
         _loc1_.push(new PropertyStruct("italic",this._field.defaultTextFormat.italic != false,PropertyStruct.const_38,this._field.defaultTextFormat.italic != false && _loc2_.fontStyle != FontStyle.ITALIC));
         _loc1_.push(new PropertyStruct("underline",this._field.defaultTextFormat.underline != false,PropertyStruct.const_38,this._field.defaultTextFormat.underline != false && _loc2_.textDecoration != "underline"));
         _loc1_.push(new PropertyStruct("kerning",this._field.defaultTextFormat.kerning != false,PropertyStruct.const_38,this._field.defaultTextFormat.kerning != false && !_loc2_.kerning));
