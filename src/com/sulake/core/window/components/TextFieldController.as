package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1713:uint = 500;
      
      protected var var_1422:String = "";
      
      protected var var_1417:Boolean = false;
      
      protected var var_800:Boolean = false;
      ...
      {
         this.var_1422 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1205,var_10);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_800 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_185,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_445,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_18 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_378,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      private function onChangeEvent(param1:Event) : void
      {
         ...
         {
            this.refreshAutoSize();
            windowEvent = WindowEvent.allocate(WindowEvent.const_110,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_999,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1753);
         _loc1_.push(this.var_1417 != PropertyDefaults.const_1265 ? new PropertyStruct(PropertyDefaults.const_813,this.var_1417,PropertyStruct.const_38,true) : PropertyDefaults.const_1917);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1281 ? new PropertyStruct(PropertyDefaults.const_777,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1859);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1198 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1919);
         return _loc1_;
      }
