package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_370)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1304)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_940;
         if(this.var_940 != param1)
         {
            if(this.var_940 != null)
            {
               if(!this.var_940.disposed)
               {
                  this.var_940.deactivate();
               }
            }
            this.var_940 = param1;
