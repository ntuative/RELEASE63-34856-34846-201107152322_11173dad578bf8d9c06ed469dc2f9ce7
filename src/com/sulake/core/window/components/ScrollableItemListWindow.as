package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1363:IItemListWindow;
      
      private var var_485:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_92))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_485)
         {
            this.var_485.removeEventListener(WindowEvent.const_289,this.scrollBarEventProc);
            this.var_485.removeEventListener(WindowEvent.const_262,this.scrollBarEventProc);
            this.var_485 = null;
         }
         if(this.var_1363)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1363)
         {
            this.var_1363 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_485)
         {
            this.var_485 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_485)
            {
               this.var_485.addEventListener(WindowEvent.const_289,this.scrollBarEventProc);
               this.var_485.addEventListener(WindowEvent.const_262,this.scrollBarEventProc);
            }
         }
         return this.var_485;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_262)
         {
            this.hideScrollBar();
         }
      }
