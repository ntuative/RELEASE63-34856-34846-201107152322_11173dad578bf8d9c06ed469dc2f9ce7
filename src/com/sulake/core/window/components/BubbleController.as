package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2081:String = "_POINTER_UP";
      
      private static const const_2083:String = "_POINTER_DOWN";
      
      private static const const_2082:String = "_POINTER_LEFT";
      
      private static const const_2080:String = "_POINTER_RIGHT";
      ...
      public function set direction(param1:String) : void
      {
         ...
         if(param1 != this._direction)
         {
            ...
            this.pointerOffset = this.var_824;
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_965,this._direction,PropertyStruct.const_51,true));
         }
         else
         {
         ...
         if(this.var_824 != 0)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_745,this.var_824,PropertyStruct.const_37,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_965:
