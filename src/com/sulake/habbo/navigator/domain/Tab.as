package com.sulake.habbo.navigator.domain
{
   ...
   public class Tab
   {
      ...
      private var var_2974:ITabPageDecorator;
      ...
      public function Tab(param1:HabboNavigator, param2:int, param3:int, param4:ITabPageDecorator, param5:int = 1)
      {
         ...
         this.var_2974 = param4;
         this.var_2163 = param5;
      }
      
      public function sendSearchRequest() : void
      {
         this._navigator.mainViewCtrl.startSearch(this._id,this._defaultSearchType,"-1",this.var_2163);
      }
