package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_773:TextFieldManager;
      ...
      private var var_965:TextFieldManager;
      ...
      private var var_772:ICheckBoxWindow;
      
      private var var_1759:ITextWindow;
      
      private var var_964:IDropMenuWindow;
      
      private var var_963:IDropMenuWindow;
      ...
      {
         this.var_370 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_370));
         if(this.var_1172 != null)
         {
            this.var_1172.visible = false;
         }
      }
      
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         if(param1.roomId != this.var_370)
         {
            return;
         }
         this.var_56 = param1;
      ...
      {
         if(param1 != this.var_370 || this.var_1177 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1177 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1892)
         {
            this.var_773.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1831)
         {
            this.var_773.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1746)
         {
            this.var_1174.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1971)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1779)
         {
            this.var_965.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_773.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_369,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_660,this.onDoorModePasswordUnselect);
         ...
         this.var_773 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1174 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         ...
         this.var_965 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1176 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1170 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1178 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1175 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_772 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1759 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_964 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_963 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2322 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1173 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1171 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1761 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1461 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_242 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1172 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1462 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1462.mouseThreshold = 0;
         this.var_1462.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1172.visible = false;
         if(!this.var_1463)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1761.visible = this.var_1463;
         this.populateForm();
         if(this.var_774)
         {
            this.var_1171.visible = true;
            this.var_1461.visible = true;
         ...
         else
         {
            ...
            this.var_1461.visible = true;
            this.var_2322.visible = this.var_1463;
            this.var_1173.height = Util.getLowestPoint(this.var_1173) + 4;
         }
         this.var_1462.text = !!this.var_774 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1173.name,this.var_1171.name,this.var_1461.name,this.var_1761.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_773.setText(_loc1_.name);
         this.var_1174.setText(_loc1_.description);
         this.var_965.setText("");
         this.var_1176.setText("");
         ...
         {
            case RoomSettingsData.const_230:
         ...
         this.changePasswordField(_loc1_.doorMode == RoomSettingsData.const_133);
         ...
         {
            this.disableWindow(this.var_772);
            this.disableWindow(this.var_964);
            this.disableWindow(this.var_963);
            this.disableWindow(this.var_1759);
         }
         else
         {
            this.enableWindow(this.var_772);
            this.enableWindow(this.var_964);
            this.enableWindow(this.var_963);
            this.enableWindow(this.var_1759);
         }
         if(this.var_772)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_772.unselect();
            }
         }
         if(this.var_964)
         {
            this.var_964.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_963)
         {
            this.var_963.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_773.getText();
         _loc2_.description = this.var_1174.getText();
         var _loc3_:ISelectorWindow = this._window.findChildByName("doormode") as ISelectorWindow;
         var _loc4_:IWindow = _loc3_.getSelected();
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_230;
               break;
            case "doormode_password":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_133;
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_624;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_133)
         {
            _loc8_ = this.var_965.getText();
            _loc9_ = this.var_1176.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_965.clearErrors();
               this.var_1176.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1170.isSelected;
         _loc2_.allowFoodConsume = this.var_1178.isSelected;
         _loc2_.allowWalkThrough = this.var_1175.isSelected;
         _loc2_.hideWalls = this.var_772.isSelected;
         _loc2_.wallThickness = this.var_964.selection - 2;
         _loc2_.floorThickness = this.var_963.selection - 2;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_370);
         if(this.var_56 == null)
         {
            return;
         }
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_56.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_370]);
         _loc2_.show();
      }
      ...
      private function refreshFlatControllers() : void
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:* = null;
         if(this.var_242 == null || this.var_242.disposed)
         {
            return;
         }
         Util.hideChildren(this.var_242);
         var _loc1_:IWindow = this.var_242.findChildByName("ruler");
         if(_loc1_ != null)
         {
            _loc1_.visible = true;
         }
         var _loc2_:IWindow = this.var_242.findChildByName("flat_ctrls_caption_txt");
         if(_loc2_ != null)
         {
            this._navigator.registerParameter("navigator.roomsettings.flatctrls.caption","cnt","" + this.var_56.controllerCount);
            _loc2_.visible = true;
         }
         var _loc3_:IWindowContainer = IWindowContainer(this.var_242.findChildByName("flat_controller_list"));
         if(_loc3_ != null)
         {
            ...
            _loc5_ = this.var_242.findChildByName("flat_ctrls_info_txt");
            _loc6_ = this.var_242.findChildByName("flat_ctrls_limit_txt");
            _loc7_ = IWindowContainer(this.var_242.findChildByName("flat_controllers_footer"));
            if(this.var_56 != null && this.var_56.controllers.length > 0)
            {
               ...
               Util.moveChildrenToColumn(this.var_242,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc2_.y,5);
            }
            else
            {
         ...
         var _loc4_:IButtonWindow = IButtonWindow(this.var_242.findChildByName("remove_flat_ctrl"));
         if(_loc4_ != null)
         {
            if(_loc8_)
            {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_76,HabboWindowStyle.const_31,HabboWindowParam.const_63,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_370));
      }
