package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_502 = new Timer(500,1);
         this.var_421 = new Timer(100,1);
         super();
         this._navigator = param1;
         this.var_1154 = param4;
         this.var_2392 = param2;
         this._popupIndentLeft = param3;
         this.var_502.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_502)
         {
            this.var_502.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_502.reset();
            this.var_502 = null;
         }
         if(this.var_421)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_61 == null)
         {
            this.var_61 = IWindowContainer(this._navigator.getXmlWindow(this.var_1154));
         ...
         this.var_61.x = _loc2_.x + this.var_2392 + param1.width;
