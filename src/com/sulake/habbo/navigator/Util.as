package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1675:CutToWidth = new CutToWidth();
      
      private static var var_2942:CutToHeight = new CutToHeight();
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1675.beforeSearch(param2,param1,param3);
         binarySearch(var_1675,param2.length - 1);
      }
