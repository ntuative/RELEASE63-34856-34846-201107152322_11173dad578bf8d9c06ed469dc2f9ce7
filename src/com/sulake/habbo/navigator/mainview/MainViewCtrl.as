package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      public static const const_1271:int = 4;
      
      private static const const_1154:int = 1;
      
      private static const const_727:int = 2;
      
      private static const const_1155:int = 3;
      
      private static const const_1706:int = 4;
      ...
      private var var_1120:PopularTagsListCtrl;
      
      private var var_1119:GuestRoomListCtrl;
      
      private var var_1379:OfficialRoomListCtrl;
      
      private var var_303:ITabContextWindow;
      
      private var var_2167:Boolean;
      
      private var var_733:int;
      
      private var var_1381:Boolean = true;
      
      private var var_1684:int = 0;
      
      private var var_1683:IWindow;
      
      private var var_901:IRegionWindow;
      
      private var var_2983:int = 0;
      
      private var var_1380:TextSearchInputs;
      
      private var var_521:Timer;
      
      private var _disposed:Boolean = false;
      
      private var var_855:WindowToggle;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_1120 = new PopularTagsListCtrl(this._navigator);
         this.var_1119 = new GuestRoomListCtrl(this._navigator);
         this.var_1379 = new OfficialRoomListCtrl(this._navigator);
      ...
      public function onNavigatorToolBarIconClick() : Boolean
      {
         ...
         if(!this.var_855 || this.var_855.disposed)
         {
            this.var_855 = new WindowToggle(this.var_16,this.var_16.desktop,this.reloadData,this.close);
         }
         var _loc1_:int = this.var_855.toggle();
      ...
      private function prepare() : void
      {
         ...
         this.var_303 = ITabContextWindow(this.var_16.findChildByName("tab_context"));
         ...
         this.var_233 = IWindowContainer(this.var_16.findChildByName("list_content"));
         this.var_307 = IWindowContainer(this.var_16.findChildByName("custom_footer"));
         this.var_1683 = this.var_16.findChildByName("loading_text");
         ...
         {
            _loc3_ = this.var_303.getTabItemByID(_loc2_.id);
            if(_loc3_ != null)
            {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1872,true);
      ...
      private function createSearchInput() : void
      {
         ...
         if(this.var_1380 == null)
         {
            ...
            this.var_1380 = new TextSearchInputs(this._navigator,_loc3_);
         }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:int = this.var_233.y;
         Util.moveChildrenToColumn(this.var_209,["custom_content","list_content"],this.var_262.y,8);
         this.var_233.height = this.var_233.height + _loc1_ - this.var_233.y - this.var_307.height + this.var_2983;
         Util.moveChildrenToColumn(this.var_209,["list_content","custom_footer"],this.var_233.y,0);
         this.var_2983 = this.var_307.height;
      ...
      {
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         var _loc2_:ISelectableWindow = this.var_303.selector.getSelected();
         if(_loc1_.button != _loc2_)
         {
            this.var_2167 = true;
            this.var_303.selector.setSelected(_loc1_.button);
         }
      }
      ...
      {
         this.refreshList(param1,param2,this.var_1120,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1379,"official_rooms");
      }
      ...
      private function refreshList(param1:Boolean, param2:Boolean, param3:IViewCtrl, param4:String) : void
      {
         ...
         if(param2)
         {
            ...
            {
               _loc5_ = this.var_233.findChildByName(param4);
      ...
      private function getSearchMsg(param1:int, param2:String) : IMessageComposer
      {
         ...
         if(param1 == Tabs.const_850)
         {
            return new RoomsWhereMyFriendsAreSearchMessageComposer();
         }
         if(param1 == Tabs.const_810)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_733 == const_1154)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_233.blend - _loc2_));
            this.var_233.blend = _loc3_;
            this.var_262.blend = !!this.var_1381 ? Number(_loc3_) : Number(1);
            this.var_307.blend = !!this.var_1381 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_733 = const_727;
            }
         }
         else if(this.var_733 == const_727)
         {
            if(this.var_1684 % 10 == 1)
            {
               this.var_1683.visible = !this.var_1683.visible;
            }
            ++this.var_1684;
            if(!this._navigator.data.isLoading())
            {
               this.var_733 = const_1155;
            }
         }
         else if(this.var_733 == const_1155)
         {
            this.refresh();
            this.var_733 = const_1706;
         }
         else
         {
            this.var_1683.visible = false;
            _loc3_ = Math.min(1,Math.max(0,this.var_233.blend + _loc2_));
            this.var_233.blend = _loc3_;
            this.var_262.blend = !!this.var_1381 ? Number(_loc3_) : Number(1);
            this.var_307.blend = !!this.var_1381 ? Number(_loc3_) : Number(1);
            if(this.var_233.blend >= 1)
            {
      ...
      {
         this.refreshScrollbar(this.var_1120);
