package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_608:IScrollbarWindow;
      
      private var var_1216:UserCountRenderer;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_1216 = new UserCountRenderer(this._navigator);
      }
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_608 = IScrollbarWindow(this.var_209.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.var_608.scrollV = 0;
         }
         this.var_209.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.addEventListener(WindowMouseEvent.const_200,this.onMouseMove);
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1938,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_230,null,0);
         ...
         this.var_1216.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_558.visible && this.var_2705)
         {
            return;
         }
         ...
         if(_loc4_.ownerName != this._navigator.sessionData.userName)
         {
            ...
            switch(_loc4_.doorMode)
            {
               case RoomSettingsFlatInfo.const_133:
                  ...
                  return;
               case RoomSettingsFlatInfo.const_230:
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2704 - _loc2_.stageX);
         this.var_2704 = _loc2_.stageX;
         this.var_2705 = _loc3_ > 2;
      }
   }
}
