package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_154:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_154 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            this.prepareRoomCategories();
            this.var_154.addEventListener(WindowEvent.const_48,this.onFilterSelected);
         }
         _loc3_.visible = true;
      }
      ...
      public function tabSelected() : void
      {
         if(this.var_154 != null)
         {
            this.var_154.removeEventListener(WindowEvent.const_48,this.onFilterSelected);
            this.var_154.selection = 0;
            this.var_154.addEventListener(WindowEvent.const_48,this.onFilterSelected);
         }
      }
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = this.var_154 == null ? 0 : int(this.var_154.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_223,Tabs.const_394);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_223,Tabs.const_810);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_223,Tabs.const_394,"" + _loc3_);
         }
         if(this.var_154)
         {
            this._navigator.trackNavigationDataPoint(this.var_154.enumerateSelection()[this.var_154.selection],"category.view");
         }
      }
      
      public function get filterCategory() : String
      {
         return !!this.var_154 ? this.var_154.enumerateSelection()[this.var_154.selection] : null;
      }
   }
}
