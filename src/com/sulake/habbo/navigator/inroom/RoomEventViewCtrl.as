package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_1755:ITextWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_1754.visible = true;
         this.var_2319.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_771.setText(param1.eventDescription);
         this.var_962.setText(this.getTagFromEvent(param1,1));
         this.var_961.setText(this.getTagFromEvent(param1,2));
         this.var_1458.visible = false;
         this.var_1459.visible = true;
         this.var_1460.visible = true;
         this.var_1756.visible = false;
         this.var_1755.visible = true;
      }
      
      private function createEvent() : void
      {
         this.var_960.visible = true;
         this.var_1754.visible = false;
         this.var_1458.visible = true;
         this.var_1459.visible = false;
         this.var_1460.visible = false;
         this.var_771.goBackToInitialState();
         this._eventNameInput.goBackToInitialState();
         this.var_962.goBackToInitialState();
         this.var_961.goBackToInitialState();
         this.var_960.selection = 0;
         this.var_1756.visible = true;
         this.var_1755.visible = false;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent) : void
      {
         ...
         var _loc4_:String = this.var_771.getText();
         var _loc5_:Array = new Array();
         this.addTag(_loc5_,this.var_962.getText());
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_771.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1754 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2319 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1756 = ITextWindow(this.find("create_caption"));
            this.var_1755 = ITextWindow(this.find("edit_caption"));
            this.var_1458 = IButtonWindow(this.find("create_button"));
            this.var_1459 = IButtonWindow(this.find("edit_button"));
            this.var_2318 = IButtonWindow(this.find("cancel_button"));
            this.var_1460 = IButtonWindow(this.find("end_button"));
            ...
            this.addMouseClickListener(this.var_1459,this.onEditButtonClick);
            this.addMouseClickListener(this.var_1460,this.onEndButtonClick);
            ...
            this.var_771 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
            this.var_962 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
