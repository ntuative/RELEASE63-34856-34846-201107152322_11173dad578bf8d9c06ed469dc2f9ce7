package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_779);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_1004);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_835);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_779:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_1004:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_835:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_172);
         _loc1_.push(FriendRequestEvent.const_59);
         _loc1_.push(FriendRequestEvent.const_220);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_172:
            ...
            case FriendRequestEvent.const_220:
