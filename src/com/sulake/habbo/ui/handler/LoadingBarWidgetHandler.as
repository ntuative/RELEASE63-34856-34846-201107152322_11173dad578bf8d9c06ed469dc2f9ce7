package com.sulake.habbo.ui.handler
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(InterstitialEvent.const_587);
         _loc1_.push(InterstitialEvent.const_551);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_113);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_349);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case InterstitialEvent.const_587:
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_113:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_349:
               this._container.events.dispatchEvent(param1);
         }
      }
