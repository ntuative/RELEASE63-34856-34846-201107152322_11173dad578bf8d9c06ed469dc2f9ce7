package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1546:IMessageEvent;
      
      private var var_1913:IMessageEvent;
      
      private var var_1912:IMessageEvent;
      ...
      {
         return RoomWidgetEnum.const_643;
      }
      ...
      {
         this.var_1546 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1913 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1912 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1546);
         this._connection.addMessageEvent(this.var_1913);
         this._connection.addMessageEvent(this.var_1912);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1546);
               this._connection.removeMessageEvent(this.var_1913);
               this._connection.removeMessageEvent(this.var_1912);
            }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_805,RoomWidgetPlayListModificationMessage.const_959,RoomWidgetPlayListModificationMessage.const_786,RoomWidgetPlayListPlayStateMessage.const_931,RoomWidgetPlayListUserActionMessage.const_918];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_805:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_787,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_959:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_786:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_931:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_918:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomEngineSoundMachineEvent.const_298);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_298:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_865,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_791,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_834));
               break;
