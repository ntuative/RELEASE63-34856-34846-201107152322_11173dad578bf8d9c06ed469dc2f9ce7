package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      public function dispose() : void
      {
         ...
         {
            this._container.avatarEditor.close(AvatarEditorInstanceId.const_235);
         }
         this.var_1155 = true;
         this.container = null;
         this.var_12 = null;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_339,this.onFigureUpdate);
            }
            if(this.var_12 && !this.var_12.disposed && this.var_12.events)
            {
               this.var_12.events.removeEventListener(HabboInventoryEffectsEvent.const_295,this.onAvatarEffectsChanged);
               this.var_12.events.removeEventListener(HabboInventoryHabboClubEvent.const_338,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_1028,this.onHelpTutorialEvent);
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_137,this.onHelpTutorialEvent);
            }
            if(this._container.catalog && !this._container.catalog.disposed && this._container.catalog.events)
            {
               this._container.catalog.events.removeEventListener(PurseEvent.const_128,this.onCreditBalance);
            }
         }
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_339,this.onFigureUpdate);
         }
         this.var_12 = this._container.inventory;
         if(this.var_12 != null)
         {
            this.var_12.events.addEventListener(HabboInventoryEffectsEvent.const_295,this.onAvatarEffectsChanged);
            this.var_12.events.addEventListener(HabboInventoryHabboClubEvent.const_338,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_1028,this.onHelpTutorialEvent);
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_137,this.onHelpTutorialEvent);
         }
         this._catalog = this._container.catalog;
         if(this._container.catalog != null)
         {
            this._container.catalog.events.addEventListener(PurseEvent.const_128,this.onCreditBalance);
         }
      }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1528)
            {
               ...
               this.var_1528 = _loc3_;
               this.var_1876 = _loc1_;
               this.var_1877 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_1876;
               _loc2_ = this.var_1877;
            }
         }
         if(this._toolbar != null)
         {
            if(_loc1_ != null && _loc2_ != null)
            {
               if(_loc1_.height > const_473)
               {
                  ...
                  if(_loc2_.height > const_473 - const_1071)
                  {
                     _loc8_.offset(0,_loc2_.height - const_473 + const_1071);
                  }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_767);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_996);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1231);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1279);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1220);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_793);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_872);
         _loc1_.push(RoomWidgetStopEffectMessage.const_849);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1881);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1301);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_513);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1748);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1196);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_988);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_1024);
         _loc1_.push(RoomWidgetMeMenuMessage.const_852);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_821);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1907);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_817);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_783);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1401);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_397);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_1024:
            ...
            case RoomWidgetWaveMessage.const_921:
               ...
               break;
            case RoomWidgetDanceMessage.const_767:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_996:
               if(this.var_12 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_1231:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1279:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_872:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1204)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_169,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_793:
               ...
               if(this.var_12 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1850:
                        this._catalog.openCatalogPage(CatalogPageName.const_1408,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1296:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_219);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_2021:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_77);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1770:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1220:
            case RoomWidgetStopEffectMessage.const_849:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1301:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_988:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetMeMenuMessage.const_852:
               ...
               {
                  this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_128,this._catalog.getPurse().credits));
               }
               ...
               break;
            case RoomWidgetAvatarEditorMessage.const_513:
               Logger.log("MeMenuWidgetHandler: Open avatar editor...");
               if(this._container)
               {
                  this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_235,null,null,true);
                  this._container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_235);
            ...
            case RoomWidgetGetSettingsMessage.const_821:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_436,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_817:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_436,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_783:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_436,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_1401:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_539));
               }
               break;
            default:
      ...
      private function onCreditBalance(param1:PurseEvent) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_128,param1.balance));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_137:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_137));
               break;
            case HabboHelpTutorialEvent.const_1028:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_653));
         }
      }
