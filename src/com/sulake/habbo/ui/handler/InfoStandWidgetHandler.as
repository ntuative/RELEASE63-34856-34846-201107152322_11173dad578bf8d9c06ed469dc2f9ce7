package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_244.events.addEventListener(NowPlayingEvent.const_105,this.onNowPlayingChanged);
            this.var_244.events.addEventListener(SongInfoReceivedEvent.const_96,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_214,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_187,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_214,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_187,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_632.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_632.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_244 != null)
         {
            this.var_244.events.removeEventListener(NowPlayingEvent.const_105,this.onNowPlayingChanged);
            this.var_244.events.removeEventListener(SongInfoReceivedEvent.const_96,this.onSongInfoReceivedEvent);
            this.var_244 = null;
         }
         this.var_1155 = true;
         this.container = null;
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomObjectMessage.const_761);
         _loc1_.push(RoomWidgetUserActionMessage.const_589);
         _loc1_.push(RoomWidgetUserActionMessage.const_573);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_446);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_979);
         _loc1_.push(RoomWidgetFurniActionMessage.const_309);
         _loc1_.push(RoomWidgetFurniActionMessage.const_823);
         _loc1_.push(RoomWidgetFurniActionMessage.const_937);
         _loc1_.push(RoomWidgetFurniActionMessage.const_752);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1366);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_758);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_914);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_1013);
         _loc1_.push(RoomWidgetUserActionMessage.const_673);
         _loc1_.push(RoomWidgetUserActionMessage.const_579);
         _loc1_.push(RoomWidgetUserActionMessage.const_567);
         _loc1_.push(RoomWidgetUserActionMessage.const_2017);
         _loc1_.push(RoomWidgetPetCommandMessage.const_583);
         _loc1_.push(RoomWidgetPetCommandMessage.const_757);
         _loc1_.push(RoomWidgetUserActionMessage.const_608);
         _loc1_.push(RoomWidgetUserActionMessage.const_306);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_954);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_673)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_306 || param1.type == RoomWidgetUserActionMessage.const_608 || param1.type == RoomWidgetUserActionMessage.const_567)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectMessage.const_761:
            ...
            case RoomWidgetUserActionMessage.const_589:
               ...
               break;
            case RoomWidgetUserActionMessage.const_573:
               this._container.sessionDataManager.giveRespect(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_608:
               this._container.sessionDataManager.givePetRespect(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_532:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1388,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_652:
               ...
               break;
            case RoomWidgetUserActionMessage.const_446:
            ...
            case RoomWidgetUserActionMessage.const_576:
               ...
               break;
            case RoomWidgetUserActionMessage.const_979:
            ...
            case RoomWidgetFurniActionMessage.const_937:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_752:
               this._container.roomEngine.useRoomObjectInActiveRoom(_loc5_,_loc6_);
               break;
            case RoomWidgetFurniActionMessage.const_1366:
               ...
               break;
            case RoomWidgetUserActionMessage.const_306:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_758:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_914:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_1013:
               ...
               break;
            case RoomWidgetUserActionMessage.const_673:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_292);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_325);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_427) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_427);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_759) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1280;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_292);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1353);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1197);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_520)
                  {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_395) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_395.length);
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_227)
               {
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_637)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_336);
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_112)
               {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_157)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_819);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_766;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_836;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1776);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_173];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_173:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_632.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_632.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_819);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_244 != null)
         {
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_406,_loc2_,_loc3_,_loc4_));
         }
      }
