package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private static const const_1433:int = 1000;
      ...
      private var var_1168:IRoomWidgetFactory = null;
      
      private var var_368:ISessionDataManager = null;
      
      private var var_15:IRoomSessionManager = null;
      
      private var var_1110:IAvatarRenderManager = null;
      ...
      private var var_1201:IHabboHelp = null;
      ...
      private var var_271:DesktopLayoutManager;
      ...
      private var var_241:IToolTipWindow;
      
      private var var_2307:uint = 16777215;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         this.var_271 = new DesktopLayoutManager();
      }
      ...
      public function set navigator(param1:IHabboNavigator) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_326,this.onNavigatorEvent);
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_417,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_599,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_808,this.onRoomContentLoaded);
         }
      }
      ...
      {
         this.var_271.setLayout(param1,this._windowManager,this._config);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_417,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_599,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_808,this.onRoomContentLoaded);
         }
         ...
         {
            this._navigator.events.removeEventListener(HabboNavigatorEvent.const_326,this.onNavigatorEvent);
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_32 != null)
         {
            this.var_770 = this._roomEngine.loadRoomResources(this.var_32.roomResources);
            if(this.var_770.length > 0)
            {
               this.var_1741 = false;
      ...
      {
         if(this.var_328 != null && this.var_32.state == RoomSessionEvent.const_274)
         {
            this.var_1742 = !this.var_328.showInterstitial();
         }
      ...
      {
         if(this.var_770 == null || this.var_770.length == 0)
         {
            return;
         }
         var _loc2_:int = this.var_770.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            this.var_770.splice(_loc2_,1);
         }
         if(this.var_770.length == 0)
         {
            this.var_1741 = true;
      ...
      public function createWidget(param1:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               {
                  _loc8_ = this.var_769.getValue(_loc11_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_769.add(_loc11_,_loc8_);
                  }
                  else
                  {
            ...
            if(_loc10_ != null)
            {
               ...
               {
                  _loc8_ = this.var_768.getValue(_loc12_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_768.add(_loc12_,_loc8_);
                  }
                  _loc8_.push(_loc4_);
               }
            }
         }
         _loc2_ = this.var_1168.createWidget(param1,_loc4_);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            this.var_271.addWidgetWindow(param1,_loc2_.mainWindow);
         }
         if(_loc3_)
         {
            param1 = "null";
            _loc13_ = new RoomWidgetRoomViewUpdateEvent(param1,this.var_271.roomViewRect);
      ...
      public function disposeWidget(param1:String) : void
      {
         ...
         if(this.var_38 != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               {
                  this.var_271.removeWidgetWindow(param1,_loc2_.mainWindow);
               }
               _loc2_.dispose();
            }
         }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         var _loc2_:Array = this.var_769.getValue(param1.type);
         if(_loc2_ != null)
         {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         var _loc2_:Array = this.var_768.getValue(param1.type);
         if(_loc2_ != null)
         {
            for each(_loc3_ in _loc2_)
            {
      ...
      private function isFurnitureSelectionDisabled(param1:RoomEngineObjectEvent) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(_loc4_.getNumber(RoomObjectVariableEnum.const_1345) == 1)
               {
                  _loc2_ = true;
                  if(this.var_368.isAnyRoomController)
                  {
                     _loc2_ = false;
                  }
               }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_930:
               if(!this.isFurnitureSelectionDisabled(param1))
               {
                  _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_346,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               }
               if(this.var_984 != null && _loc3_ == RoomObjectCategoryEnum.const_29)
               {
                  _loc7_ = this.var_32.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_130)
                  {
                     this.var_984.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_183:
               ...
               break;
            case RoomEngineObjectEvent.const_420:
               switch(_loc3_)
               {
                  case RoomObjectCategoryEnum.const_27:
                  case RoomObjectCategoryEnum.const_26:
            ...
            case RoomEngineObjectEvent.const_504:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_175,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_189:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_1008,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_196:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_426,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_736:
               if(!this.var_32.isRoomController && !this.var_368.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_146:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1390,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_149:
               ...
               this.processWidgetMessage(_loc5_);
               break;
            case RoomEngineSoundMachineEvent.const_298:
               this.processEvent(param1);
         }
         if(_loc4_ != null)
         {
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_607:
            ...
            case RoomEngineEvent.const_507:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_421,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc21_:* = null;
         var _loc2_:Rectangle = this.var_271.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_32.roomId,this.var_32.roomCategory,RoomVariableEnum.const_886);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_32.roomId,this.var_32.roomCategory,RoomVariableEnum.const_851);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_32.roomId,this.var_32.roomCategory,RoomVariableEnum.const_906);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_32.roomId,this.var_32.roomCategory,RoomVariableEnum.const_1002);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_291,this.canvasMouseHandler);
         ...
         this.var_271.addRoomView(_loc9_);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2307);
      ...
      {
         var _loc3_:IWindowContainer = this.var_271.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function getRoomViewRect() : Rectangle
      {
         ...
         return this.var_271.roomViewRect;
      }
      ...
      public function canvasMouseHandler(param1:WindowEvent) : void
      {
         ...
         if(_loc3_ == MouseEvent.MOUSE_MOVE && this.var_241 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(-this.var_241.width / 2,15);
            this.var_241.setGlobalPosition(_loc8_);
         }
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this._roomEngine.modifyRoomCanvas(this.var_32.roomId,this.var_32.roomCategory,this.var_319[0],_loc2_.width,_loc2_.height);
         if(this.var_521 == null)
         {
            this.var_521 = new Timer(const_1433,1);
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1739) / 1000);
      ...
      {
         var _loc2_:* = null;
         if(param1.type == HabboNavigatorEvent.const_326)
         {
            if(this.var_32 != null)
            {
               _loc2_ = this._roomEngine.getRoomCanvasGeometry(this.var_32.roomId,this.var_32.roomCategory,this.getFirstCanvasId());
      ...
      {
         if(this.var_15 != null && this.var_32 != null && this.var_1742 && this.var_1741)
         {
            this.var_15.startSession(this.var_32);
            this.processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_349));
            return true;
         }
         return false;
      }
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_435);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_649:
               ...
               this.var_241 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_399,WindowStyle.const_101,WindowParam.const_103) as IToolTipWindow;
               this.var_241.setParamFlag(WindowParam.const_30,false);
