package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_3076:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_3076 = param1.root.assets;
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_405:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_73,this.var_162,this.var_2455++,this);
               break;
            case RoomWidgetEnum.const_361:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_73,this.var_162,this);
               break;
            case RoomWidgetEnum.const_515:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_73,this.var_162,this._catalog);
               break;
            case RoomWidgetEnum.const_496:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_73,events,this.var_162);
               break;
            ...
            case RoomWidgetEnum.const_635:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_73,this.var_162,this.var_12);
               break;
            ...
            case RoomWidgetEnum.const_526:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_73,this.var_162);
               break;
            case RoomWidgetEnum.const_613:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_73,this.var_162);
               break;
            case RoomWidgetEnum.const_134:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_73,this.var_162);
               break;
            ...
            case RoomWidgetEnum.const_136:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_162,this.var_73,this);
               break;
            ...
            case RoomWidgetEnum.const_643:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_73,this.var_162,this._catalog);
               break;
