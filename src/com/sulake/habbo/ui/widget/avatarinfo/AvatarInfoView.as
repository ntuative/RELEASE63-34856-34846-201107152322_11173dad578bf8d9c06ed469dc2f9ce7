package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoView implements IDisposable
   {
      ...
      protected static const const_1412:uint = 4281149991;
      
      protected static const const_1036:uint = 4282950861;
      
      protected static const const_2050:uint = 4288230144;
      
      protected static const const_1413:uint = 16777215;
      
      protected static const const_1414:uint = 9552639;
      
      protected static const const_2048:uint = 16777215;
      ...
      private static const const_1561:int = 25;
      
      private static const const_1099:int = 3;
      ...
      protected var var_2634:int;
      
      protected var var_2158:Boolean;
      
      protected var var_2259:FixedSizeStack;
      ...
      protected var var_3049:int = 3000;
      ...
      {
         this.var_2259 = new FixedSizeStack(const_1561);
         super();
         this._widget = param1;
         this.var_1146 = true;
         this.var_1709 = false;
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         param1.var_2634 = param4;
         param1.var_2258 = param6;
         ...
         if(param1.var_1146)
         {
            if(!param1.var_511)
            {
               param1.var_511 = new Timer(param1.var_3049,1);
      ...
      public function update(param1:Rectangle, param2:Point, param3:uint) : void
      {
         ...
         if(this.var_1710)
         {
            ...
            this._blend = 1 - this.var_1711 / Number(this.var_3050);
         }
         else
         {
            this._blend = 1;
         ...
         if(!this.var_2158 || this.var_1957)
         {
            _loc4_ = -this.var_191.height;
            if(this.var_1708 == RoomObjectTypeEnum.const_130 || this.var_1708 == RoomObjectTypeEnum.const_637)
            {
            ...
            this.var_2259.addValue(_loc5_);
            _loc6_ = this.var_2259.getMax();
            if(_loc6_ < this.var_2257 - const_1099)
            {
               _loc6_ = this.var_2257 - const_1099;
            }
