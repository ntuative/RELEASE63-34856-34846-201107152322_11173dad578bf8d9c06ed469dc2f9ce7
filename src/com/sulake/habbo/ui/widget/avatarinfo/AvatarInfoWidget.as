package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1057:String = "use_minimized_own_avatar_menu";
      ...
      private var var_783:AvatarInfoView;
      
      private var var_781:OwnAvatarMenuView;
      ...
      public function AvatarInfoWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboConfigurationManager, param5:IHabboLocalizationManager, param6:Component)
      {
         ...
         this.var_2373 = Boolean(this.var_128.getBoolean("menu.avatar.enabled",false));
         this.var_1789 = this.var_128.getBoolean("menu.own_avatar.enabled",false);
         this.var_375 = new Map();
         this.handler.roomEngine.events.addEventListener(RoomEngineObjectEvent.const_183,this.onRoomObjectAdded);
         this.handler.roomEngine.events.addEventListener(RoomEngineObjectEvent.const_420,this.onRoomObjectRemoved);
         this.handler.container.inventory.events.addEventListener(HabboInventoryEffectsEvent.const_295,this.onEffectsChanged);
         this.handler.widget = this;
      }
      
      public function get handler() : AvatarInfoWidgetHandler
      {
         return var_935 as AvatarInfoWidgetHandler;
      }
      ...
      private function onRoomObjectRemoved(param1:RoomEngineObjectEvent) : void
      {
         ...
         if(param1.category == RoomObjectCategoryEnum.const_29)
         {
            for each(_loc2_ in this.var_375)
            {
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_867,0,0));
      }
      ...
      override public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_375)
         {
            _loc1_.dispose();
         }
         this.var_375 = null;
         ...
         this.handler.roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_183,this.onRoomObjectAdded);
         this.handler.roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_420,this.onRoomObjectRemoved);
         this.handler.container.inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_295,this.onEffectsChanged);
         this._view = null;
         this.var_128 = null;
         super.dispose();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_346,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_175,this.updateEventHandler);
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_325,this.updateEventHandler);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.BOT,this.updateEventHandler);
         param1.addEventListener(RoomWidgetPetInfoUpdateEvent.const_114,this.updateEventHandler);
         param1.addEventListener(RoomWidgetUserDataUpdateEvent.const_129,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_192,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_99,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_421,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectNameEvent.const_559,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_1008,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_426,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_346,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_175,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_325,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.BOT,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetPetInfoUpdateEvent.const_114,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetUserDataUpdateEvent.const_129,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_192,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomEngineUpdateEvent.const_99,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomEngineUpdateEvent.const_421,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectNameEvent.const_559,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_426,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_426,this.updateEventHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetAvatarInfoEvent.const_136:
               ...
               if(this.var_1789 && _loc2_.allowNameChange)
               {
               ...
               break;
            case RoomWidgetRoomObjectNameEvent.const_559:
               ...
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_346:
               this.var_1790 = true;
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_175:
            case RoomWidgetFurniInfoUpdateEvent.const_325:
               if(this._view)
               {
                  this.removeView(this._view,false);
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_1008:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  this.var_1788 = RoomWidgetRoomObjectUpdateEvent(param1).id;
                  messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_761,RoomWidgetRoomObjectUpdateEvent(param1).id,RoomWidgetRoomObjectUpdateEvent(param1).category));
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_426:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  if(RoomWidgetRoomObjectUpdateEvent(param1).id == this.var_1788)
                  {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_157:
               ...
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_130,false,!!_loc3_.isSpectatorMode ? null : this.var_245);
               break;
            case RoomWidgetUserInfoUpdateEvent.BOT:
               _loc4_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.updateView(_loc4_.webID,_loc4_.name,_loc4_.userRoomId,RoomObjectTypeEnum.const_637,false,null);
               break;
            case RoomWidgetPetInfoUpdateEvent.const_114:
               if(this.var_1790)
               {
                  _loc6_ = param1 as RoomWidgetPetInfoUpdateEvent;
                  this.updateView(_loc6_.id,_loc6_.name,_loc6_.roomIndex,RoomObjectTypeEnum.const_227,false,null);
               }
               break;
            case RoomWidgetUserDataUpdateEvent.const_129:
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_192:
               ...
               for each(_loc7_ in this.var_375)
               {
            ...
            case RoomWidgetRoomEngineUpdateEvent.const_99:
               this.var_1791 = false;
               break;
            case RoomWidgetRoomEngineUpdateEvent.const_421:
               this.var_1791 = true;
         }
      ...
      public function selectOwnAvatar() : void
      {
         ...
         _loc3_ = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_382,_loc2_.id,RoomObjectCategoryEnum.const_29);
      ...
      private function storeUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.var_245.isOwnUser = param1.type == RoomWidgetUserInfoUpdateEvent.const_112;
      ...
      private function updateView(param1:int, param2:String, param3:int, param4:int, param5:Boolean, param6:AvatarInfoData) : void
      {
         ...
         if(param6)
         {
            _loc7_ = !!param6.isOwnUser ? Boolean(this.var_1789) : Boolean(this.var_2373);
         }
            ...
            if(!this.var_1791)
            {
               if(_loc7_)
               {
                  if(param6.isOwnUser)
                  {
                     if(!this.var_781)
                     {
                        this.var_781 = new OwnAvatarMenuView(this);
                     }
                  ...
                  else
                  {
                     ...
                     for each(_loc8_ in this.var_375)
                     {
               ...
               else
               {
                  if(!this.var_783)
                  {
                     this.var_783 = new AvatarInfoView(this);
                  }
                  this._view = this.var_783;
      ...
      public function removeView(param1:AvatarInfoView, param2:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_375.remove(param1.userName);
               param1.dispose();
               this.checkUpdateNeed();
            }
         }
      ...
      public function checkUpdateNeed() : void
      {
         ...
         if(this._view || this.var_375.length > 0)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         for each(_loc3_ in this.var_375)
         {
      ...
      {
         return this.handler.container.config.getBoolean(const_1057,true);
      }
      
      public function set useMinimizedOwnAvatarMenu(param1:Boolean) : void
      {
         this.handler.container.config.setKey(const_1057,!!param1 ? "1" : "0");
      }
   }
}
