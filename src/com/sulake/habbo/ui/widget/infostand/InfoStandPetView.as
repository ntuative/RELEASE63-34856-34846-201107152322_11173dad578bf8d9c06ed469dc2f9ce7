package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1576:int = 162;
      
      private static const const_1588:int = 16;
      
      private static const const_701:int = 4;
      
      private static const const_1585:uint = 14342874;
      
      private static const const_1579:uint = 3815994;
      
      private static const const_1583:uint = 2085362;
      
      private static const const_1586:uint = 39616;
      
      private static const const_1582:uint = 10513106;
      
      private static const const_1577:uint = 8734654;
      
      private static const const_1581:uint = 9094430;
      
      private static const const_1580:uint = 6200576;
      
      private static const const_1584:String = "happiness";
      
      private static const const_1587:String = "experience";
      
      private static const const_1589:String = "energy";
      
      private static const const_1578:int = 250;
      
      private static const const_1117:int = 25;
      ...
      private var var_225:PetCommandTool;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1584,param1.nutrition,param1.nutritionMax,const_1586,const_1583);
         this.updateStateElement(const_1587,param1.experience,param1.experienceMax,const_1577,const_1582);
         this.updateStateElement(const_1589,param1.energy,param1.energyMax,const_1580,const_1581);
         ...
         this.updateWindow();
         this.var_533 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_225 && this.var_225.isVisible() && param1.isOwnPet)
         {
            this.var_225.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_225.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1576,const_1588,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1585);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1579);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_701,_loc7_.width - 2,_loc7_.height - 2 - const_701);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_701);
      ...
      private function openTrainView() : void
      {
         if(this.var_225 == null)
         {
            this.var_225 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_533) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_225.showWindow(true);
            this.var_225.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for each(_loc10_ in _loc4_)
         {
            ...
            _loc10_.addEventListener(WindowEvent.const_40,this.method_9);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_225 && this.var_225.getPetId() == this.var_533)
               {
                  this.var_225.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1865,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_446,this._widget.petData.ownerId);
      ...
      protected function method_9(param1:WindowEvent) : void
      {
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1117 + const_1116;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1116;
            }
         }
         this.var_109.height = _loc4_ + const_1117;
         this.updateWindow();
      }
   }
}
