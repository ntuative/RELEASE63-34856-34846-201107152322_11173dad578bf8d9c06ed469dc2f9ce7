package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private var var_118:IWidgetAvatarEffect;
      
      private var var_744:IWindow;
      
      private var var_326:Number;
      
      private var var_427:ITextWindow;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_118 = param2;
         this._widget = param1;
         this.var_212 = new Timer(this.const_2381);
         this.var_212.addEventListener(TimerEvent.TIMER,this.onUpdate);
         this.update();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_212.stop();
            this.var_212.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_212 = null;
         }
         this._widget = null;
         this.var_118 = null;
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_118.isActive)
         {
            _loc2_ = this.var_118.secondsLeft / Number(this.var_118.duration);
            this.var_744.width = _loc2_ * this.var_326;
         }
         else
         {
            this.var_744.width = 0;
            this.var_212.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_427 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_427 == null)
            {
               return;
            }
         ...
         if(!this.var_118.isActive)
         {
            this.var_427.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         if(this.var_118.secondsLeft > 86400)
         {
            this.var_427.caption = "${widgets.memenu.effects.active.daysleft}";
            _loc1_ = this.var_427.text;
            _loc2_ = Math.floor(this.var_118.secondsLeft / 86400);
            _loc1_ = _loc1_.replace("%days_left%",_loc2_);
         }
         else
         {
            this.var_427.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_427.text;
            _loc3_ = this.var_118.secondsLeft;
      ...
      public function update() : void
      {
         ...
         if(!this._window)
         {
            this._window = this._widget.windowManager.createWindow("","",HabboWindowType.const_76,HabboWindowStyle.const_31,HabboWindowParam.const_63) as IWindowContainer;
         }
         ...
         this.var_427 = null;
         var _loc2_:String = "";
         if(this.var_118.isInUse)
         {
            _loc2_ = "memenu_effect_selected";
         }
         else if(this.var_118.isActive)
         {
         ...
         else
         {
            ...
            this.var_745 = this._window.findChildByName("effect_hilite");
            this.var_745.visible = false;
         }
         this.setTimeLeft();
         this.var_744 = this._window.findChildByName("loader_bar");
         if(this.var_744 != null)
         {
            this.var_326 = this.var_744.width;
            this.var_212.start();
            this.onUpdate();
         }
         if(this.var_118.icon)
         {
            this.setElementBitmap("effect_icon",this.var_118.icon);
         }
      ...
      private function onMouseEvent(param1:WindowMouseEvent) : void
      {
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               this._widget.selectEffect(this.var_118.type,this.var_118.isInUse);
         }
      }
