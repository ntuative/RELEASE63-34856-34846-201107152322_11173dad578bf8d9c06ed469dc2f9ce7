package com.sulake.habbo.ui.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1530:int = 30000;
      ...
      public function VoteWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager)
      {
         ...
         {
            this.var_1530 = int(this._config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_182.reset();
            this.var_182.removeEventListener(TimerEvent.TIMER,this.updateEvent);
            this.var_182 = null;
         }
         this._config = null;
         super.dispose();
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_143,this.showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_141,this.showVoteResult);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_143,this.showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_141,this.showVoteResult);
      }
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         if(this.var_182 == null)
         {
            ...
            this.var_182.addEventListener(TimerEvent.TIMER,this.updateEvent);
         }
      ...
      private function updateTimerView() : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((this.var_1530 - _loc1_) / 1000,0);
      ...
      {
         var _loc2_:int = getTimer() - this.var_1884;
         if(_loc2_ > this.var_1530)
         {
            this.vote();
            return;
         }
