package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private var var_354:IFrameWindow;
      
      private var var_3031:Boolean = false;
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1399;
         if(this.var_1399 < this.var_1135.length)
         {
            _loc1_ = this.var_1135[this.var_1399] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(this._window != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",this.var_1135.length);
                  _loc2_.text = _loc6_;
               }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_1135[this.var_1399] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_354)
         {
            ...
            this.var_354 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2) as IFrameWindow;
            this.var_354.center();
            _loc2_ = this.var_354.findChildByName("header_button_close");
            if(_loc2_ != null)
            {
               _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCancelPollClose);
            }
            _loc3_ = this.var_354.findChildByName("poll_cancel_confirm_button_ok");
            if(_loc3_ != null)
            {
               _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCancelPollOk);
            }
            _loc4_ = this.var_354.findChildByName("poll_cancel_confirm_button_cancel");
            if(_loc4_ != null)
            {
