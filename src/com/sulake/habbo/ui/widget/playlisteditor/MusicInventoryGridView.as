package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      private var var_700:IItemGridWindow;
      
      private var _items:Map;
      
      private var _widget:PlayListEditorWidget;
      
      private var var_114:MusicInventoryGridItem;
      ...
      public function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            this.var_700.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_114.playButtonState = MusicInventoryGridItem.const_1321;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_114 != null)
         {
            this.var_114.playButtonState = MusicInventoryGridItem.const_632;
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            if(param2.name == "button_to_playlist" || _loc3_)
            {
               if(this.var_114 != null)
               {
                  this.var_114.deselect();
                  this.stopPreview();
                  this._widget.sendAddToPlayListMessage(this.var_114.diskId);
                  this.var_114 = null;
               }
            }
            else if(param2.name == "button_play_pause")
            {
               if(this.var_114.playButtonState == MusicInventoryGridItem.const_632)
               {
                  this.var_114.playButtonState = MusicInventoryGridItem.const_1247;
                  this._widget.playUserSong(this.var_114.songId);
               }
               else
               {
                  this.stopPreview();
            ...
            {
               _loc4_ = this.var_700.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
                  _loc5_ = this._items.getWithIndex(_loc4_);
                  if(_loc5_ != this.var_114)
                  {
                     if(this.var_114 != null)
                     {
                        this.var_114.deselect();
