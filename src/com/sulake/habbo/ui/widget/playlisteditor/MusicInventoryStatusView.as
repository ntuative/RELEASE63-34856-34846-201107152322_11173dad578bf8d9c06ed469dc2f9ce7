package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_788:String = "MISV_BUY_MORE";
      
      public static const const_756:String = "MISV_PREVIEW_PLAYING";
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_442[param1] as IWindowContainer,0);
         this.var_54 = param1;
      }
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_2096.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_756,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_788,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_442.add(const_756,_loc1_);
            this.var_2095 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_2096 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_623));
         ...
         if(_loc1_ != null)
         {
            this.var_442.add(const_788,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_554));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_442[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
