package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_854:String = "PLSV_ADD_SONGS";
      
      public static const const_1360:String = "PLSV_START_PLAYBACK";
      
      public static const const_530:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_54 != const_530)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_442[this.var_54];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_442[const_854];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_442.add(const_530,_loc1_);
