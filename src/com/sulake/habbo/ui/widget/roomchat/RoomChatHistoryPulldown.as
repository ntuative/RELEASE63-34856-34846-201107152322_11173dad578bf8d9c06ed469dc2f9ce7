package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_1070:int = 150;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_43 = param3;
         this.var_2529 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1870 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2532 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1869 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1871 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2531 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2534 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_85 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_366,HabboWindowStyle.const_31,HabboWindowParam.const_63,new Rectangle(0,0,param3.width,param3.height - const_91),null,0,0) as IBitmapWrapperWindow;
         this.var_43.addChild(this.var_85);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_76,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,this.var_43.height - const_91,param3.width,const_91),null,0) as IWindowContainer;
         this.var_43.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_321,HabboWindowStyle.const_47,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_91),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_529:
               this.var_85.blend += param1 / const_1069;
               this._window.blend += param1 / const_1069;
               ...
               break;
            case const_1115:
               this.var_85.blend -= param1 / const_1070;
               this._window.blend -= param1 / const_1070;
      ...
      public function set state(param1:int) : void
      {
         ...
         {
            case const_432:
               if(this._state == const_264)
               {
                  this.state = const_529;
               }
               else
               {
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_43.width - this.var_2530;
         }
         if(this.var_85 != null)
         {
            this.var_85.rectangle = this.var_43.rectangle;
            this.var_85.height -= const_91;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2533 == this._window.width)
         {
            return;
         }
         this.var_2533 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2532;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_1869;
            barX.disposesBitmap = false;
            this.var_2530 = this._window.width - barX.x;
         }
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2529,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1870,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1870,destGripRBitmap);
         ...
         this.var_85.bitmap = this.var_2534;
