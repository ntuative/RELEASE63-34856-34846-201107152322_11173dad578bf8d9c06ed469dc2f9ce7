package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_517:IItemGridWindow;
      
      private var _view:DimmerView;
      
      private var var_1720:XML;
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= this.var_517.numGridItems)
         {
            return;
         }
         this.select(this.var_517.getGridItemAt(param1) as IWindowContainer);
      }
      
      private function populate(param1:IHabboWindowManager) : void
      {
         if(this._view == null || this.var_517 == null)
         {
            return;
         }
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(this.var_1720) as IWindowContainer;
            ...
            _loc3_.width = this.var_614.width;
            _loc3_.height = this.var_614.height;
            this.var_517.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_614.width,this.var_614.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_614,this.var_614.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1157.width,this.var_1157.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_943.width,this.var_943.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_943,this.var_943.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = this.var_517.getGridItemIndex(param1.target as IWindow);
