package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_2100:int = 0;
      ...
      private const const_2097:int = 4;
      
      private const const_2366:int = 0;
      
      private const const_2365:int = 1;
      
      private const const_2361:int = 2;
      
      private const const_2367:int = 3;
      
      private const const_2368:int = 4;
      
      private const const_2364:int = 5;
      
      private const const_2096:String = "deco_img";
      
      private const const_2095:String = "dialog_bg";
      
      private const const_2362:String = "%campaign%_dialog_bg.png";
      
      private const const_392:String = "%campaign%_gift_package.png";
      
      private const const_2360:String = "%campaign%_gift_content.png";
      
      private const const_2363:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1656 = this.var_162.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1656 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1653.length)
         {
            _loc2_ = this.var_1653.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_162 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_781,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_574:
               ...
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_781:
               ...
               this._shareId = null;
               this.var_1655 = param1.itemCategory;
               break;
         ...
         if(this._window && (this.var_1654 != _loc2_ || _loc3_ != this.var_207))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_207 = _loc3_;
         this.var_1654 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
      ...
      override public function get mainWindow() : IWindow
      {
         ...
         if(!this._window)
         {
            switch(this.var_1654)
            {
               ...
               case this.const_2099:
                  ...
                  else if(this.var_433 == this.const_2365)
                  {
                     ...
                     _loc2_ = this.const_2360;
                  }
                  else if(this.var_433 == this.const_2361)
                  {
                  ...
                  else if(this.var_433 == this.const_2368)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_207,"client.show.not_enough_fb_friends");
            ...
            _loc5_ = this.const_2362.replace("%campaign%",this.var_207);
            this.setDecoImage(_loc5_,this.const_2095);
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         var _loc4_:String = this.var_162.getKey("viral.furni.post_type","feed");
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_12)
         {
            if(this.var_1655 != 0)
            {
               this.var_12.toggleInventoryPage(this.var_1655 == 1 ? "null" : InventoryCategory.const_121);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_776,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1653.push(new ImageDownloader(this,_assets,this.var_207,this.var_1656,param1,param2));
            return;
         }
