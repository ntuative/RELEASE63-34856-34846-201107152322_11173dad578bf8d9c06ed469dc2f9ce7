package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class SpamWallPostItFurniWidget extends StickieFurniWidget
   {
      ...
      {
         param1.addEventListener(RoomWidgetSpamWallPostItEditEvent.const_511,this.onEditPostItRequest);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetSpamWallPostItEditEvent.const_511,this.onEditPostItRequest);
      }
      ...
      private function onEditPostItRequest(param1:RoomWidgetSpamWallPostItEditEvent) : void
      {
         ...
         this.var_488 = param1.location;
         var_1412 = param1.objectType;
         _text = "";
         var_361 = "FFFF33";
         var_27 = true;
         showInterface();
      ...
      override protected function sendUpdate() : void
      {
         ...
         if(var_238 != -1)
         {
            ...
            {
               _loc1_ = new RoomWidgetSpamWallPostItFinishEditingMessage(RoomWidgetSpamWallPostItFinishEditingMessage.const_901,var_238,this.var_488,_text,var_361);
