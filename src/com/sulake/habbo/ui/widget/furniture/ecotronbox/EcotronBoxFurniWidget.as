package com.sulake.habbo.ui.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_75,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_98,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_152,this.onRoomObjectRemoved);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_75,this.onPresentUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_75,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_98,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_75,this.onPresentUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetEcotronBoxDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetEcotronBoxDataUpdateEvent.const_75:
               ...
               this.showInterface();
               break;
            case RoomWidgetEcotronBoxDataUpdateEvent.const_98:
               if(!this.var_385)
               {
                  return;
               }
      ...
      private function showInterface() : void
      {
         ...
         this._window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_76,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1511,const_1510,2,2),null,0) as IWindowContainer;
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_904,this.var_238);
