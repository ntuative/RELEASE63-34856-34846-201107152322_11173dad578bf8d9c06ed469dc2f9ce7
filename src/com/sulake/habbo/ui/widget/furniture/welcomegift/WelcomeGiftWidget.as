package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_696:String = "welcome_gift_email_unverified";
      
      private const const_1090:String = "welcome_gift_email_verified";
      
      private const const_1542:String = "welcome_gift_email_change";
      
      private const const_2350:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1246)
         {
            this.setViewState(this.const_1090);
         }
         else
         {
            this.setViewState(this.const_696);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_696:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1025;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_30,this.var_1025);
               break;
            case this.const_1090:
            ...
            case this.const_1542:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1025);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1549;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1542);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_929,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1246 ? this.const_1090 : this.const_696);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1550 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1550));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_494,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_494,this.updateEventHandler);
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_494:
               this.var_1549 = param1.email;
               this.var_1246 = param1.isVerified;
               this.var_1025 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1549 = this.var_1550;
            this.setViewState(this.const_696);
         }
         else
         {
            if(param1.result == this.const_2350)
            {
               this.var_1025 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1550);
