package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1498:String = "${widgets.chatinput.say}";
      ...
      private var var_1861:IWindow;
      
      private var _button:IWindow;
      
      private var var_1860:IWindow;
      
      private var var_1526:IWindow;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1224 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2508 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2507 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_386 = new Timer(1000,1);
         this.var_386.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_452 = new Timer(10000,1);
         this.var_452.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_386.reset();
            this.var_386.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_386 = null;
         }
         if(this.var_452 != null)
         {
            this.var_452.reset();
            this.var_452.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_452 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1861 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_1860 = this._window.findChildByName("send_button_text");
         this.var_1526 = this._window.findChildByName("block_text");
         this.var_1860.caption = const_1498;
         ...
         this.var_26.addEventListener(WindowKeyboardEvent.const_185,this.windowKeyEventProcessor);
         this.var_26.addEventListener(WindowKeyboardEvent.const_378,this.keyUpHandler);
         ...
         this.var_1527 = true;
         this.var_655 = "";
         this._window.addEventListener(WindowEvent.const_586,this.updatePosition);
         this._window.addEventListener(WindowEvent.const_571,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_1861.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1497 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1499);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_26 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1224 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_26.text = "";
                  this.var_655 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_655.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_656);
