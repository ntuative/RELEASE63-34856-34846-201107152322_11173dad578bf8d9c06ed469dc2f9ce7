package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_950:MeMenuSoundSettingsSlider;
      
      private var var_948:BitmapData;
      
      private var var_946:BitmapData;
      
      private var var_949:BitmapData;
      
      private var var_947:BitmapData;
      ...
      {
         this.var_951 = param1.volume;
         if(this.var_950 != null)
         {
            this.var_950.setValue(this.var_951);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_948 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_946 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_949 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_947 = (_loc5_.content as BitmapData).clone();
         }
         this.var_950 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_951 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_947);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_948);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_949);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_946);
         }
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "sounds_on":
               ...
               break;
            case "back_btn":
               this._widget.changeView(MeMenuWidget.const_980);
               break;
            default:
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_817);
         }
         else
         {
