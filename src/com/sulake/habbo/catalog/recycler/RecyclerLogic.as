package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_667 != const_1092;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1930 != RecyclerStatusMessageEvent.const_1341;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_667 == const_481;
      }
      ...
      {
         this.var_667 = const_1093;
         this.var_136 = new Array(const_213);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_213)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_667 = const_1092;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1894:
               this.var_667 = const_481;
            ...
            case RecyclerStatusMessageEvent.const_1341:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1868:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1410:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1926:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_136.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_213)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_136.length < const_213)
         {
            return false;
         }
         var _loc1_:int = 0;
