package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1450:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1476:XML;
      
      private static var var_1475:XML;
       
      
      private var var_1781:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_3070:IWindowContainer;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1781 == 4294967295)
            {
               this.var_1781 = _loc1_.color;
            }
            _loc1_.color = const_1450;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1918;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_2004;
            }
         }
      }
      ...
      {
         this.var_64 = navigator.catalog.windowManager.buildFromXML(var_1475) as IItemListWindow;
         if(this.var_64 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1476) as IWindowContainer;
         }
         else
         {
