package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1929:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array, param5:int) : void
      {
         ...
         {
            if(this.var_250.pageId == param1)
            {
               if(param5 > -1)
               {
                  this.var_250.selectOffer(param5);
               }
               return;
            }
            this._container.removeChild(this.var_250.window);
            this.var_250.dispose();
         }
         var _loc6_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,this.var_1929);
         this.var_250 = _loc6_;
      ...
      {
         return this.var_250.dispatchWidgetEvent(param1);
      }
      ...
      public function getCurrentLayoutCode() : String
      {
         ...
         return this.var_250.layoutCode;
      }
   }
}
