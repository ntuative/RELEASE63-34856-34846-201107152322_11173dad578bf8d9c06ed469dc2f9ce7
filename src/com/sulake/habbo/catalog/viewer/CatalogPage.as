package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2052:String = "ctlg_";
       
      
      protected var var_2260:XML;
      ...
      private var var_565:EventDispatcher;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_565 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1292);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1292);
      }
      ...
      {
         var _loc2_:String = const_2052 + param1;
         ...
         this.var_2260 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2260) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1972:
               if(this.var_1293 == null)
               {
                  this.var_1293 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_38.push(this.var_1293);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1743:
               ...
               break;
            case CatalogWidgetEnum.const_2015:
            ...
            case CatalogWidgetEnum.const_1797:
               ...
               break;
            case CatalogWidgetEnum.const_1867:
               this.var_38.push(new RecyclerCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1781:
            ...
            case CatalogWidgetEnum.const_1818:
               ...
               break;
            case CatalogWidgetEnum.const_2001:
               this.var_38.push(new MarketPlaceOwnItemsCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1858:
            ...
            case CatalogWidgetEnum.const_1912:
               ...
               break;
            case CatalogWidgetEnum.const_1738:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_565.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_565 != null)
         {
            return this.var_565.dispatchEvent(param1);
         }
         return false;
      }
