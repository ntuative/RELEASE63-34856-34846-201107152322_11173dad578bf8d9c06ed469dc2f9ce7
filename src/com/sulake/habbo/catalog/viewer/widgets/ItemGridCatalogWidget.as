package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_514:IItemGridWindow;
      ...
      protected var var_228:Boolean = true;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_902,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_289,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_848,this.deActivateScrollbar);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_212.stop();
            this.var_212.removeEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_212 = null;
         }
         if(this.var_514 != null)
         {
            this.var_514.destroyGridItems();
            this.var_514 = null;
         }
         this.var_2060 = null;
         this.var_239 = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_514 = _window.findChildByName("itemGrid") as IItemGridWindow;
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_859 >= 0 && this.var_859 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_859];
                  this.loadGraphics(_loc4_);
                  _loc4_.productContainer.grid = this;
               }
               ++this.var_859;
               if(this.var_859 >= _loc2_)
               {
                  this.resetTimer();
                  break;
               }
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_2060) as IWindowContainer;
         this.var_514.addGridItem(_loc2_);
         ...
         if(param1.pricingModel == Offer.const_528)
         {
            ++this.var_2029;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_2029);
         }
      }
