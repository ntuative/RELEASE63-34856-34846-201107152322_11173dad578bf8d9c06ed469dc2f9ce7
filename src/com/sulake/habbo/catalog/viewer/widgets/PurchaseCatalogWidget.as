package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_2682:XML;
      
      private var var_2683:XML;
      ...
      private var var_3115:IButtonWindow;
      
      private var var_1955:IButtonWindow;
      
      private var var_1953:ITextWindow;
      ...
      override public function dispose() : void
      {
         ...
         events.removeEventListener(WidgetEvent.const_802,this.onSetParameter);
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc2_ != null)
         {
            this.var_2682 = _loc2_.content as XML;
         }
         var _loc3_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsPixelsStub") as XmlAsset;
         if(_loc3_ != null)
         {
            this.var_2683 = _loc3_.content as XML;
         }
      ...
      private function attachStub(param1:String, param2:int) : void
      {
         ...
         if(this.var_32.hasUserRight(null,param2))
         {
            switch(param1)
            {
               case Offer.const_820:
                  _loc3_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2681) as IWindowContainer;
                  break;
               case Offer.const_1306:
                  _loc3_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2682) as IWindowContainer;
                  break;
               case Offer.const_1225:
                  _loc3_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2683) as IWindowContainer;
                  break;
               default:
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _window.removeChild(this.var_1037);
               this.var_1037.dispose();
            }
            this.var_1037 = _loc3_;
            _window.addChild(_loc3_);
            this.var_1037.x = 0;
            this.var_1037.y = 0;
         }
         this.var_1953 = _window.findChildByName("ctlg_price_credits") as ITextWindow;
         this.var_1954 = _window.findChildByName("ctlg_price_pixels") as ITextWindow;
         ...
         this.var_1955 = window.findChildByName("ctlg_buy_club_button") as IButtonWindow;
         if(this.var_678 != null)
         {
            if(this.var_1570 != null)
            {
               this.var_678.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1570);
            }
            else
            {
               this.var_678.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1570);
         ...
         {
            this.var_1955.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onBuyClub);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_1954 != null)
         {
            ...
            this.var_1954.caption = _loc2_.getKey(_loc4_);
         }
      ...
      {
         this.var_1951 = param1.parameter;
      }
      ...
      private function onPurchase(param1:WindowMouseEvent) : void
      {
         ...
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_105,page.pageId,this.var_1951);
         }
      }
      ...
      private function initPurchase(param1:CatalogWidgetInitPurchaseEvent) : void
      {
         if(this.var_105 != null)
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_105,page.pageId,this.var_1951,param1.enableBuyAsGift);
         }
      }
