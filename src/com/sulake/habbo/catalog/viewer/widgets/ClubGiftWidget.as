package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!this.var_249)
         {
            this.var_249 = this.createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!this.var_249)
         {
            return;
         }
         var _loc4_:IBitmapWrapperWindow = this.var_249.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc4_)
         {
            return;
         }
         ...
         this.var_249.setGlobalPosition(_loc6_.subtract(new Point(this.var_249.width / 2,this.var_249.height / 2)));
         this.var_249.visible = true;
         this.var_249.activate();
      }
