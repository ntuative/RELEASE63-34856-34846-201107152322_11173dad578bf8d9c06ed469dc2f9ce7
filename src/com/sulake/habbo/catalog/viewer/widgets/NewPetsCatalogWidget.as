package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1567:int = 18;
      ...
      private var var_232:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         _loc1_.addEventListener(WindowEvent.const_110,this.onTextWindowEvent);
         ...
         this.var_562 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_562 < 8)
         {
            return false;
         }
         this.var_2729 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_232 != null && this.var_232.length > 0)
         {
            this.var_397 = this.var_232[0];
         }
         else
         {
            this.var_397 = -1;
         }
         this._offers.add(this.var_562,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_232 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1567 && _loc2_ < this.var_232.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_562,this.var_232[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_232 != null && this.var_232.length > 0)
         {
            if(param1 < 0 || param1 > this.var_232.length)
            {
               param1 = 0;
            }
            this.var_397 = this.var_232[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_562,this.var_397),this.getRaceLocalizationKey(this.var_562,this.var_397));
            }
         }
         return this.getRaceLocalizationKey(this.var_562,this.var_397);
      }
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_397 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_562;
         var _loc3_:int = this.var_397;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_397 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
