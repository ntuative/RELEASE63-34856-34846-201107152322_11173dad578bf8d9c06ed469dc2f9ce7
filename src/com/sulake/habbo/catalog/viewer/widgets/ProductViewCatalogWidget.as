package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_583:IDisplayObjectWrapper;
      
      private var var_2120:Point;
      
      private var var_582:IItemGridWindow;
      
      private var var_1666:IScrollbarWindow;
      
      protected var var_2060:XML;
      
      private var var_2926:Array;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_208.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
            this.var_208 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1103 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1352 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_100 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_208 = _window.findChildByName("room_canvas_container") as IWindowContainer;
         if(this.var_208 != null)
         {
            this.var_208.visible = false;
            this.var_583 = this.var_208.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_583 != null && _loc3_ != null)
            {
               this.var_208.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_583.width,this.var_583.height);
               if(_loc4_ != null)
               {
                  this.var_583.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_2120 = new Point(this.var_100.x,this.var_100.y);
         this.var_582 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1666 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_582 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_2060 = _loc1_.content as XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_582 != null)
         {
            this.var_582.visible = false;
            this.var_582.destroyGridItems();
         }
         ...
         this.var_1103.text = _loc4_;
         this.var_1352.text = _loc5_;
         this.var_1103.height = this.var_1103.textHeight + 5;
         this.var_1352.y = this.var_1103.y + this.var_1103.height;
         this.var_1352.height = Math.max(130,this.var_1352.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_528:
                  _loc6_ = this._bundlePreview.clone();
                  if(this.var_582 != null)
                  {
                     this.var_582.visible = true;
                     _loc11_ = _loc2_.productContainer as BundleProductContainer;
                     _loc11_.populateItemGrid(this.var_582,this.var_1666,this.var_2060);
                     this.var_582.scrollV = 0;
                  }
                  if(this.var_208 != null)
                  {
                     this.var_208.visible = false;
               ...
               case Offer.const_414:
                  ...
                  if(this.var_208 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_69 || _loc9_.productType == ProductTypeEnum.const_64 || _loc9_.productType == ProductTypeEnum.const_193)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_69:
                        if(_loc8_ != null && this.var_583 != null)
                        {
                     ...
                     case ProductTypeEnum.const_193:
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 _loc18_.setDirection(AvatarSetType.const_58,3);
                                 _loc18_.initActionAppends();
                                 _loc18_.appendAction(AvatarAction.const_329,AvatarAction.const_521);
                                 _loc18_.appendAction(AvatarAction.const_334,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2926)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2926 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_100 != null && true)
         {
            ...
            this.var_100.x = this.var_2120.x;
            this.var_100.y = this.var_2120.y;
            if(param3 != null)
            {
