package com.sulake.habbo.catalog.club
{
   ...
   public class ClubExtendConfirmationDialog
   {
      ...
      private static const const_1481:String = "your_price_icon";
      
      private static const const_1483:String = "http://images.habbo.com/c_images/catalogue/vip_extend_tsr.png";
      
      private static const const_1484:String = "image/png";
      
      private static const const_1485:int = 2000;
      
      private static const const_1482:int = 75;
      
      protected static const const_2043:uint = 0;
      ...
      private var var_648:IRegionWindow;
      
      private var var_647:ITextWindow;
      
      private var var_383:IBitmapWrapperWindow;
      
      private var var_650:Vector.<BitmapData>;
      
      private var var_797:Timer;
      ...
      public function ClubExtendConfirmationDialog(param1:ClubExtendController, param2:ClubOfferExtendData)
      {
         ...
         this.var_27 = param1;
         this.var_105 = param2;
         this.var_650 = new Vector.<BitmapData>(const_388);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_648)
         {
            this.var_648.removeEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
            this.var_648.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
            this.var_648 = null;
         }
         if(this.var_647)
         {
         ...
         if(this.var_650)
         {
            ...
            {
               this.var_650[_loc1_].dispose();
               this.var_650[_loc1_] = null;
               _loc1_++;
            }
            this.var_650 = null;
         }
      ...
      public function showConfirmation() : void
      {
         ...
         var _loc9_:* = null;
         var _loc10_:* = null;
         if(!this.var_105 || !this.var_27 || this._disposed)
         {
            return;
         }
         ...
         if(this.var_105.subscriptionDaysLeft > 1)
         {
            _loc1_.registerParameter("catalog.club.extend.expiration_days_left","day",this.var_105.subscriptionDaysLeft.toString());
         ...
         this._view.findChildByName("normal_price_price").caption = this.var_105.originalPrice.toString();
         this._view.findChildByName("you_save_price").caption = this.var_105.discountAmount.toString();
         this._view.findChildByName("your_price_price").caption = this.var_105.price.toString();
         this.var_648 = this._view.findChildByName("maybe_later_region") as IRegionWindow;
         this.var_647 = this._view.findChildByName("maybe_later_link") as ITextWindow;
         if(!this.var_648 || !this.var_647)
         {
            return;
         }
         this.var_648.addEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
         this.var_648.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
         ...
         _loc4_.height = 144;
         _loc4_.width = 133;
         this.loadAssetFromUrl("club_teaser","club_teaser",const_1483,const_1484,this.onTeaserLoaded);
         ...
         this.var_383 = this._view.findChildByName(const_1481) as IBitmapWrapperWindow;
         ...
         while(_loc8_ < const_388)
         {
            ...
            this.var_650[_loc8_] = _loc10_.clone();
            _loc8_++;
         }
         this.startAnimation();
      }
      ...
      private function onMouseOutLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_647)
         {
            this.var_647.textColor = const_2043;
         }
      }
      ...
      private function startAnimation() : void
      {
         ...
         this.var_797 = new Timer(const_1485);
         this.var_797.addEventListener(TimerEvent.TIMER,this.onAnimationTrigger);
         this.var_797.start();
      }
      ...
      private function setAnimationFrame() : void
      {
         ...
         if(this.var_383.bitmap)
         {
            this.var_383.bitmap.dispose();
         }
         if(this.var_649 < const_388)
         {
            this.var_383.bitmap = new BitmapData(this.var_383.width,this.var_383.height,true,0);
            this.var_383.bitmap.copyPixels(this.var_650[this.var_649],this.var_650[this.var_649].rect,new Point(0,0));
         }
         else
         {
            Logger.log("Animation frame " + this.var_649);
         }
      }
      
      private function startAnimationFrame() : void
      {
         this.var_448 = new Timer(const_1482,const_388 - 1);
         this.var_448.addEventListener(TimerEvent.TIMER,this.onAnimationFrame);
         this.var_448.addEventListener(TimerEvent.TIMER_COMPLETE,this.onAnimationFrameComplete);
         this.var_448.start();
      }
      ...
      {
         if(!param1 || !param2 || !this.var_27 || !this.var_105 || this._disposed)
         {
            return;
         }
