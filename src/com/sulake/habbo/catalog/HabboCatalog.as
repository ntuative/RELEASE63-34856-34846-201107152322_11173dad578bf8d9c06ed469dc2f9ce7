package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private var var_1166:IRoomSession;
      ...
      private var var_213:CatalogViewer;
      
      private var var_240:ICatalogNavigator;
      
      private var var_110:Purse;
      
      private var var_104:RecyclerLogic;
      
      private var var_151:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var _confirmationDialog:PurchaseConfirmationDialog;
      
      private var var_214:ChargeConfirmationDialog;
      ...
      private var var_2293:Boolean = true;
      
      private var var_1733:Boolean = false;
      
      private var var_2292:GiftWrappingConfiguration;
      
      private var var_1165:ClubGiftController;
      
      private var var_520:ClubBuyController;
      
      private var var_617:ClubExtendController;
      
      private var var_764:Map;
      
      private var var_1167:Boolean = false;
      
      private var var_766:IPurchasableOffer;
      
      private var var_1445:IDragAndDropDoneReceiver;
      
      private var var_62:PlacedObjectPurchaseData;
      
      private var var_1446:Boolean;
      
      private var var_2295:Boolean;
      
      private var var_618:RoomPreviewer;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            this.var_15.events.removeEventListener(RoomSessionEvent.const_79,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1808);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_368.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_520.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2295 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_368.loadProductData(this);
      }
      ...
      {
         if(this._roomEngine != null && this.var_128 != null && this.var_128.getKey("catalog.furniture.animation","RoomObjectVisualizationEnum") == "true")
         {
            if(this.var_618 == null)
            {
               this.var_618 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      {
         return this.var_128.getBoolean("toolbar.new_additions.notification.enabled",false);
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_800 || !this.var_240 || !this.var_240.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_953 = -1;
            this.var_765 = param1;
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_240.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_128.getKey("client.credits.embed.enabled","RoomObjectVisualizationEnum") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_128.getKey("link.format.credits","/credits");
      ...
      {
         return this.var_368.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_368.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_64)
         {
            _loc3_ = this.var_368.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_764.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_110.getActivityPointsForType(ActivityPointTypeEnum.PIXEL)));
         var _loc1_:int = 0;
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_213.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_240 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_213 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_213.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:String = "catalog";
         if(this.var_128.getBoolean("catalog.show.purse",false))
         {
            _loc1_ = "catalog_with_purse";
         }
         var _loc2_:XmlAsset = assets.getAssetByName(_loc1_) as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc2_.content as XML,const_681) as IWindowContainer;
         ...
         _loc4_.setParamFlag(WindowParam.const_288,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_79:
               this.var_1733 = param1.session.isPrivateRoom;
               this.var_1166 = param1.session;
               if(this.var_104 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_151 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1165 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_520 == null)
         {
            this.var_520 = new ClubBuyController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_617 == null)
         {
            this.var_617 = new ClubExtendController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_213 != null)
         {
            this.var_213.catalogWindowClosed();
         }
         if(this.var_104 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_104.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1446 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_240.buildCatalogIndex(_loc2_);
         if(this.var_765 && this.var_765 != "")
         {
            this.var_240.openPage(this.var_765);
            this.var_765 = "";
            this.var_953 = -1;
         }
         else if(this.var_953 > -1)
         {
            this.var_240.openPageById(this.var_953,this.var_1732);
            this.var_953 = -1;
            this.var_1732 = -1;
            this.var_765 = "";
         }
         else if(this.var_1446 && this.var_2295)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_240.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1833));
         }
         else
         {
            this.var_240.loadFrontPage();
         }
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_213.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_213 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_213.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2294 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1318);
         }
         this.var_2294 = false;
         if(this.var_214 != null && !this.var_214.disposed)
         {
            this.var_214.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_128,this.var_110.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2293 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1210);
         }
         this.var_2293 = false;
         if(this.var_214 != null && !this.var_214.disposed)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_376,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_989)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_342,_loc2_.amount));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_376,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_342,_loc2_.points["null"]));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_110.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1183 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1165.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_151 != null)
         {
            this.var_151.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_151 != null)
         {
            this.var_151.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_151 != null)
         {
            this.var_151.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2292 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_151.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onHabboClubOffers(param1:HabboClubOffersMessageEvent) : void
      {
         if(this.var_520 != null)
         {
            this.var_520.onOffers(param1);
         }
      }
      
      private function onHabboClubExtendOffer(param1:HabboClubExtendOfferMessageEvent) : void
      {
         if(this.var_617 != null && this.var_128.getBoolean("club.membership.extend.promotion.enabled",false))
         {
            this.var_617.onOffer(param1);
         }
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_214 == null || this.var_214.disposed)
         {
            this.var_214 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_214.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_764.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_764.add(_loc2_.productCode,_loc3_.slice());
            this.var_213.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "true" == this.var_128.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_128.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_153)
         {
            _loc3_ = this.var_128.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_128.keyExists("catalog.drag_and_drop") || this.var_128.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
         if(!this.var_1166 || !this.var_1166.isRoomOwner)
         {
            return false;
         }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_236);
         ...
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_226);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1167 && param1.type == RoomEngineObjectEvent.const_171)
         {
            this.resetPlacedOfferData(true);
            if(this.var_766 == null || this.var_766.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_766.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_62 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_766);
            _loc5_ = this.var_1445;
            if(_loc5_ != null)
            {
      ...
      public function syncPlacedOfferWithPurchase(param1:IPurchasableOffer) : void
      {
         if(this.var_62)
         {
            if(this.var_62.offerId != param1.offerId)
            {
               this.resetPlacedOfferData();
            }
         }
      ...
      public function resetPlacedOfferData(param1:Boolean = false) : void
      {
         ...
         if(this.var_62 != null)
         {
            if(this.var_62.category == RoomObjectCategoryEnum.const_27)
            {
               this._roomEngine.disposeObjectFurniture(this.var_62.roomId,this.var_62.roomCategory,this.var_62.objectId);
            }
            else if(this.var_62.category == RoomObjectCategoryEnum.const_26)
            {
               switch(this.var_62.furniData.name)
               {
                  case "floor":
                  case "wallpaper":
                  case "landscape":
                     ...
                     break;
                  default:
                     this._roomEngine.disposeObjectWallItem(this.var_62.roomId,this.var_62.roomCategory,this.var_62.objectId);
               }
            }
            else
            {
               this._roomEngine.deleteRoomObject(this.var_62.objectId,this.var_62.category);
            }
            this.var_62.dispose();
            this.var_62 = null;
         }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc9_:* = null;
         var _loc10_:* = null;
         if(this.var_62 != null && this.var_62.productClassId == param1.classId)
         {
            if(this.var_62.roomCategory == this._roomEngine.activeRoomCategory && this.var_62.roomId == this._roomEngine.activeRoomId)
            {
               _loc2_ = param1.stripId;
               _loc3_ = this.var_62.category;
               _loc4_ = this.var_62.wallLocation;
               _loc5_ = this.var_62.x;
               _loc6_ = this.var_62.y;
               _loc7_ = this.var_62.direction;
               switch(param1.category)
               {
                  case FurniCategory.const_330:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_222);
                     if(this.var_62.extraParameter != _loc8_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
                  case FurniCategory.const_327:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_236);
                     if(this.var_62.extraParameter != _loc9_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
                  case FurniCategory.const_374:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_226);
                     if(this.var_62.extraParameter != _loc10_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_128.getKey("image.library.catalogue.url");
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_681);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_618 != null)
         {
            this.var_618.updatePreviewRoomView();
         }
      }
   }
}
