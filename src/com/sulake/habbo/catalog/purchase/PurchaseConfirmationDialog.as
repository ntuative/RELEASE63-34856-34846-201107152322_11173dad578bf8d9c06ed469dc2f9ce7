package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2356:int = 10;
      ...
      private const const_2069:uint = 4.293848814E9;
      
      private const const_2070:uint = 4.294967295E9;
      
      private const const_1554:uint = 4.291613146E9;
      ...
      public function showOffer(param1:IHabboCatalog, param2:IRoomEngine, param3:IPurchasableOffer, param4:int, param5:String = "", param6:Array = null) : void
      {
         ...
         this.var_1263 = param3.offerId;
         this.var_1566 = param4;
         this.var_1567 = param5;
         this.var_257 = param6;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1263 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            _loc6_.addEventListener(WindowEvent.const_110,this.onNameInputChange);
            _loc6_.addEventListener(WindowMouseEvent.const_46,this.onNameInputMouseDown);
            _loc6_.addEventListener(WindowKeyboardEvent.const_378,this.onNameInputKeyUp);
         }
         var _loc7_:ITextFieldWindow = this._window.findChildByName("message_input") as ITextFieldWindow;
         if(_loc7_ != null)
         {
            _loc7_.addEventListener(WindowMouseEvent.const_46,this.onMessageInputMouseDown);
            _loc7_.addEventListener(WindowEvent.const_359,this.onMessageInputFocus);
         }
         this.var_1944 = true;
         this.var_1943 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               _loc12_.addEventListener(WindowEvent.const_369,this.onFreeWrappingSelected);
               _loc12_.addEventListener(WindowEvent.const_619,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1945 = _loc1_.stuffTypes;
            this.var_830 = _loc1_.boxTypes;
            this.var_831 = _loc1_.ribbonTypes;
            this.var_1262 = this.var_1945[0];
            this.var_395 = this.var_830[0];
            this.var_393 = this.var_831[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_393 < 0)
         {
            this.var_393 = this.var_831.length - 1;
         }
         if(this.var_393 > this.var_831.length - 1)
         {
            this.var_393 = 0;
         }
         if(this.var_395 < 0)
         {
            this.var_395 = this.var_830.length - 1;
         }
         if(this.var_395 > this.var_830.length - 1)
         {
            this.var_395 = 0;
         }
         var _loc1_:int = this.var_830[this.var_395] * 1000 + this.var_831[this.var_393];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1262,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1568 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1945)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1262);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_830[this.var_395]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_831[this.var_393]);
         this._catalog.purchaseProductAsGift(this.var_1566,this.var_1263,this.var_1567,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1566,this.var_1263,this.var_1567);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         if(this.var_2664 == _loc2_.text)
         {
            return;
         }
         var _loc3_:String = _loc2_.text.toLowerCase();
         var _loc4_:* = [];
         for each(_loc5_ in this.var_257)
         {
            if(_loc5_.toLowerCase().search(_loc3_) != -1)
            {
               _loc4_.push(_loc5_);
            }
            if(_loc4_.length >= this.const_2356)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2664 = _loc2_.text;
      }
      ...
      private function onNameInputKeyUp(param1:WindowEvent) : void
      {
         ...
         {
            case Keyboard.UP:
               this.highlightSuggestion(this.var_394 - 1);
               break;
            case Keyboard.DOWN:
               this.highlightSuggestion(this.var_394 + 1);
               break;
      ...
      {
         if(this.var_284 == null || !this.var_284.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_284.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_394) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_284 == null)
         {
            this.var_284 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_832 == null)
         {
            this.var_832 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_284 == null || this.var_832 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_284.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_832.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_284.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_394) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_394);
         }
         this.var_394 = param1;
         if(this.var_394 < 0)
         {
            this.var_394 = _loc2_.numListItems - 1;
         }
         if(this.var_394 >= _loc2_.numListItems)
         {
            this.var_394 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_394) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1554;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2069) : uint(this.const_2070);
      }
      ...
      {
         this.var_1262 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1262;
               }
            }
            _loc4_++;
         }
