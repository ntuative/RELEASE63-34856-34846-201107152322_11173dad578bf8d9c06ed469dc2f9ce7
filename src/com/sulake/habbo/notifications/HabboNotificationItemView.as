package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      private static const const_529:int = 1;
      ...
      private var var_266:HabboNotificationItem;
      ...
      private var var_1288:uint;
      
      private var var_1287:uint;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1989 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1989 = 15;
         }
         this.var_1990 = this._window.height;
         this.var_1592 = 4;
         this._blend = 0;
         this._state = name_4;
      ...
      {
         if(param1.badgeId != this.var_266.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_529:
               ...
               _loc2_ = Number(this.var_1288) / Number(this.var_1053["time_fade_in"]);
               if(this.var_1288 > int(this.var_1053["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1114:
               ...
               if(this.var_1593 > int(this.var_1053["time_display"]) && !this.var_1988)
               {
                  this.startFadeOut();
               }
               break;
            case const_1115:
               ...
               _loc3_ = 1 - Number(this.var_1287) / Number(this.var_1053["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1287 > int(this.var_1053["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1989;
         if(this._window.height < this.var_1990)
         {
            this._window.height = this.var_1990;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1769;
         this._window.y = this.var_1592;
      }
