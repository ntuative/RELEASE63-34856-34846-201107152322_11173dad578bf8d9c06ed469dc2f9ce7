package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1723:String = "pixelbalance";
      
      private static const const_1720:String = "badges";
      
      private static const const_1722:String = "selectbadge";
      
      private static const const_1721:String = "inventory";
      
      private static const const_1726:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1724:String = "friendlist";
      
      private static const const_1727:String = "pet_inventory";
      
      private static const const_1725:String = "go_to_room";
      ...
      private var var_2197:IHabboToolbar;
      ...
      private var var_600:HabboNotificationViewManager;
      
      private var var_264:HabboAlertDialogManager;
      
      private var var_918:ParkBusDialogManager;
      
      private var var_3030:Boolean;
      
      private var var_1134:ClubGiftNotification;
      
      private var var_1132:ClubEndingNotification;
      
      private var var_1131:ClubPromoNotification;
      
      private var var_3100:Dictionary;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2076 = false;
         this.var_3100 = new Dictionary();
         var _loc4_:IAsset = this._assetLibrary.getAssetByName("habbo_notifications_config_xml");
         var _loc5_:XmlAsset = XmlAsset(_loc4_);
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1133);
         }
         var _loc6_:Map = this.var_1133["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1133["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_1398.push(_loc8_);
         return this.var_1398.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1398.splice(0,1);
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_264 = new HabboAlertDialogManager(this._windowManager,this._localization);
         if(this._communication)
         {
      ...
      {
         this.var_2197 = param2 as IHabboToolbar;
      }
      ...
      {
         this.var_600 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this._config,this.var_2197,this.var_1133["styles"],this.var_1133["view"]);
         ...
         registerUpdateReceiver(this.var_600,1);
         registerUpdateReceiver(this,2);
         this.var_368.events.addEventListener(BadgeImageReadyEvent.const_214,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_368.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1201,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1201,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1928,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_900,null);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_368.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_64)
               {
                  _loc7_ = this.var_368.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_368.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1977,_loc5_);
               }
            }
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_64:
               ...
               break;
            case CatalogPageMessageProductData.const_193:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1410)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1790,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1131 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      private function checkClubEndingNotification(param1:ScrSendUserInfoMessageParser) : void
      {
         ...
         if(_loc2_ > 0 && param1.daysToPeriodEnd > 0 && param1.daysToPeriodEnd <= _loc2_ && param1.periodsSubscribedAhead == 0)
         {
            ...
            this.var_1132 = new ClubEndingNotification(param1.daysToPeriodEnd,param1.isVIP,assets,this._windowManager,this._catalog,this._localization);
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_600.isSpaceAvailable() && this.var_1398.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_600.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      {
         if(param1 != null && this.var_600 != null)
         {
            this.var_600.replaceIcon(param1);
         }
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_264 == null)
         {
            return;
         }
         this.var_264.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_264.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         this.var_264.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_264.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_264.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_918 == null)
         {
            this.var_918 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_918 != null)
         {
            this.var_918.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1293,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1293,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_1110.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_61);
            if(_loc6_ != null)
            {
               _loc6_.setDirection(AvatarSetType.const_43,3);
               _loc4_ = _loc6_.getCroppedImage(AvatarSetType.const_58);
               _loc6_.dispose();
            }
         }
         else
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_3030)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_900,null);
            this.var_3030 = true;
      ...
      {
         if(param2.type == WindowEvent.const_153 || param2.type == WindowEvent.const_645)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1134 && this.var_1134.visible)
         {
            return;
         }
         this.var_1134 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog,this.var_2197);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_900,_loc6_);
      }
   }
}
