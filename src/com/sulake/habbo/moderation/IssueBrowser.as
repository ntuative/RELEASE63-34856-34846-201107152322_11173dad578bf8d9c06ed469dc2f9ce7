package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2371:String = "my_issues";
      
      private const const_2372:String = "open_issues";
      
      private const const_2370:String = "picked_issues";
      ...
      private var var_415:IIssueBrowserView;
      
      private var var_2137:IIssueBrowserView;
      
      private var var_2138:IIssueBrowserView;
      
      private var var_2136:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_303 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_303.numTabItems)
            {
               _loc5_ = this.var_303.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_48,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_303 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_303 == null || this.var_303.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_303.selector.getSelectableByName("open_issues");
         this.var_303.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_415 == _loc2_)
         {
            return;
         }
         if(this.var_415 != null)
         {
            this.var_415.visible = false;
         }
         this.var_415 = _loc2_;
         if(this.var_415 == null)
         {
         ...
         this.var_415.view.width = this.var_303.container.width;
         this.var_415.view.height = this.var_303.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2371:
               if(this.var_2137 == null)
               {
                  this.var_2137 = new MyIssuesView(this.issueManager,this,this.var_303.container);
               }
               return this.var_2137;
            case this.const_2372:
               if(this.var_2138 == null)
               {
                  this.var_2138 = new OpenIssuesView(this.issueManager,this,this.var_303.container);
               }
               return this.var_2138;
            case this.const_2370:
               if(this.var_2136 == null)
               {
                  this.var_2136 = new PickedIssuesView(this.issueManager,this,this.var_303.container);
               }
