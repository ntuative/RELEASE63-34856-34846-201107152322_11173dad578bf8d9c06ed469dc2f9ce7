package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_787:IssueMessageData = null;
      
      private var var_788:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2382 = param2.pickerUserId;
         this.var_2383 = param2.pickerUserName;
         this.var_1474 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1198 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1199;
         }
         if(this.var_787 == null || param1.timeStamp < this.var_787.timeStamp)
         {
            this.var_787 = param1;
         }
         if(this.var_788 == null || param1.priority > this.var_788.timeStamp)
         {
            this.var_788 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_788;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_787;
         if(_loc2_ == null)
         {
