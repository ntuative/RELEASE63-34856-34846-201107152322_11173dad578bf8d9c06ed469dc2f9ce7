package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1107:Array = [];
      
      private static var var_2130:int = 200;
      ...
      {
         this.var_889 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1744;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1107.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_889.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1107.length < var_2130)
         {
            ...
            param1.width = this.var_889.width;
            param1.height = this.var_889.height;
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1672)
         {
