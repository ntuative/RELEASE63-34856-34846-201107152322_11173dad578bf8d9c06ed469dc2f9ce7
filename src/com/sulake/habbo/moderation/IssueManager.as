package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1384:String = "issue_bundle_open";
      
      public static const const_764:String = "issue_bundle_my";
      
      public static const const_1219:String = "issue_bundle_picked";
      
      public static const const_1898:int = 15000;
       
      
      private var var_75:ModerationManager;
      
      private var var_662:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_662 = new IssueBrowser(this,this.var_75.windowManager,this.var_75.assets);
         this.var_1237 = [];
         this.var_1236 = [];
         this.var_1017 = new Map();
         this.var_2581 = parseInt(this.var_75.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1900 = new Timer(const_1898,0);
         this.var_1900.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1900.start();
      }
      ...
      {
         var _loc4_:IssueBundle = this.var_123.getValue(param1) as IssueBundle;
         if(_loc4_ == null)
         {
            return;
         }
         this.sendPick(_loc4_.getIssueIds(),param2,param3);
         this.var_1237 = this.var_1237.concat(_loc4_.getIssueIds());
      }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Array = this.var_123.getValues();
      ...
      public function releaseAll() : void
      {
         ...
         var _loc2_:* = [];
         for each(_loc3_ in this.var_123)
         {
      ...
      public function releaseBundle(param1:int) : void
      {
         ...
         var _loc2_:IssueBundle = this.var_123.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1236 = this.var_1236.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_662 == null || !this.var_662.isOpen())
         {
            this.var_75.soundManager.playSound(HabboSoundTypesEnum.const_1409);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_1016.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_123.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  {
                     this.var_123.remove(_loc3_.id);
                     this.removeHandler(_loc3_.id);
                  }
                  this.var_1016.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1996)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_123)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_1016.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2582++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_1016.add(param1.issueId,_loc2_);
            this.var_123.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         }
         if(this.var_1237.indexOf(param1.issueId) != -1)
         {
         ...
         {
            _loc6_ = this.getBundles(const_764);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1236.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2581);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_1017.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_1017.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_1016.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_123.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_1017.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_1017.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      {
         var _loc3_:IssueBundle = this.var_123.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = this.var_123.getValues();
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            _loc8_ = null;
            for each(_loc9_ in this.var_123)
            {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_1017.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
