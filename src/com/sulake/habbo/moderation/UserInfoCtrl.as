package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1086:int = 60;
      
      private static const const_1085:int = 3600;
      
      private static const const_1083:int = 86400;
      
      private static const const_1084:int = 31536000;
      ...
      {
         if(param1 < 2 * const_1086)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_1085)
         {
            return Math.round(param1 / const_1086) + " mins ago";
         }
         if(param1 < 2 * const_1083)
         {
            return Math.round(param1 / const_1085) + " hours ago";
         }
         if(param1 < 2 * const_1084)
         {
            return Math.round(param1 / const_1083) + " days ago";
         }
         return Math.round(param1 / const_1084) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_35,WindowTracker.const_1188,this._data.userId),this._callerFrame,this.var_1235,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new RoomVisitsCtrl(this.var_35,this._data.userId),this._callerFrame,this.var_1235,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new SendMsgsCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1513),this._callerFrame,this.var_1235,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ModActionCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1513),this._callerFrame,this.var_1235,false,true);
      }
