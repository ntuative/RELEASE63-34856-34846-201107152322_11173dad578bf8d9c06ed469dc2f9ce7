package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1277:IDropMenuWindow;
      
      private var var_542:ITextFieldWindow;
      
      private var var_621:Boolean = true;
      
      private var var_1042:ICheckBoxWindow;
      
      private var var_1574:ICheckBoxWindow;
      
      private var var_1573:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_370));
         Logger.log("BEGINNING TO SHOW: " + this.var_370);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1960;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_370);
         if(param1.flatId != this.var_370)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_370);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1277 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1277);
         this.var_1277.procedure = this.onSelectTemplate;
         this.var_1042 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1574 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1573 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_833,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_621 || this.var_542.text == "")
         {
            this.var_35.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_1042.isSelected);
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1967,_loc2_,this.var_542.text,"",""));
         if(this.var_1574.isSelected || this.var_1573.isSelected || this.var_1042.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1574.isSelected,this.var_1573.isSelected,this.var_1042.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1945);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1785);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1277.selection];
         if(_loc3_ != null)
         {
            this.var_621 = false;
