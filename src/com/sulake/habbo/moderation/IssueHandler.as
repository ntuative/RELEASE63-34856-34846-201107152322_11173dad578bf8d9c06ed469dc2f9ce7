package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_176:IssueBundle;
      
      private var _window:IFrameWindow;
      
      private var var_549:UserInfoCtrl;
      
      private var var_1248:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = this.var_176.getHighestPriorityIssue();
         this.var_549 = new UserInfoCtrl(this._window,this.var_75,_loc3_.message);
         this.var_1248 = new UserInfoCtrl(this._window,this.var_75,_loc3_.message);
         this.var_549.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(this._window.findChildByName("reported_user_info"));
         if(this.var_176.reportedUserId > 0)
         {
            this.var_1248.load(_loc4_,this.var_176.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_176.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_176.issues;
         var _loc3_:int = 0;
      ...
      {
         if(this.var_75 != null && this.var_75.issueManager != null && this.var_176 != null)
         {
            this.var_75.issueManager.removeHandler(this.var_176.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_75.issueManager.closeBundle(this.var_176.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_75.issueManager.closeBundle(this.var_176.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_75.issueManager.closeBundle(this.var_176.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_75.issueManager.releaseBundle(this.var_176.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_176.getHighestPriorityIssue().issueId;
         this.var_75.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_75,WindowTracker.const_1335,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_176.getHighestPriorityIssue();
            this.var_549 = new UserInfoCtrl(this._window,this.var_75,_loc3_.message);
            this.var_549.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
