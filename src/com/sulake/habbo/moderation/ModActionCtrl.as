package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1218:IDropMenuWindow;
      ...
      private var var_996:OffenceCategoryData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1219 = IButtonWindow(this.var_35.getXmlWindow("modact_offence"));
         this.var_1220 = IButtonWindow(this.var_35.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1850;
         ...
         this.var_1218 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1218);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_996 != null;
         ...
         else if(this.var_996 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_996.offences,this.var_1219,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_35.initMsg.offenceCategories,this.var_1220,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1796;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModAlertMessageComposer(this.var_1514,this.var_542.text,this.var_1513));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_996 = this.var_35.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_997 = this.var_996.offences[_loc3_];
         this.var_542.text = this.var_997.msg;
         this.var_621 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModKickMessageComposer(this.var_1514,this.var_542.text,this.var_1513));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1218.selection < 0)
         {
            this.var_35.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_35.connection.send(new ModBanMessageComposer(this.var_1514,this.var_542.text,this.getBanLength(),this.var_1513));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1218.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1219.destroy();
            this.var_1219 = null;
         }
         if(this.var_1220 != null)
         {
            this.var_1220.destroy();
            this.var_1220 = null;
         }
         this.var_1218 = null;
         this.var_542 = null;
