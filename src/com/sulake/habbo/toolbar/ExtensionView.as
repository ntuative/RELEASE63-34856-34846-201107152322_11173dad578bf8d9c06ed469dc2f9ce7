package com.sulake.habbo.toolbar
{
   ...
   public class ExtensionView implements IExtensionView
   {
      ...
      private var var_127:IItemListWindow;
      ...
      public function ExtensionView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:HabboToolbar)
      {
         ...
         if(_loc4_)
         {
            this.var_127 = param1.buildFromXML(_loc4_.content as XML,1) as IItemListWindow;
         }
         var _loc5_:IWindowContainer = this.var_127.desktop;
         if(this.var_127)
         {
            this.var_127.x = _loc5_.width - this.var_127.width - const_1045;
            this.var_127.y = const_1045;
            this.var_127.visible = true;
         }
         else
         {
            Core.error("Unable to initialize Toolbar Extension view window from xml asset",false,Core.const_1316);
         }
         this._items = new Map();
      }
      ...
      public function get screenHeight() : uint
      {
         ...
         return this.var_127.height + this.var_127.y;
      }
      ...
      public function attachExtension(param1:String, param2:IWindow, param3:int = -1) : void
      {
         ...
         if(this.var_127)
         {
            if(param3 == -1)
            {
               this.var_127.addListItem(param2);
            }
            else
            {
               this.var_127.addListItemAt(param2,param3);
            }
            this.var_127.invalidate();
         }
      ...
      public function detachExtension(param1:String) : void
      {
         ...
         if(this.var_127)
         {
            this.var_127.removeListItem(_loc2_);
         }
