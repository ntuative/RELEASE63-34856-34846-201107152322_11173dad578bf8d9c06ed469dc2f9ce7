package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1457:Point = new Point(3,3);
      
      private static const const_1516:uint = 7433577;
      
      private static const const_1515:uint = 5723213;
      
      private static const const_478:String = "_hover";
      
      private static const const_476:String = "_normal";
      
      private static const const_477:int = 5;
      
      private static const const_1519:int = 600;
      
      private static const const_1518:int = 80;
      
      private static const const_1512:int = 74;
      
      private static const ICON_SPACING_NORMAL:int = 10;
      
      private static const const_1514:int = -2;
      
      private static const const_1517:int = 5;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1457;
         this._window.addEventListener(WindowEvent.const_586,this.onParentResized);
         ...
         {
            this.setIconHoverState(_loc11_,const_476);
         }
         ...
         this.var_222 = param2.buildFromXML(_loc12_.content as XML,2) as IWindowContainer;
         ...
         _loc13_.addChild(this.var_222);
         var _loc14_:ITextWindow = this.var_222.findChildByName("new_textfield") as ITextWindow;
         ...
         this.var_222.x = _loc13_.width - this.var_222.width - const_477;
         this.var_222.y = const_477;
         this.var_2571 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1519;
         if(!param1 && _loc2_ == this.var_1537)
         {
            return;
         }
         this.var_1537 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1512) : int(const_1518);
         var _loc4_:int = !!_loc2_ ? int(const_1514) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1517 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_222 != null && this.var_2571)
               {
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               this.setIconHoverState(_loc4_,const_478);
               this.setIconBgHoverState(_loc3_,const_478);
               break;
            case WindowMouseEvent.const_25:
               this.setIconHoverState(_loc4_,const_476);
               this.setIconBgHoverState(_loc3_,const_476);
         }
      }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_478 ? this.var_1539 : this.var_1538;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_478)
         {
            param1.color = const_1516;
         }
         else
         {
            param1.color = const_1515;
         }
      }
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1537 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1537 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1538 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1539)
         {
            this.var_1539.dispose();
         }
         this.var_1539 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1013.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_477;
            _loc2_.y = const_477;
      ...
      {
         return this._config.getKey("toolbar.new_additions.notification.enabled","RoomObjectVisualizationEnum") == "true";
      }
   }
}
