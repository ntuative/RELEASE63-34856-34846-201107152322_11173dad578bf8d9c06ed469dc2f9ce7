package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1555:uint = 16777215;
      
      private static const const_1554:uint = 12247545;
      
      private static const const_1553:String = "HELP";
      ...
      public function ExtraToolsExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_426 = this._window.findChildByName("roominfo_region");
      ...
      {
         this.var_64.removeListItem(this.var_426);
      }
      
      public function showRoomInfo() : void
      {
         this.var_64.addListItemAt(this.var_426,0);
      }
      ...
      private function showConfirmation() : void
      {
         ...
         if(!this.var_335)
         {
            this.var_335 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
            _loc1_ = new Point();
            this._window.getGlobalPosition(_loc1_);
            this.var_335.x = _loc1_.x + this._window.width - this.var_335.width;
            this.var_335.y = _loc1_.y + this._window.height - this.var_335.height;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1553);
               break;
