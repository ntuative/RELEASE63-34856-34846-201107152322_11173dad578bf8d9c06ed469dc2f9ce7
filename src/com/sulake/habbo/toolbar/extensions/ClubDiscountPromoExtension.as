package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ClubDiscountPromoExtension
   {
      ...
      private static const const_690:String = "club_promo";
      
      private static const const_1439:int = 13;
      
      private static const const_1062:int = 14;
      
      private static const const_1440:uint = 16777215;
      
      private static const const_1441:uint = 12247545;
      ...
      private var var_640:IExtensionView;
      ...
      private var var_1206:IRegionWindow;
      ...
      public function ClubDiscountPromoExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager, param6:ICoreLocalizationManager, param7:IHabboInventory, param8:IHabboCatalog, param9:IConnection)
      {
         ...
         this.var_640 = param1.extensionView;
         if(this.var_12)
         {
            this.var_12.events.addEventListener(HabboInventoryHabboClubEvent.const_338,this.onClubChanged);
         }
      }
      ...
      private function createWindow(param1:IAssetLibrary, param2:IHabboWindowManager) : IWindowContainer
      {
         ...
         if(_loc4_)
         {
            ...
            if(_loc3_)
            {
               ...
               this.var_1206 = _loc3_.findChildByName("text_region") as IRegionWindow;
               if(this.var_1206)
               {
                  this.var_1206.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onTextRegionClicked);
                  this.var_1206.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onTextRegionMouseOver);
                  this.var_1206.addEventListener(WindowMouseEvent.const_25,this.onTextRegionMouseOut);
               }
               this.assignState();
            }
         }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            if(this.var_640)
            {
               this.var_640.detachExtension(const_690);
               this.var_640 = null;
            }
            this.animate(false);
            this.clearAnimation();
            ...
            if(this.var_12)
            {
               this.var_12.events.removeEventListener(HabboInventoryHabboClubEvent.const_338,this.onClubChanged);
               this.var_12 = null;
            }
            this._catalog = null;
      ...
      private function onClubChanged(param1:HabboInventoryHabboClubEvent) : void
      {
         if(this.var_12.clubIsExpiring)
         {
            if(!this._view)
            {
               ...
               this.assignState();
               this.var_640.attachExtension(const_690,this._view,ExtensionFixedSlotsEnum.const_1809);
            }
         }
         else
         {
      ...
      private function animate(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            this.var_644 = new Timer(15000);
            this.var_644.addEventListener(TimerEvent.TIMER,this.onTriggerTimer);
            this.var_644.start();
         }
         else
         {
      ...
      private function onAnimationTimer(param1:TimerEvent) : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         this.var_84.x = 3 + this.var_1499 / 20 * this.var_1820;
