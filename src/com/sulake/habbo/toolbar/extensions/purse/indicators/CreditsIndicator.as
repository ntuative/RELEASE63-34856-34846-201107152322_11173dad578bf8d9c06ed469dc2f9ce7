package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class CreditsIndicator extends CurrencyIndicatorBase
   {
      ...
      private static const const_1425:uint = 4291993382;
      
      private static const const_1424:uint = 4290807040;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(PurseEvent.const_128,this.onCreditBalance);
      }
      ...
      private function onCreditBalance(param1:PurseEvent) : void
      {
         ...
         if(this.var_1728 != -1)
         {
            if(this.var_1728 > param1.balance)
            {
