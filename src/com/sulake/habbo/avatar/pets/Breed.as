package com.sulake.habbo.avatar.pets
{
   public class Breed extends PetEditorInfo implements IBreed
   {
      ...
      private var var_2778:Boolean = true;
      ...
      public function Breed(param1:XML)
      {
         ...
         this.var_2786 = parseInt(param1.@pattern);
         this.var_1067 = String(param1.@gender);
         this.var_1641 = Boolean(parseInt(param1.@colorable));
         this.var_2563 = String(param1.@localizationKey);
