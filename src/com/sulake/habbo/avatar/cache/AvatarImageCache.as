package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_2073:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1571:IAvatarImage;
      ...
      private var var_381:IActiveActionData;
      
      private var var_503:AvatarImageBodyPartContainer;
      
      private var var_1497:String;
      
      private var var_131:AvatarImagePartContainer;
      
      private var var_2403:Point;
      ...
      private var var_2405:ByteArray;
      
      private var var_2404:ImageData;
      
      private var var_1118:PaletteMap;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_792 == GeometryType.const_1277 && param1 == GeometryType.const_1327 || this.var_792 == GeometryType.const_1327 && param1 == GeometryType.const_1277)
         {
            this.var_792 = param1;
            this.var_99 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         this.var_381 = this._bodyPartCache.getAction();
         var _loc5_:IActiveActionData = this.var_381;
         var _loc6_:* = [];
         var _loc7_:Dictionary = new Dictionary();
         var _loc8_:Point = new Point();
         if(!(!this.var_381 || !this.var_381.definition))
         {
            if(this.var_381.definition.isAnimation)
            {
               _loc11_ = _loc3_;
               _loc12_ = this._structure.getAnimation(this.var_381.definition.state + "." + this.var_381.actionParameter);
               _loc13_ = param2 - this.var_381.startFrame;
               if(_loc12_ != null)
               {
                  _loc14_ = _loc12_.getLayerData(_loc13_,param1,this.var_381.overridingAction);
                  if(_loc14_ != null)
                  {
                     ...
                     {
                        this.var_381 = _loc14_.action;
                     }
                     if(_loc14_.type == AnimationLayerData.const_771)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_605)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         var _loc9_:AvatarImageActionCache = this._bodyPartCache.method_5(_loc5_);
         if(_loc9_ == null)
         {
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1571.getFigure(),_loc5_,this.var_792,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_503 = _loc10_.getImageContainer(_loc4_);
         if(this.var_503 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_503 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_381);
            if(this.var_503 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_503,_loc4_);
         }
         this.var_503.offset = _loc8_;
         return this.var_503;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_99)
         {
            this.var_99 = this._structure.getCanvas(this._scale,this.var_792);
            if(!this.var_99)
            {
               return null;
            }
            this.var_2403 = new Point(0,this.var_99.height - int(this.var_99.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1837[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_856 || _loc10_ == AvatarAction.const_409;
         var _loc12_:int = param2.length - 1;
         _loc8_ = _loc12_;
         while(_loc8_ >= 0)
         {
            this.var_131 = param2[_loc8_] as AvatarImagePartContainer;
            if(!(param1 == 7 && (this.var_131.partType == "fc" || this.var_131.partType == "ey")))
            {
               this.var_1497 = this.var_131.bodyPartId;
               this.var_197 = this.var_131.partType;
               this.var_1816 = this.var_131.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_131.flippedPartType != this.var_197)
                     {
                        this.var_197 = this.var_131.flippedPartType;
                     }
                  }
               }
               this.var_1496 = this._scale + "_" + this.var_131.action.assetPartDefinition + "_" + this.var_197 + "_" + this.var_1816 + "_" + _loc5_ + "_" + this._frame;
               this.var_446 = this._assets.getAssetByName(this.var_1496) as BitmapDataAsset;
               if(this.var_446 == null)
               {
                  this.var_1496 = this._scale + "_std_" + this.var_197 + "_" + this.var_1816 + "_" + _loc5_ + "_0";
                  this.var_446 = this._assets.getAssetByName(this.var_1496) as BitmapDataAsset;
               }
               if(!(!this.var_446 || !this.var_446.content))
               {
                  ...
                  {
                     this.var_1118 = this._structure.renderManager.paletteManager.getPalette(this.var_131.paletteMapId);
                     if(this.var_1118 != null)
                     {
                        this.var_988 = this.var_446.content as BitmapData;
                        this.var_196 = new BitmapData(this.var_988.width,this.var_988.height);
                        this.var_2405 = this.var_1118.colorize(this.var_988.getPixels(this.var_988.rect));
                        this.var_196.setPixels(this.var_196.rect,this.var_2405);
                     }
                     else
                     {
                        this.var_196 = (this.var_446.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1497 == AvatarBodyPartType.const_246 || this.var_1497 == AvatarBodyPartType.const_1782 || this.var_1497 == AvatarBodyPartType.const_1876) && this.var_131.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_196.colorTransform(this.var_196.rect,this.var_131.color.colorTransform);
                  }
                  if(this.var_131.isBlendable)
                  {
                     this.var_196.colorTransform(this.var_196.rect,this.var_131.blendTransform);
                  }
                  this.var_987 = this.var_446.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_61)
                     {
                  ...
                  this.var_2404 = new ImageData(this.var_196,this.var_987,_loc7_);
                  this.var_986.push(this.var_2404);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_986,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2403.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_61)
            {
         ...
         _loc8_ = this.var_986.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_986.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
