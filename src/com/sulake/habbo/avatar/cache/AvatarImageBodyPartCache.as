package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageBodyPartCache
   {
      ...
      private var var_796:IActiveActionData;
      ...
      public function setAction(param1:IActiveActionData, param2:int) : void
      {
         ...
         var _loc3_:AvatarImageActionCache = this.method_5(this.var_796);
         if(_loc3_ != null)
         {
      ...
      public function method_5(param1:IActiveActionData = null) : AvatarImageActionCache
      {
         if(!this.var_796)
         {
            return null;
