package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2094:Number = 1.0;
      
      private var var_2093:Number = 1.0;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1303:Map;
      
      private var var_2821:Boolean = true;
      
      public function AvatarDataContainer(param1:XML)
      {
         super();
         this.var_2027 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2823 = parseInt(_loc2_,16);
         this.var_2822 = parseInt(_loc3_,16);
         ...
         this.var_883 = new ColorTransform(this.var_2092,this.var_2094,this.var_2093,this._alphaMultiplier);
         this.var_1303 = this.generatePaletteMapForGrayscale(this.var_2822,this.var_2823);
      }
      ...
      {
         return this.var_1303.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1303.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1303.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1303.getValue("alphas") as Array;
      }
