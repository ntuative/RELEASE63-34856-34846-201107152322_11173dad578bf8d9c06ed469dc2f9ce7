package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      private var var_1147:IAnimation;
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_2027 = parseInt(param2.@ink);
         this.var_2652 = String(param2.@member);
         this.var_2651 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1556 = [];
         this.var_1557 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1556[_loc4_] = parseInt(_loc3_.@dy);
      ...
      {
         if(param1 < this.var_1556.length)
         {
            return this.var_1556[param1];
         }
         return 0;
      }
