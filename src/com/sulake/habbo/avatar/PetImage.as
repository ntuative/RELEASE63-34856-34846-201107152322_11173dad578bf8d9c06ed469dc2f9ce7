package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_611:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_58)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1509);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_317.definition.geometryType);
         if(this.var_48 == null || _loc4_ != null && (this.var_48.width != _loc4_.width || this.var_48.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_317.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_725);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc16_ = this.var_1509 < 3;
               _loc17_ = !!_loc16_ ? 32 : 67;
               if(this._scale == AvatarScaleType.const_108)
               {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_725);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_725);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_725);
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_587 = this.var_587 + param1 + _loc3_;
         switch(param1)
         {
      ...
      private function sortActions() : void
      {
         ...
         this.var_1510 = this._structure.sortActions(this.var_363);
         if(this.var_1510 == null)
         {
            this.var_910 = new Array(0,0,0);
         }
         else
         {
            this.var_910 = this._structure.getCanvasOffsets(this.var_1510,this._scale,this.var_103);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1510)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_409)
               {
                  this.var_995 = true;
               }
               if(_loc1_.actionType == AvatarAction.const_259)
               {
                  this.var_995 = true;
               }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1282 = _loc4_.id;
                     this.var_1843 = _loc4_.breed;
                     break;
                  }
               }
            }
