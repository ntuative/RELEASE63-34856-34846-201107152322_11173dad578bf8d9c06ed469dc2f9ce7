package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1982:AvatarSet;
      
      private var var_844:Dictionary;
      
      private var var_1983:Dictionary;
      
      private var var_1284:Matrix4x4;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc15_:* = null;
         var _loc16_:* = null;
         this.var_1052 = new Vector3D(0,0,10);
         super();
         this.var_1284 = new Matrix4x4();
         this.var_844 = new Dictionary();
         this.var_1983 = new Dictionary();
         this.var_1982 = new AvatarSet(param1.avatarset[0]);
         this.var_178 = new Dictionary();
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_1052.x = _loc11_;
            this.var_1052.y = _loc12_;
            this.var_1052.z = _loc13_;
         }
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            this.var_844[String(_loc6_.@id)] = _loc7_;
            this.var_1983[String(_loc6_.@id)] = _loc8_;
         }
      }
      ...
      public function removeDynamicItems() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_844)
         {
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = this.var_1982.findAvatarSet(param1);
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:AvatarSet = this.var_1982.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Dictionary = this.var_178[param1];
         if(_loc3_ != null)
         {
      ...
      {
         return this.var_844[param1] != null;
      }
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = this.var_844[param1] as Dictionary;
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(this.typeExists(param1))
         {
            return this.var_844[param1] as Dictionary;
         }
      ...
      public function getBodyPartOfItem(param1:String, param2:String) : GeometryBodyPart
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Dictionary = this.var_1983[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:String) : Array
      {
         ...
         this.var_1284 = Matrix4x4.getYRotationMatrix(param2);
         for each(_loc7_ in _loc5_)
         {
            _loc7_.applyTransform(this.var_1284);
            _loc9_ = _loc7_.getDistance(this.var_1052);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(this.hasBodyPart(param1,param2))
         {
            ...
            this.var_1284 = Matrix4x4.getYRotationMatrix(param3);
            return _loc5_.getParts(this.var_1284,this.var_1052,param4);
         }
         return [];
      }
