package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      public function findAvatarSet(param1:String) : AvatarSet
      {
         ...
         for each(_loc2_ in this.var_1261)
         {
