package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2380:String = "hd-99999-99999";
      ...
      private var var_356:PetDataManager;
      
      private var var_925:PaletteManager;
      
      private var var_743:String;
      
      private var var_355:Map;
      
      private var var_265:AvatarAssetDownloadManager;
      
      private var var_2203:AvatarFigureContainer;
      
      private var var_3033:Boolean = false;
      
      private var var_3035:Boolean = false;
      
      private var var_3034:Boolean = false;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_743 = RenderMode.const_1944;
         ...
         this.var_125.add(AvatarType.const_135,_loc4_);
         _loc4_ = new AvatarStructure(this,AvatarType.const_55,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_125.add(AvatarType.const_55,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_356 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_925 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_356.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_125.getValues())
            {
               _loc1_.dispose();
            }
         ...
         if(this.var_265)
         {
            this.var_265.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_356.init();
         this.var_925.init();
         _loc2_ = this.var_125.getValue(AvatarType.const_135) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_125.getValue(AvatarType.const_55) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_125.getValue(AvatarType.const_135) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_128.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_265 == null)
               {
                  ...
                  _loc6_ = this.var_128.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_128.getKey("flash.dynamic.avatar.download.url","");
                  this.var_265 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_265.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_969)
         {
            if(this.var_3033 && this.var_3035 && this.var_3034)
            {
               this.var_969 = true;
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_265.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_265.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_125.getValue(AvatarType.const_135) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_265.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_2203)
         {
            this.var_2203 = new AvatarFigureContainer(this.const_2380);
         }
         this.var_265.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_2203,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(param1 == null || this.var_355 == null)
         {
            return;
         }
         for each(_loc2_ in this.var_355.getKeys())
         {
            _loc3_ = this.var_355.getValue(_loc2_);
            if(_loc3_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_356.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1822)
         {
            _loc6_ = !this.var_356.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_356.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_125.getValue(AvatarType.const_55) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_355.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_356.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_125.getValue(AvatarType.const_55);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_355.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_355.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc2_:AvatarStructure = this.var_125.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_125.getValue(AvatarType.const_135) as AvatarStructure;
      ...
      {
         return this.var_356 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_135:
               _loc3_ = this.var_125.getValue(AvatarType.const_135) as AvatarStructure;
               break;
            case AvatarType.const_55:
               _loc3_ = this.var_125.getValue(AvatarType.const_55) as AvatarStructure;
               break;
            default:
