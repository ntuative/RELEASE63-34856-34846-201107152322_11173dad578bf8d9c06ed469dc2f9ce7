package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_2246:int = 6710886;
      
      private static const const_1558:int = 5000;
      
      private static const const_1457:Point = new Point(100,30);
      ...
      private var var_251:ITabSelectorWindow;
      ...
      private var var_2661:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:Array)
      {
         ...
         var _loc5_:* = null;
         this.var_1260 = [];
         this.var_1506 = [AvatarEditorFigureCategory.const_917,AvatarEditorFigureCategory.const_58,AvatarEditorFigureCategory.const_246,AvatarEditorFigureCategory.const_962,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_117];
         super();
         this.var_23 = param1;
         if(var_1410 == null)
         {
         ...
         this._saveTimer = new Timer(const_1558,1);
         this._saveTimer.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param2 == null)
         {
            param2 = this.var_1506;
         }
         for each(_loc3_ in param2)
         {
            this.var_1260.push(_loc3_);
         }
         this.createWindow();
      }
      ...
      public function getFrame(param1:Array, param2:String = null) : IFrameWindow
      {
         ...
         if(_loc3_)
         {
            this.var_87 = this.var_23.manager.windowManager.buildFromXML(_loc3_.content as XML) as IFrameWindow;
         }
         if(this.var_87 == null)
         {
         ...
         this.var_87.position = const_1457;
      ...
      public function embedToContext(param1:IWindowContainer, param2:Array) : Boolean
      {
         ...
         else
         {
            if(this.var_672 == null)
            {
               this.var_672 = this.var_23.manager.windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_76,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_672.addChild(this.var_59);
            }
            _loc3_ = this.var_672.getChildIndex(this.var_59);
            if(_loc3_)
            {
               param1.removeChildAt(_loc3_);
            }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1.length != this.var_1260.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1260.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function createWindow() : void
      {
         ...
         this.var_251 = this.var_59.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc1_:int = this.var_251.numSelectables - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_251.getSelectableAt(_loc1_);
            if(_loc2_ != null && this.var_1260.indexOf(_loc2_.name) < 0)
            {
               _loc3_ = this.var_251.removeSelectable(_loc2_);
               _loc4_ = _loc1_ + 1;
               while(_loc4_ < this.var_251.numSelectables)
               {
                  this.var_251.getSelectableAt(_loc4_).x = this.var_251.getSelectableAt(_loc4_).x - _loc3_.width;
                  _loc4_++;
               }
            }
            _loc1_--;
         }
         this.var_251.setSelected(this.var_251.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      public function update() : void
      {
         ...
         if(this.var_23.manager.sessionData && this.var_23.manager.sessionData.clubLevel >= HabboClubLevelEnum.const_35 && (this.var_1563 == AvatarEditorSideCategory.const_117 || this.var_2661))
         {
            _loc4_ = "null";
         }
      ...
      {
         if(this.var_1563 == AvatarEditorSideCategory.const_117)
         {
            this.var_2661 = false;
            this.setSideContent(AvatarEditorSideCategory.const_667);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_667:
               break;
            case AvatarEditorSideCategory.const_568:
               _loc3_ = this.var_23.getSideContentWindowContainer(AvatarEditorSideCategory.const_568);
               break;
         ...
         {
            _loc5_ = 8;
            this.var_87.content.width = this.var_59.width + _loc5_;
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_372 = param1;
         this.var_251.setSelected(this.var_251.getSelectableByName(param1));
      }
      ...
      private function openCatalogClubPage() : void
      {
         ...
         {
            this.var_23.manager.catalog.openCatalogPage(CatalogPageName.const_169,true);
         }
      }
   }
}
