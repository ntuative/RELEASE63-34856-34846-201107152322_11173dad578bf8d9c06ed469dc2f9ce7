package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_153 = new Dictionary();
         this.var_1808 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_3003 = parseInt(param1.@precedence);
         this.var_3004 = String(param1.@activepartset);
         this.var_3009 = String(param1.@assetpartdefinition);
         this.var_3008 = String(param1.@lay);
         this.var_792 = String(param1.@geometrytype);
         this.var_2663 = Boolean(parseInt(param1.@main));
         this.var_3006 = Boolean(parseInt(param1.@name_6));
         this.var_3005 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc4_ in param1.type)
         {
            ...
            this.var_153[_loc7_] = new ActionType(_loc4_);
         }
      }
      ...
      private function getTypePrevents(param1:String) : Array
      {
         ...
         var _loc2_:ActionType = this.var_153[param1];
         if(_loc2_ != null)
         {
