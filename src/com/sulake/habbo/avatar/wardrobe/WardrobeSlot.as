package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this._figure && this.var_1617)
         {
            _loc5_ = this.var_27.manager.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_108,this.var_1067,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_43,parseInt(FigureData.const_844));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "set_button":
               ...
               this.var_1067 = this.var_27.gender;
               this.var_27.handler.saveWardrobeOutfit(this.var_2006,this);
               this.updateView();
               break;
            case "get_button":
               if(this._figure)
               {
                  this.var_27.loadAvatarInEditor(this._figure,this.var_1067,this.var_27.clubMemberLevel);
               }
         }
      }
