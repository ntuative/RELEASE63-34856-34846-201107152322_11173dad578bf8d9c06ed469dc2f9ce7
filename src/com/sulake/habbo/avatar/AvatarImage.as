package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1491:String = "Default";
      
      private static const const_1490:int = 2;
      
      private static const const_1489:String = AvatarSetType.const_43;
      ...
      protected var var_1783:int;
      
      protected var var_317:IActiveActionData;
      ...
      protected var var_611:IAvatarDataContainer;
      ...
      private var var_2144:Array;
      
      private var var_2948:int = -1;
      
      private var var_2949:String = null;
      
      private var var_2950:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1489,const_1490);
         this.var_363 = new Array();
         this.var_994 = new ActiveActionData(AvatarAction.const_443);
         this.var_994.definition = this._structure.getActionDefinition(const_1491);
         this.resetActions();
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_1155)
         {
            ...
            if(this.var_893)
            {
               for each(_loc2_ in this.var_893)
               {
                  _loc2_.dispose();
               }
      ...
      {
         param2 += this.var_1844;
         if(param2 < AvatarDirectionAngle.const_1252)
         {
            param2 = AvatarDirectionAngle.const_373 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_373)
         {
            param2 -= NaN;
         }
         ...
         if(param1 == AvatarSetType.const_58 || param1 == AvatarSetType.const_43)
         {
            if(param1 == AvatarSetType.const_58 && this.isHeadTurnPreventedByAction())
            {
               param2 = this.var_103;
            }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_725,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_304.length == 1 && this.var_103 == this.var_1783)
         {
            return this.var_103 + this.var_587 + this.var_725 % 4;
         }
         if(this.var_304.length == 2)
         {
            for each(_loc1_ in this.var_304)
            {
               ...
               {
                  return this.var_103 + this.var_587 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_725 % 11;
                  return this.var_103 + "_" + this.var_1783 + this.var_587 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2948 || param2 != this.var_2949 || param1 != this.var_2950)
         {
            this.var_2948 = param3;
            this.var_2949 = param2;
            this.var_2950 = param1;
            this.var_2144 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_317.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1430 || this.var_48 == null || (this.var_48.width != _loc5_.width || this.var_48.height != _loc5_.height))
         {
            if(this.var_48 != null && !this.var_1430)
            {
               this.var_48.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_317.definition.geometryType,this.var_103);
         this.var_48.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_725);
         ...
         {
            if(this.var_611.paletteIsGrayscale)
            {
               ...
               this.var_48 = _loc13_;
               this.var_48.paletteMap(this.var_48,this.var_48.rect,new Point(0,0),this.var_611.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_317.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_317.definition.geometryType,this.var_103);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_725);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_363.push(new ActiveActionData(param1,param2,this.var_725));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_317 = this.var_994;
         this.var_317.definition = this.var_994.definition;
         this.resetBodyPartCache(this.var_994);
         return true;
      }
      ...
      private function isHeadTurnPreventedByAction() : Boolean
      {
         ...
         for each(_loc3_ in this.var_304)
         {
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_587 = "";
         this.var_304 = this._structure.sortActions(this.var_363);
         if(this.var_304 == null)
         {
         ...
         {
            this.var_910 = this._structure.getCanvasOffsets(this.var_304,this._scale,this.var_103);
            for each(_loc4_ in this.var_304)
            {
               this.var_587 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_334)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1678 != _loc5_)
                  {
                     _loc2_ = true;
                  }
            ...
            if(this.var_1360 != this.var_587)
            {
               _loc1_ = true;
               this.var_1360 = this.var_587;
            }
         }
         this.var_1508 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_304)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_995 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     this.var_218 = this.var_218.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1844 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_611 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_354 || _loc1_.actionType == AvatarAction.const_259 || _loc1_.actionType == AvatarAction.const_409)
               {
                  this.var_995 = true;
               }
            }
