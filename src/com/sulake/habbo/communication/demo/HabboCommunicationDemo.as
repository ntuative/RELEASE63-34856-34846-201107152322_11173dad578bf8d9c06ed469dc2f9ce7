package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_66:IHabboCommunicationManager;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_15:IRoomSessionManager;
      
      private var var_584:IKeyExchange;
      
      private var var_1106:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2935:PseudoRandom;
      ...
      private var var_259:HabboHotelView;
      
      private var var_1670:String = "";
      
      private const const_2094:String = "fuselogin";
      ...
      {
         if(param1 && !this.var_721)
         {
            this.var_721 = param1;
            this.var_66.initConnection(HabboConnectionType.const_282);
         }
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            this.var_66 = param2 as IHabboCommunicationManager;
            _loc3_ = this.var_66.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            this.var_66.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(this.onInitCrypto));
            this.var_66.addHabboConnectionMessageEvent(new SecretKeyEvent(this.onSecretKeyEvent));
            this.var_66.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(this.onSessionParamsEvent));
            this.var_66.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            this.var_66.addHabboConnectionMessageEvent(new PingMessageEvent(this.onPing));
            this.var_66.addHabboConnectionMessageEvent(new ErrorReportEvent(this.onErrorReport));
            this.var_66.addHabboConnectionMessageEvent(new UserObjectEvent(this.onUserObject));
            this.var_66.addHabboConnectionMessageEvent(new GenericErrorEvent(this.onGenericError));
            this.var_66.addHabboConnectionMessageEvent(new DisconnectReasonEvent(this.onDisconnectReason));
            this.var_66.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(this.onRoomEntryInfoEvent));
            this.var_66.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(this.onUniqueMachineId));
            this.var_66.addHabboConnectionMessageEvent(new IdentityAccountsEvent(this.onIdentityAccounts));
            this.checkRequirements();
         }
      }
      ...
      {
         if(this.var_66 && this.var_162 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:Boolean = this.var_162.getBoolean("client.hotel_view.show_on_startup",true);
         this.var_259 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         var _loc2_:String = this.var_162.getKey("client.hotel_view.image");
         var _loc3_:String = this.var_162.getKey("image.library.url");
         if(_loc2_ != null && _loc3_ != null)
         {
            this.var_259.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_162.getKey("use.sso.ticket") == "1";
         this.var_721 = this.var_162.getKey("sso.ticket",null);
         this.var_2127 = this.var_162.getKey("flash.client.url","");
         this.var_2933 = this.var_162.getKey("external.variables.txt","");
         if(this.var_259 == null)
         {
            this.var_259 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_66.mode = HabboConnectionType.const_99;
            if(this.var_721)
            {
               this.var_66.initConnection(HabboConnectionType.const_282);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_971,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1756);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         {
            this.var_66.mode = HabboConnectionType.const_99;
            if(this.var_162.keyExists("local.environment"))
            {
               this.var_66.mode = HabboConnectionType.const_1184;
            }
         }
         this.var_66.initConnection(HabboConnectionType.const_282);
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = this.var_66.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_882);
            _loc3_ = new InitCryptoMessageComposer(this.var_66.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2935 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_66.mode)
         {
            case HabboConnectionType.const_99:
               _loc6_ = "";
               _loc6_ = this.var_162.getKey("url.prefix",_loc6_);
               _loc6_ = _loc6_.replace("http://","");
               _loc6_ = _loc6_.replace("https://","");
               _loc7_ = this.var_162.getKey("hotelview.banner.url","http:/\nsitename$/gamedata/banner");
               _loc7_ = _loc7_.replace("$sitename$",_loc6_);
               this.var_1670 = _loc4_;
               this.var_259.loadBannerImage(_loc7_ + "?token=" + this.var_1670,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1184:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1728:
               this.var_1106 = this.generateRandomHexString(30);
               this.var_584 = new DiffieHellman(new BigInteger(this.var_162.getKey("connection.development.prime"),16),new BigInteger(this.var_162.getKey("connection.development.generator"),16));
               this.var_584.init(this.var_1106);
               _loc8_ = this.var_584.getPublicKey(10);
               _loc2_.send(new GenerateSecretKeyMessageComposer(_loc8_.toUpperCase()));
               break;
            default:
               Logger.log("[HabboCommunicationDemo] Unknown Connection Mode: " + this.var_66.mode);
         }
      }
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_584.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_584.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2935);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1671 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_308);
         connection.send(new VersionCheckMessageComposer(401,this.var_2127,this.var_2933));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2094,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_721 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_721);
            _loc2_.send(_loc4_);
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_208);
         }
      ...
      {
         var _loc4_:IConnection = this.var_66.getHabboMainConnection(null);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_297);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2934)
         {
            _loc2_ = this.var_162.getKey("logout.disconnect.url");
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         this.var_2934 = true;
         var _loc2_:String = this.var_162.getKey("logout.url");
         if(_loc2_.length > 0)
         {
      ...
      private function setOriginProperty(param1:String) : String
      {
         ...
         {
            return param1.replace("%origin%",this.var_162.getKey("flash.client.origin","popup"));
         }
         return param1;
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1670);
         ...
         var _loc9_:IConnection = this.var_66.getHabboMainConnection(null);
         ...
         this.var_584 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_584.init(_loc14_);
            _loc15_ = this.var_584.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_1106 = _loc14_;
            }
