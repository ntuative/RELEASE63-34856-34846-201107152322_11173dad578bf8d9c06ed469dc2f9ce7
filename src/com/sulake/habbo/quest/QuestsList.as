package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1611:int = 5;
      
      private static const const_1614:int = 10;
      
      private static const const_1613:int = 10;
      
      private static const const_1612:int = 30;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_855 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_855.toggle();
         this.var_2012 = false;
      }
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1618.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1618[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_608 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_64.spacing = const_1614;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1613;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1611;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1612;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_2012 && !this.var_2013)
            {
               this.var_2012 = false;
