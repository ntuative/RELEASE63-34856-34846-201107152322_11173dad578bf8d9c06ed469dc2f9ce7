package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1549:int = 800;
      
      private static const const_1550:int = 15;
      
      private static const const_1551:int = 300;
      ...
      private var var_1249:QuestController;
      
      private var var_1029:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1249 = new QuestController(this);
         this.var_1029 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1552);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_368.events.removeEventListener(BadgeImageReadyEvent.const_214,this.var_1029.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_368.events.addEventListener(BadgeImageReadyEvent.const_214,this.var_1029.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1249.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_1029.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1249.questTracker.isVisible();
      }
