package com.sulake.habbo.quest
{
   ...
   public class NextQuestTimer implements IDisposable
   {
      ...
      public static const const_825:int = 1000;
      
      private static const const_715:String = "next_quest";
      ...
      {
         var _loc1_:int = this.var_144.waitPeriodSeconds;
         if(_loc1_ < 1)
         {
            this.close();
            this.var_144.waitPeriodSeconds = 0;
            this.var_51.questController.onQuest(this.var_144);
         }
         var _loc2_:String = FriendlyTime.getFriendlyTime(this.var_51.localization,_loc1_);
         var _loc3_:* = this.var_144.getCampaignLocalizationKey() + ".delayedmsg";
         ...
         this._window.findChildByName("quest_header_txt").caption = this.var_51.localization.getKey("quests.nextquesttimer.caption." + (!!this.var_595 ? "expanded" : "contracted"));
      ...
      {
         this._window.findChildByName("quest_timer_expanded").visible = this.var_595;
         this._window.findChildByName("quest_timer_contracted").visible = !this.var_595;
         this._window.findChildByName("more_info_txt").visible = this.var_595 && this.var_51.currentlyInRoom;
         this._window.findChildByName("more_info_region").visible = this.var_595 && this.var_51.currentlyInRoom;
         this._window.findChildByName("quest_pic_bitmap").visible = this.var_595;
         this._window.findChildByName("desc_txt").visible = this.var_595;
         this.refresh();
      }
      ...
      private function onMoreInfo(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this.var_51.questController.questDetails.showDetails(this.var_144);
         }
      }
