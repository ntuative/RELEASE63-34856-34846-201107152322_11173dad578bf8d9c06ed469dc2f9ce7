package com.sulake.habbo.quest
{
   ...
   public class AchievementController implements IDisposable, IUpdateReceiver
   {
      ...
      private static const const_1528:int = 8;
      
      private static const const_1521:int = 5;
      
      private static const const_1531:int = 6;
      
      private static const const_1525:int = 3;
      
      private static const const_1529:int = 2;
      
      private static const const_1081:int = 6;
      
      private static const const_1523:int = 180;
      
      private static const const_1526:int = 246;
      
      private static const const_1504:int = 45;
      
      private static const const_1530:Point = new Point(115,93);
      
      private static const const_1522:Point = new Point(72,1);
      
      private static const const_1082:int = 40;
      
      private static const const_1527:int = 20;
      
      private static const const_1520:int = 3;
      
      private static const const_1524:int = 10;
      ...
      private var var_660:ProgressBar;
      
      private var var_816:ProgressBar;
      
      private var var_1232:Matrix;
      
      private var var_1898:ColorMatrixFilter;
      
      private var var_1541:AchievementData;
      
      private var var_815:Timer;
      
      private var var_661:Dictionary;
      
      private var var_817:AchievementLevelUp;
      ...
      public function AchievementController(param1:HabboQuestEngine)
      {
         ...
         super();
         this.var_51 = param1;
         this.var_546 = new Timer(100,1);
         this.var_546.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_815 = new Timer(2000,1);
         this.var_815.addEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
         this.var_817 = new AchievementLevelUp(this.var_51);
         this.var_1232 = new Matrix();
         this.var_1898 = this.createGrayscaleFilter();
         this.var_661[16] = 1;
         this.var_661[28] = 6;
         this.var_661[38] = 4;
         this.var_661[39] = 3;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_546)
         {
            this.var_546.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
            this.var_546.reset();
            this.var_546 = null;
         }
         if(this.var_815)
         {
            this.var_815.removeEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
            this.var_815.reset();
            this.var_815 = null;
         }
         if(this.var_660)
      ...
      private function refresh() : void
      {
         ...
         this._window.height = getLowestPoint(this._window.content) + const_1504;
      }
      ...
      private function refreshCategoryListFooter() : void
      {
         if(this._category != null)
         {
            this.var_1233.visible = false;
            return;
         }
         this.var_1233.visible = true;
         this.var_816.refresh(this.var_119.getProgress(),this.var_119.getMaxProgress(),0);
      }
      ...
      private function refreshAchievementList() : void
      {
         ...
         this.var_813.height = getLowestPoint(this.var_813);
      }
      ...
      private function refreshAchievementsHeader() : void
      {
         if(this._category == null)
         {
            this.var_1014.visible = false;
            return;
         }
         this.var_1014.visible = true;
         this.var_1014.findChildByName("category_name_txt").caption = this.var_51.getAchievementCategoryName(this._category.code);
         ...
         this.var_51.setupAchievementCategoryImage(this.var_1014,this._category,false);
      }
      ...
      private function refreshAchievementDetails() : void
      {
         if(this.var_74 == null)
         {
            this.var_455.visible = false;
            return;
         }
         this.var_455.visible = true;
         var _loc1_:String = this.getAchievedBadgeId(this.var_74);
         this.var_455.findChildByName("achievement_name_txt").caption = this.var_51.localization.getBadgeName(_loc1_);
         var _loc2_:String = this.var_51.localization.getBadgeDesc(_loc1_);
         this.var_455.findChildByName("achievement_desc_txt").caption = _loc2_ == null ? "" : _loc2_;
         ...
         this.var_51.refreshReward(!this.var_74.finalLevel,this.var_455,this.var_74.levelRewardPointType,this.var_74.levelRewardPoints);
         this.refreshBadgeImageLarge(this.var_455,this.var_74);
         this.var_660.refresh(this.var_74.currentPoints,this.var_74.scoreLimit,this.var_74.type * 10000 + this.var_74.level);
         this.var_660.visible = !this.var_74.finalLevel;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1014 = IWindowContainer(this._window.findChildByName("achievements_header_cont"));
         this.var_813 = IWindowContainer(this._window.findChildByName("achievements_cont"));
         this.var_455 = IWindowContainer(this._window.findChildByName("achievement_cont"));
         this.var_1542 = IWindowContainer(this._window.findChildByName("achievements_footer_cont"));
         this.var_1233 = IWindowContainer(this._window.findChildByName("categories_footer_cont"));
         this.var_660 = new ProgressBar(this.var_51,this.var_455,const_1523,"achievements.details.progress",true,const_1530);
         this.var_816 = new ProgressBar(this.var_51,this.var_1233,const_1526,"achievements.categories.totalprogress",true,const_1522);
      }
      ...
      private function refreshCategoryEntry(param1:int, param2:AchievementCategory) : Boolean
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc3_.x = (_loc3_.width + const_1528) * (param1 % const_692);
            _loc3_.y = (_loc3_.height + const_1521) * Math.floor(param1 / const_692) + const_1531;
         }
      ...
      {
         var _loc9_:* = null;
         var _loc3_:IWindowContainer = IWindowContainer(this.var_813.getChildByName("" + param1));
         var _loc4_:int = Math.floor(param1 / const_1081);
         var _loc5_:* = _loc4_ < const_1529;
         if(_loc3_ == null)
         {
            if(param2 == null && !_loc5_)
            {
            ...
            _loc3_.x = _loc3_.width * (param1 % const_1081);
            _loc3_.y = _loc3_.height * _loc4_ + const_1520;
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc5_:BitmapData = this.var_814[_loc4_];
         ...
         if(_loc5_ == null)
         {
            ...
            this.var_814[_loc4_] = _loc5_;
         }
         var _loc7_:int = const_1082 - _loc5_.height + this.getPositionFix(param2.type);
         var _loc8_:Point = new Point((_loc3_.width - _loc5_.width) / 2,!!_loc6_ ? Number(const_1524) : Number(_loc7_));
         ...
         {
            _loc3_.bitmap.applyFilter(_loc5_,_loc5_.rect,_loc8_,this.var_1898);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      private function refreshBadgeImageLarge(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc6_:int = 2 * (const_1082 - _loc5_.height + this.getPositionFix(param2.type));
         this.var_1232.identity();
         this.var_1232.scale(2,2);
         this.var_1232.translate((_loc3_.width - _loc5_.width * 2) / 2,_loc6_);
         _loc3_.bitmap.fillRect(_loc3_.bitmap.rect,16777215);
         _loc3_.bitmap.draw(_loc5_,this.var_1232);
         if(!param2.firstLevelAchieved)
         {
            _loc3_.bitmap.applyFilter(_loc3_.bitmap,_loc3_.bitmap.rect,new Point(0,0),this.var_1898);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      {
         this.var_74 = this.var_1541;
         this.var_119.update(this.var_1541);
         this.var_1541 = null;
         this.refresh();
      }
      ...
      public function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.var_814[param1.badgeId] = param1.badgeImage;
         if(!this.var_546.running)
         {
            this.var_546.start();
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_660.updateView();
         }
         if(this.var_816 != null)
         {
            this.var_816.updateView();
         }
         if(this.var_817 != null)
         {
            this.var_817.update(param1);
         }
      }
      ...
      {
         return !!this.var_661[param1] ? int(this.var_661[param1]) : 0;
      }
