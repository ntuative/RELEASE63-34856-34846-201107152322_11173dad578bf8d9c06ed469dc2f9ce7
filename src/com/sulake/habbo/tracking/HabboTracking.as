package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1061:uint = 11;
      ...
      private var var_219:IHabboFriendList;
      
      private var var_1203:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_211:IHabboHelp;
      ...
      private var var_277:LatencyTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_277 = new LatencyTracker();
         this.var_641 = new LagWarningLogger();
         this.var_445 = new ToolbarClickTracker(this);
         this.var_1495 = new Array(const_1061);
         var _loc4_:int = 0;
         while(_loc4_ < const_1061)
         {
            this.var_1495[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1832,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1772,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_2030,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_843,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1307,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1203)
            {
               this.var_1203.release(new IIDHabboWindowManager());
               this.var_1203 = null;
            }
            if(this.var_328)
            {
            ...
            if(this._navigator)
            {
               if(!this._navigator.disposed)
               {
                  ...
                  this._navigator.events.removeEventListener(HabboNavigatorEvent.const_326,this.onZoomToggle);
               }
            ...
            if(this.var_219)
            {
               ...
               {
                  Component(this.var_219).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_219).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_219).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_219).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_219).events.removeEventListener(HabboFriendListTrackingEvent.const_556,this.onFriendlistTrackingEvent);
               }
               this.var_219.release(new IIDHabboFriendList());
               this.var_219 = null;
            }
            if(this.var_211)
            {
               ...
               {
                  this.var_211.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_211.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_211.release(new IIDHabboHelp());
               this.var_211 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_215,this.onRoomAdClick);
      ...
      {
         this.var_1495[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_128 = IHabboConfigurationManager(param2);
         if(this.var_128)
         {
            if(this.var_277 != null)
            {
               this.var_277.configuration = this.var_128;
            }
            if(this.var_276 != null)
            {
               this.var_276.configuration = this.var_128;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_2034);
            if(this.var_128)
            {
               if(this.var_641 != null)
               {
                  this.var_641.configure(this.var_128);
               }
               if(this.var_444 != null)
               {
                  this.var_444.configure(this.var_128);
               }
               if(this.var_445 != null)
               {
                  this.var_445.configure(this.var_128);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_882,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_308,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_297,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_946,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_70,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_658,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_277 != null)
            {
               this.var_277.communication = this._communication;
               this.var_277.connection = param1;
            }
            if(this.var_641 != null)
            {
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_946)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1864);
         }
         else if(param1.type == HabboHotelViewEvent.const_658)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1767);
         }
         else if(param1.type == HabboHotelViewEvent.const_70)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1973);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_882:
               this.trackLoginStep(HabboLoginTrackingStep.const_1788,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_308:
               this.trackLoginStep(HabboLoginTrackingStep.const_308);
               break;
            ...
            case HabboCommunicationEvent.const_208:
               ...
               break;
            case HabboCommunicationEvent.const_297:
      ...
      {
         this.var_1203 = IHabboWindowManager(param2);
         if(this.var_1203)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_128)
            {
               if(this.var_128.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_128.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1495)
                  {
      ...
      private function onNavigatorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_326,this.onZoomToggle);
      }
      ...
      {
         this.var_219 = param2 as IHabboFriendList;
         Component(this.var_219).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_219).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_219).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_219).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_219).events.addEventListener(HabboFriendListTrackingEvent.const_556,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_556:
      ...
      {
         this.var_211 = param2 as IHabboHelp;
         this.var_211.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_211.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2399)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1794);
            this.var_2399 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1307,String(_loc2_.guestRoomId));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_215,this.onRoomAdClick);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_328.events.addEventListener(AdEvent.const_564,this.onRoomAdLoad);
      }
      ...
      {
         if(this.var_128 != null && !Boolean(this.var_128.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_535 > -1 && _loc2_ < this.var_535)
         {
            ++this.var_1812;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1812);
         }
         if(this.var_535 > -1 && _loc2_ - this.var_535 > 15000)
         {
            ++this.var_1814;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1814);
         }
         this.var_535 = _loc2_;
         if(this.var_276 != null)
         {
            this.var_276.update(param1,this.var_535);
         }
         if(this.var_277 != null)
         {
            this.var_277.update(param1,this.var_535);
         }
         if(this.var_444 != null)
         {
            this.var_444.trackUpdate(param1,this,this.var_535);
         }
         if(this.var_641 != null)
         {
            this.var_641.update(this.var_535);
         }
      }
   }
}
