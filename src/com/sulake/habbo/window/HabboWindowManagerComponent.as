package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1442:uint = 1;
      ...
      private var var_1765:ProfilerOutput;
      
      private var var_1465:ProfilerAgentTask;
      
      private var var_1466:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_215 = new Array(const_470);
         ...
         {
            this.var_215[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_672 = this.var_215[const_1442];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1765)
            {
               this.var_1765 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1765.profiler = _loc3_;
            ...
            this.var_1466 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1466);
            this.var_1180 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_215)
            {
               while(this.var_215.length > 0)
               {
                  IDisposable(this.var_215.pop()).dispose();
               }
            }
            this.var_215 = null;
            if(this.var_272)
      ...
      {
         return this.var_672.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_672.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_272[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_272[0][param1] as XML : _loc4_;
      }
      ...
      {
         return this.var_215[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_215[param2].getDesktopWindow();
      ...
      {
         return this.var_215[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_215[param1].getDesktopWindow().getChildAt(this.var_672.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_215[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_428.length > 0)
         {
            ...
            while(_loc2_ >= 0)
            {
               this.var_215[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1180)
         ...
         {
            this.var_215[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1180)
         {
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1800,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1820,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_2026,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1895,param2.name + ": " + param2.toString());
            }
         }
      }
