package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_826:ITextFieldWindow;
      ...
      {
         this.var_826 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_826.procedure = this.onSearchInput;
         this.var_826.addEventListener(WindowKeyboardEvent.const_185,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_64.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_403,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_615.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_615.showPopup(this._friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function onSearchStrInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc4_ = 25;
            _loc5_ = this.var_826.text;
            if(_loc5_.length > _loc4_)
            {
               this.var_826.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_826.text;
