package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_191:String = "face";
      ...
      private var var_159:IHabboMessenger;
      ...
      private var var_2829:FriendListLookAndFeel;
      
      private var var_467:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_2032:OpenedToWebPopup;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_701.stop();
            this.var_701.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_701 = null;
         }
         ...
         if(this.var_159)
         {
            this.var_159.release(new IIDHabboMessenger());
            this.var_159 = null;
         }
         if(this.var_128)
         {
         ...
         if(this.var_1057)
         {
            this.var_1057.release(new IIDHabboNotifications());
            this.var_1057 = null;
         }
         if(this._toolbar)
         {
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(this.var_2032 == null)
         {
            this.var_2032 = new OpenedToWebPopup(this);
         }
         this.var_2032.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_116);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_403);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_366,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_603.createAvatarImage(param1,AvatarScaleType.const_108,null,this);
         if(!_loc2_)
         {
            return null;
         }
         var _loc3_:BitmapData = _loc2_.getCroppedImage(AvatarSetType.const_58);
         _loc2_.dispose();
         return _loc3_;
      }
      ...
      {
         var _loc1_:String = this.var_128.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_128.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_159 = param2 as IHabboMessenger;
      ...
      {
         this.var_1057 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_119.addCategory(new FriendCategory(FriendCategory.const_1397,this.getText("friendlist.friends")));
         this.var_119.addCategory(new FriendCategory(FriendCategory.const_422,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_119.addFriend(new Friend(_loc4_));
         }
         this.var_467 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_701)
         {
            this.var_701 = new Timer(120000);
            this.var_701.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_701.start();
         }
         ...
         {
            _loc5_ = this.var_119.findCategory(FriendCategory.const_422);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_467.findTab(FriendListTab.const_88).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_467.findTab(FriendListTab.const_88);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_2031.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_467.findTab(FriendListTab.const_88);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_467.findTab(FriendListTab.const_88);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_860 || !this.var_122)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_860.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_41))
         {
            _loc2_ = this.var_122.vipLimit;
         }
         else if(this.var_860.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_35))
         {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_191) as IBitmapWrapperWindow;
