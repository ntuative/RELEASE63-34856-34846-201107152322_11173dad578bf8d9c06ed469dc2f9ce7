package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_2341:int = 2500;
      ...
      private var var_1169:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1169 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1169.connection = param1;
         }
      }
      ...
      {
         if(this._state == RoomSessionEvent.const_274 && this._connection != null)
         {
            this._state = RoomSessionEvent.const_79;
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1456));
         this.var_1457.add(this.var_1456,getTimer());
         ++this.var_1456;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1457.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_2341)
            {
      ...
      {
         return this.var_1169 as IUserDataManager;
      }
