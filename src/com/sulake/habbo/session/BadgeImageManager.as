package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1378:String = "group_badge";
      
      public static const const_2036:String = "normal_badge";
       
      
      private const const_2076:String = "badge_";
      ...
      private function getBadgeImageInternal(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc3_:String = this.const_2076 + param1;
         ...
         switch(param2)
         {
            case const_2036:
               ...
               {
                  _loc5_ = this.var_128.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_1378:
               if(this.var_128 != null)
               {
                  if(this.var_128 != null)
                  {
                     _loc5_ = this.var_128.getKey("group.badge.url");
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(this.const_2076,"");
