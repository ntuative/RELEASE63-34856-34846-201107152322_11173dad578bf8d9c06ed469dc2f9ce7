package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private var var_261:Map = null;
      
      private var var_2165:Boolean = false;
      
      private var var_2980:Boolean = false;
      
      private var var_2982:int = 0;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_261)
         {
            while(this.var_261.length > 0)
            {
               ...
               _loc2_ = this.var_261.remove(_loc1_) as RoomSession;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_2165)
         {
            this.gotoRoom(this.var_2980,this.var_2982,this.var_2166);
            this.var_2165 = false;
            this.var_2166 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         this.var_1682 = true;
         if(this.var_261.getValue(_loc6_) != null)
         {
         ...
         this.var_261.add(_loc6_,_loc7_);
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_274,_loc7_));
         return true;
      }
      
      public function startSession(param1:IRoomSession) : Boolean
      {
         if(param1.state == RoomSessionEvent.const_79)
         {
            return false;
         }
         if(param1.start())
         {
            this.var_1682 = false;
            events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_79,param1));
      ...
      public function sessionReinitialize(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:RoomSession = this.var_261.remove(_loc5_) as RoomSession;
         if(_loc6_ != null)
         {
            param4 = param2;
            _loc6_.reset(param3,param4);
            _loc5_ = this.getRoomIdentifier(param3,param4);
            _loc7_ = this.var_261.remove(_loc5_);
            if(_loc7_ != null)
            {
            }
            this.var_261.add(_loc5_,_loc6_);
      ...
      public function getSession(param1:int, param2:int) : IRoomSession
      {
         ...
         return this.var_261.getValue(_loc3_) as IRoomSession;
      }
      
      public function disposeSession(param1:int, param2:int) : void
      {
         var _loc3_:String = this.getRoomIdentifier(param1,param2);
         var _loc4_:RoomSession = this.var_261.remove(_loc3_) as RoomSession;
         if(_loc4_ != null)
         {
