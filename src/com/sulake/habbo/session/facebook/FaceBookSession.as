package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1132:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1662:String = "sendAccessTokenToServer";
      
      private static const const_1663:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1662,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1663,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1132);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1132);
         }
      }
