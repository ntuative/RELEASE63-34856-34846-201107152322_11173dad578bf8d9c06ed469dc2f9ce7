package com.sulake.habbo.room.messages
{
   ...
   public class RoomObjectRoomPlaneVisibilityUpdateMessage extends RoomObjectUpdateMessage
   {
      ...
      public static const const_1276:String = "RORPVUM_WALL_VISIBILITY";
      
      public static const const_1320:String = "RORPVUM_FLOOR_VISIBILITY";
       
      
      private var _type:String = "";
      
      private var var_339:Boolean = false;
