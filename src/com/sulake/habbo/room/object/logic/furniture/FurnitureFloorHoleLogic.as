package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureFloorHoleLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         if(this.var_1378 == const_489)
         {
            eventDispatcher.dispatchEvent(new RoomObjectFloorHoleEvent(RoomObjectFloorHoleEvent.const_147,object.getId(),object.getType()));
         }
         super.dispose();
      }
      ...
      {
         var _loc1_:Array = [RoomObjectFloorHoleEvent.const_144,RoomObjectFloorHoleEvent.const_147];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc4_ != this.var_1378)
               {
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(this.var_1378 == const_489)
                     {
                        eventDispatcher.dispatchEvent(new RoomObjectFloorHoleEvent(RoomObjectFloorHoleEvent.const_147,object.getId(),object.getType()));
                     }
                  }
            ...
            else if(_loc3_.x != this.var_198.x || _loc3_.y != this.var_198.y)
            {
               if(this.var_1378 == const_489)
               {
                  if(eventDispatcher != null)
