package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_215,RoomObjectRoomAdEvent.const_322,RoomObjectRoomAdEvent.const_324];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_950,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_535,Number(false));
         this.var_800 = true;
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1374:
                  _loc2_.setString(RoomObjectVariableEnum.const_418,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_950,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_535,Number(true));
                  this.var_1483 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1209);
            }
         }
      }
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_535,Number(false));
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_514)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_950);
                  if(_loc7_ != null && _loc7_.indexOf("http") == 0)
                  {
                     eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_215,_loc5_,_loc6_,_loc7_));
