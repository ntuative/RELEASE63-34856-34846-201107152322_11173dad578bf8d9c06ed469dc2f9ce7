package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_2047:int = 255;
      
      private var var_1632:uint = 16777215;
      
      private var var_2048:int = 255;
      
      private var var_1314:uint = 16777215;
      
      private var var_2049:int = 255;
      
      private var var_1313:int = 0;
      
      private var var_2050:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_550,RoomObjectMouseEvent.const_145];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1009,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_741,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_941,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_794,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_888,1);
         }
      }
         ...
         if(this.var_1633)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_1009,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1342,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1313)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_2047;
            if(_loc2_ - this.var_1313 >= this.var_2050)
            {
               _loc3_ = this.var_1314;
               _loc4_ = this.var_2049;
               this.var_1313 = 0;
            }
            else
            {
               _loc7_ = this.var_1632 >> 16 & 255;
               _loc8_ = this.var_1632 >> 8 & 255;
               _loc9_ = this.var_1632 & 255;
               _loc10_ = this.var_1314 >> 16 & 255;
               _loc11_ = this.var_1314 >> 8 & 255;
               _loc12_ = this.var_1314 & 255;
               _loc13_ = (_loc2_ - this.var_1313) / this.var_2050;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_2048 + (this.var_2049 - this.var_2048) * _loc13_;
               this._color = _loc3_;
               this.var_2047 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_741,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_790:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_998:
               param2.setString(RoomObjectVariableEnum.const_236,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_951:
               param2.setString(RoomObjectVariableEnum.const_226,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_519:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_253)
               {
                  _loc5_ = "null";
               }
               this.var_545.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_1006:
               _loc4_ = this.var_545.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_545.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1297,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1320:
               param2.setNumber(RoomObjectVariableEnum.const_941,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1276:
               param2.setNumber(RoomObjectVariableEnum.const_794,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_888,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_693:
               param2.setNumber(RoomObjectVariableEnum.const_1367,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1237:
               param2.setNumber(RoomObjectVariableEnum.const_1315,param1.value);
         }
      }
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomFloorHoleUpdateMessage.const_144:
               this._planeParser.addFloorHole(param1.id,param1.x,param1.y,param1.width,param1.height);
               this.var_1633 = true;
               break;
            case RoomObjectRoomFloorHoleUpdateMessage.const_147:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1166,int(param1.bgOnly));
         this.var_1632 = this._color;
         this.var_2048 = this.var_2047;
         this.var_1314 = _loc3_;
         this.var_2049 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_584,0);
            }
            return;
         }
         _loc5_--;
         ...
         var _loc10_:IVector3d = this._planeParser.method_3(_loc5_);
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1883,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1911,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_2016,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_584,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_271 || _loc12_ == RoomPlaneData.const_456)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
