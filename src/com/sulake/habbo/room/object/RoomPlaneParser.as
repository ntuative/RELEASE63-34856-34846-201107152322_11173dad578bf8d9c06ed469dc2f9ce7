package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private static const const_693:Number = 0.25;
      
      private static const const_1237:Number = 0.25;
      
      public static const const_71:int = -110;
      
      public static const const_109:int = -100;
      ...
      private var var_1534:Number = 1.0;
      
      private var var_1018:Number = 1.0;
      
      private var var_1002:Number = 0.0;
      
      private var var_333:Map = null;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            while(_loc7_ < param1)
            {
               _loc4_[_loc7_] = const_71;
               _loc5_[_loc7_] = const_71;
               _loc6_[_loc7_] = false;
               _loc7_++;
            }
            this.var_124.push(_loc4_);
            this._tileMatrixOriginal.push(_loc5_);
            this.var_547.push(_loc6_);
            _loc3_++;
         }
         this.var_223 = param1;
         this._height = param2;
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this.var_223 && param2 >= 0 && param2 < this._height)
         {
            ...
            {
               if(param1 == this._minX || param1 == this.var_457)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_456;
                  while(_loc6_ < this.var_458)
                  {
               ...
               if(param2 == this.var_456 || param2 == this.var_458)
               {
                  _loc7_ = false;
                  _loc8_ = this._minX;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         while(_loc3_ < this._height)
         {
            ...
            while(_loc2_ < this.var_223)
            {
               if(this.var_547[_loc3_][_loc2_])
               {
                  this.var_124[_loc3_][_loc2_] = const_109;
               }
               _loc2_++;
            }
            _loc3_++;
      ...
      private function initialize(param1:Point, param2:Boolean) : Boolean
      {
         ...
         if(param1 != null)
         {
            ...
            this.setTileHeight(param1.x,param1.y,const_71);
         }
         this.var_1002 = getFloorHeight(this.var_124);
         if(!param2)
         {
      ...
      private function createWallPlanes() : Boolean
      {
         ...
         {
            if(this.getTileHeightInternal(_loc8_,_loc9_) > const_109)
            {
               _loc9_--;
               break;
            }
         ...
         if(_loc22_)
         {
            ...
            while(_loc2_ < _loc26_)
            {
               if(!_loc20_[_loc2_])
               {
                  ...
                  {
                     if(this.getTileHeightInternal(_loc29_.x + _loc3_ * _loc30_.x - _loc31_.x,_loc29_.y + _loc3_ * _loc30_.y - _loc31_.y) == const_109)
                     {
                        _loc20_[_loc2_] = true;
                        break;
                     }
      ...
      private function extractTopWall(param1:Point) : Point
      {
         ...
         while(_loc2_ < 1000)
         {
            if(this.getTileHeightInternal(param1.x + _loc2_,param1.y) > const_109)
            {
               return new Point(param1.x + _loc2_ - 1,param1.y);
            }
            if(this.getTileHeightInternal(param1.x + _loc2_,param1.y + 1) <= const_109)
            {
      ...
      private function extractRightWall(param1:Point) : Point
      {
         ...
         while(_loc2_ < 1000)
         {
            if(this.getTileHeightInternal(param1.x,param1.y + _loc2_) > const_109)
            {
               return new Point(param1.x,param1.y + (_loc2_ - 1));
            }
            if(this.getTileHeightInternal(param1.x - 1,param1.y + _loc2_) <= const_109)
            {
      ...
      {
         var _loc12_:* = null;
         this.addPlane(RoomPlaneData.const_271,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_456,param1,param2,param3,[param4]);
         var _loc8_:Number = const_1237 * this.var_1534;
         var _loc9_:Number = const_693 * this.var_1018;
         ...
         this.addPlane(RoomPlaneData.const_271,Vector3d.sum(param1,param3),param2,_loc11_,[_loc10_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_271,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_271,Vector3d.sum(param1,Vector3d.product(param3,-_loc9_ / param3.length)),Vector3d.product(param3,(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
            if(param7)
            {
               _loc12_ = Vector3d.product(param2,_loc8_ / param2.length);
               this.addPlane(RoomPlaneData.const_271,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc12_,-1)),_loc12_,_loc11_,[_loc10_,param2,param4]);
            }
         }
      }
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number, param12:Boolean, param13:Boolean) : void
      {
         ...
         var _loc14_:RoomPlaneData = this.addPlane(RoomPlaneData.const_275,param1,param2,param3);
         var _loc15_:IVector3d = param1;
         var _loc16_:* = null;
         var _loc17_:* = null;
         if(_loc14_)
         {
            _loc18_ = const_693 * this.var_1018;
            _loc19_ = _loc18_;
            if(this.var_1018 > 1)
            {
               _loc19_ = const_693;
            ...
            if(param6)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_275,_loc15_,new Vector3d(0,0,-_loc20_),param2);
               if(_loc16_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_275,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param2,-1));
               if(_loc16_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_275,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param3,-1));
               if(_loc17_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_275,_loc15_,new Vector3d(0,0,-_loc20_),param3);
               if(_loc17_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getXML() : XML
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_223}" height="{this._height}" wallHeight="{this.var_1543}"/>;
         var _loc2_:int = 0;
         ...
         {
            _loc12_ = this.var_333.getWithIndex(_loc4_);
            if(_loc12_ != null)
            {
               _loc13_ = this.var_333.getKey(_loc4_);
      ...
      public function getPlaneLocation(param1:int) : IVector3d
      {
         ...
         var _loc2_:RoomPlaneData = this.var_156[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.loc;
         }
      ...
      public function method_3(param1:int) : IVector3d
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return null;
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1325;
         }
         var _loc2_:RoomPlaneData = this.var_156[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = this.var_156[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {
      ...
      public function addFloorHole(param1:int, param2:int, param3:int, param4:int, param5:int) : void
      {
         ...
         this.var_333.add(param1,_loc6_);
      }
      
      public function removeFloorHole(param1:int) : void
      {
         this.var_333.remove(param1);
      }
      ...
      private function initializeHoleMap() : void
      {
         ...
         while(_loc4_ < this.var_333.length)
         {
            _loc5_ = this.var_333.getWithIndex(_loc4_);
            if(_loc5_ != null)
            {
               _loc6_ = _loc5_.x;
