package com.sulake.habbo.room.object.visualization.data
{
   public class AnimationFrameSequenceData
   {
      ...
      {
         return this.var_482.length * this._loopCount;
      }
      ...
      public function initialize() : void
      {
         var _loc1_:int = 1;
         var _loc2_:int = -1;
         var _loc3_:int = this.var_482.length - 1;
         while(_loc3_ >= 0)
         {
            if(this.var_482[_loc3_] == _loc2_)
            {
               _loc1_++;
            }
            else
            {
               _loc2_ = this.var_482[_loc3_];
               _loc1_ = 1;
            }
            this.var_1005[_loc3_] = _loc1_;
            _loc3_--;
         }
      }
      ...
      public function addFrame(param1:int, param2:int, param3:int, param4:int, param5:int, param6:DirectionalOffsetData) : void
      {
         ...
         this.var_482.push(this._frames.length - 1);
         this.var_1005.push(1);
      }
      ...
      public function getFrame(param1:int) : AnimationFrameData
      {
         ...
         param1 = this.var_482[param1 % this.var_482.length];
      ...
      public function getFrameIndex(param1:int) : int
      {
         ...
         if(this.var_1966)
         {
            param1 = Math.random() * this.var_482.length;
            if(param1 == this.var_482.length)
            {
               param1--;
            }
         }
      ...
      public function getRepeats(param1:int) : int
      {
         ...
         return this.var_1005[param1 % this.var_1005.length];
      }
   }
}
