package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetAnimationSizeData extends AnimationSizeData
   {
      ...
      public static const const_1019:int = -1;
      ...
      public function definePostures(param1:XML) : Boolean
      {
         ...
         {
            this.var_890 = param1.@defaultPosture;
         }
         else
         {
            this.var_890 = null;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_722.add(_loc6_,_loc7_);
         ...
         if(this.var_722.getValue(this.var_890) == null)
         {
            return false;
         }
         return true;
      ...
      public function defineGestures(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            _loc6_ = String(_loc5_.@id);
            _loc7_ = int(_loc5_.@animationId);
            this.var_891.add(_loc6_,_loc7_);
            _loc4_++;
         }
         return true;
      }
      ...
      {
         if(this.var_722.getValue(param1) == null)
         {
            param1 = this.var_890;
         }
      ...
      {
         if(this.var_891.getValue(param1) == null)
         {
            return const_1019;
         }
         return int(this.var_891.getValue(param1));
      }
      ...
      public function getPostureForAnimation(param1:int) : String
      {
         ...
         {
            return this.var_722.getKey(param1);
         }
         return this.var_890;
      }
      ...
      {
         if(param1 >= 0 && param1 < this.var_891.length)
         {
            return this.var_891.getKey(param1);
         }
         return null;
      }
      ...
      {
         return this.var_722.length;
      }
      
      public function getGestureCount() : int
      {
         return this.var_891.length;
      }
   }
}
