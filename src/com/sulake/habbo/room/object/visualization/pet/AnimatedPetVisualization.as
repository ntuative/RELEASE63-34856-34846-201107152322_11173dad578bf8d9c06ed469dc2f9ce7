package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1452:String = "head";
      
      private static const const_685:int = 1;
      
      private static const const_1056:int = 1000;
      
      private static const const_1451:String = "pet_experience_bubble_png";
      
      private static const const_1454:int = 0;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1451) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_374 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2371)
            {
               this.var_2371 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_270);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_155);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_270);
            if(!isNaN(_loc6_))
            {
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_155);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_2192 = _loc3_.getNumber(RoomObjectVariableEnum.const_250) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_228);
            if(!isNaN(_loc8_))
            {
               this.var_1783 = _loc8_;
            }
            else
            {
               this.var_1783 = direction;
            }
            this.var_1478 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2370 = _loc3_.getNumber(RoomObjectVariableEnum.const_396);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_830);
            if(_loc9_ != this.var_1782)
            {
               this.var_1782 = _loc9_;
               this.var_2372 = this.var_1782.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_374 != null)
         {
            ...
            if(this.var_1478 > 0)
            {
               _loc2_ = param1 - this.var_1478;
               if(_loc2_ < const_1056)
               {
                  this.var_374.alpha = int(Math.sin(_loc2_ / const_1056 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_374.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_374.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_309)
         {
            ...
            this.setAnimationForIndex(const_1454,_loc3_);
         }
         if(param2 != this.var_1501)
         {
            this.var_1501 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_102,param2);
            this.setAnimationForIndex(const_1453,_loc3_);
         }
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2372);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_685)
         {
            ...
            {
               if(param2 >= FurnitureVisualizationData.const_671.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_671[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1783);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_102,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1452)
            {
               this.var_976[param1] = true;
            }
            else
            {
               this.var_976[param1] = false;
            }
         }
