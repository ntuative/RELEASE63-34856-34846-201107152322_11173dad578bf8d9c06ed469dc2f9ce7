package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private var var_738:PetVisualizationData = null;
      ...
      private const const_1479:int = 3;
      ...
      private var var_1829:Number = NaN;
      ...
      {
         this.var_738 = param1 as PetVisualizationData;
         createSprites(this.const_1479);
         var _loc2_:BitmapData = (this.var_738.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset).content as BitmapData;
         this.var_374 = new ExperienceData(_loc2_.clone());
         return true;
      }
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_2192 = param1.getNumber(RoomObjectVariableEnum.const_250) > 0;
            this.var_1501 = param1.getString(RoomObjectVariableEnum.const_155);
            this.var_309 = param1.getString(RoomObjectVariableEnum.const_270);
            this.var_1692 = param1.getString(RoomObjectVariableEnum.const_978);
            this.var_1829 = param1.getNumber(RoomObjectVariableEnum.const_228);
            this.var_1478 = param1.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2370 = param1.getNumber(RoomObjectVariableEnum.const_396);
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_506 != param1.getUpdateID() || this.var_1827 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_1829;
            if(isNaN(this.var_1829))
            {
               _loc5_ = _loc4_;
            }
            else
            ...
            if(_loc4_ != this.var_2193 || param3)
            {
               this.var_2193 = _loc4_;
               _loc4_ -= 112.5;
               _loc4_ = (_loc4_ + 360) % 360;
               this.var_67.setDirectionAngle(AvatarSetType.const_43,_loc4_);
            }
            if(_loc5_ != this.var_2194 || param3)
            {
               this.var_2194 = _loc5_;
               _loc5_ -= 112.5;
               _loc5_ = (_loc5_ + 360) % 360;
               this.var_67.setDirectionAngle(AvatarSetType.const_58,_loc5_);
            }
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = this.var_738.getAvatar(this._figure,param1,this);
            if(_loc3_ != null)
            {
      ...
      private function updateShadow(param1:Number) : void
      {
         ...
         this.var_740 = null;
         _loc2_ = getSprite(this.const_2074);
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(param1 < 48)
         {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc12_:Boolean = this.var_995 || this.var_1213 > 0 || this.var_1828;
         this.var_374.alpha = 0;
         if(this.var_1478 > 0)
         {
            _loc13_ = param2 - this.var_1478;
            if(_loc13_ < AvatarAction.const_1056)
            {
               this.var_374.alpha = int(Math.sin(_loc13_ / 0 * 0) * 255);
               this.var_374.setExperience(this.var_2370);
               this.var_1213 = this.const_2346;
            }
            else
            {
               this.var_1478 = 0;
            }
            _loc14_ = getSprite(this.const_2106);
            if(_loc14_ != null)
            {
               if(this.var_374.alpha > 0)
               {
                  _loc14_.asset = this.var_374.image;
                  _loc14_.offsetX = -20;
                  _loc14_.offsetY = -80;
                  _loc14_.alpha = this.var_374.alpha;
         ...
         if(_loc11_ || _loc12_)
         {
            ...
            _loc14_ = getSprite(this.const_1158);
            if(_loc14_)
            {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         if(this.var_1501 != null && this.var_1501 != "")
         {
            param1.appendAction(AvatarAction.const_329,this.var_1501);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1479;
