package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_784:IGraphicAssetCollection;
      
      private var var_1859:XMLList;
      
      private var _offsetX:int;
      
      private var var_1251:int;
      
      private var var_2643:Vector3d;
      ...
      private var var_1032:Boolean = true;
      ...
      private var var_1255:Point = null;
      
      private var var_1555:LayoutRasterizerData = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_1031)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1555 = this.var_46.getValue(this.var_1031);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2643 = new Vector3d(-0.5,0.5,0);
         this.var_1032 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2643);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_1255.x = _loc3_.x;
         this.var_1255.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_46.getValue(this.var_1031);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1932 = RoomObjectVariableEnum.const_1347;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1932 = RoomObjectVariableEnum.const_1165;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1256 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1256 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_46.getValue(this.var_1031);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2642 && param3 == this.var_2641)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1256 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1256 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1932);
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1555.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_784.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1255.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1255.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_462.indexOf(_loc10_) >= 0 && this.var_1032)
            {
               param1 = this.var_462.indexOf(_loc10_);
               if(this.var_669[param1] != "")
               {
                  _loc9_ = this.var_784.getAsset(this.var_669[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_668[param1] != -1)
               {
                  param2.alpha = this.var_668[param1];
               }
               this.var_462.splice(param1,1);
               this.var_669.splice(param1,1);
               this.var_668.splice(param1,1);
      ...
      {
         this.var_1032 = true;
         var _loc3_:int = this.var_462.indexOf(param1);
         if(_loc3_ < 0)
         {
            this.var_462.push(param1);
            this.var_669.push(param2);
            this.var_668.push(-1);
         }
         else
         {
            this.var_669[_loc3_] = param2;
         }
      }
      ...
      public function changeElementAlpha(param1:String, param2:Number) : void
      {
         ...
         if(_loc3_ < 0)
         {
            this.var_462.push(param1);
            this.var_669.push("");
            this.var_668.push(param2);
         }
         else
         {
            this.var_668[_loc3_] = param2;
         }
      }
   }
}
