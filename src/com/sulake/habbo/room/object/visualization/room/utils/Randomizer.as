package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2145:int = 16777216;
      ...
      private var var_1863:int = 16777216;
      
      private var var_3079:int = 69069;
      
      private var var_3078:int = 5;
      ...
      {
         var _loc1_:int = this.var_3079 * this.var_1862 + this.var_3078;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1863;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1863 * param2);
      }
   }
}
