package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1924:int = 16777215;
      
      public static const const_1997:int = 13421772;
      
      private static const const_1075:int = 16777215;
      
      private static const const_1077:int = 13421772;
      
      private static const const_1078:int = 10066329;
      
      private static const const_1076:int = 10066329;
      
      public static const const_1903:int = 16777215;
      
      public static const const_1799:int = 13421772;
      
      public static const const_2023:int = 10066329;
      ...
      private var var_811:Rectangle = null;
      
      private var var_545:RoomPlaneBitmapMaskParser = null;
      
      private var var_1681:String = null;
      
      private var _floorType:String = null;
      
      private var var_1680:String = null;
      
      private var var_1018:Number = NaN;
      
      private var var_1534:Number = NaN;
      
      private var var_2551:Number = NaN;
      
      private var var_1890:String = null;
      
      private var var_1228:uint = 16777215;
      
      private var var_2555:int = 255;
      
      private var var_2556:int = 255;
      
      private var var_2552:int = 255;
      ...
      private var var_2553:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_545 = new RoomPlaneBitmapMaskParser();
      ...
      private function resetRoomPlanes() : void
      {
         ...
         if(this.var_156 != null)
         {
            ...
            {
               _loc2_ = this.var_156[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_811 = super.boundingRectangle;
         }
         return new Rectangle(this.var_811.x,this.var_811.y,this.var_811.width,this.var_811.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_156.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_156[_loc2_] as RoomPlane;
            _loc4_ = getSprite(_loc2_);
            if(_loc4_ != null && _loc3_ != null && _loc3_.leftSide != null && _loc3_.rightSide != null)
            {
               if(_loc3_.type == RoomPlane.const_72 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
               ...
               if(_loc3_.type == RoomPlane.const_72)
               {
                  _loc4_.tag = "plane.wall@" + (_loc2_ + 1);
               }
               else if(_loc3_.type == RoomPlane.const_111)
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1018))
         {
            this._planeParser.floorThicknessMultiplier = this.var_1018;
         }
         if(!isNaN(this.var_1534))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1534;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1009);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1286);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            _loc10_ = this._planeParser.method_3(_loc7_);
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_275)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_271)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_72,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_456)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1903;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1799;
               }
               else
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1817)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_72,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_456)
            {
      ...
      private function getLandscapeHeight() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_456)
            {
               _loc4_ = this._planeParser.method_3(_loc2_);
            ...
            while(_loc10_ < this.var_387.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1889)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2552 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2556 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2555 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1827)
         {
            this.var_1827 = param1.updateId;
            this.var_811 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1685 || _loc3_.y != this.var_2554 || _loc3_.z != this.var_2553 || param1.scale != this.var_1888))
            {
               this.var_1685 = _loc3_.x;
               this.var_2554 = _loc3_.y;
               this.var_2553 = _loc3_.z;
               this.var_1888 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1297);
            if(_loc3_ != this.var_1890)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1890 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_741));
            if(_loc4_ != this.var_1228)
            {
               this.var_1228 = _loc4_;
               this.var_2552 = this.var_1228 & 255;
               this.var_2556 = this.var_1228 >> 8 & 255;
               this.var_2555 = this.var_1228 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1166));
            if(_loc5_ != this.var_1889)
            {
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_236);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_222);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_226);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_941));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_794));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_888));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1367);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1315);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_1018 || _loc3_ != this.var_1534))
            {
               this.var_1018 = _loc2_;
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1342);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2551)
            {
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_156.length)
         {
            _loc5_ = this.var_156[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_111 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               else if(_loc5_.type == RoomPlane.const_72 && param2 != null)
               {
                  _loc5_.id = param2;
               }
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_111)
                        {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1227;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_545.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_156.length)
         {
            _loc3_ = this.var_156[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_545.maskCount)
         {
            _loc10_ = this.var_545.getMaskType(_loc8_);
            _loc11_ = this.var_545.getMaskLocation(_loc8_);
            _loc12_ = this.var_545.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_156.length)
               {
                  _loc3_ = this.var_156[_loc13_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_72 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_72 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_253)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_156[_loc18_] as RoomPlane;
