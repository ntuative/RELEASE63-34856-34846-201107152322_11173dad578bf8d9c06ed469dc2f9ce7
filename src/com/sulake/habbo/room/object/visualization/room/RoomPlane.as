package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_1932:int = 0;
      
      public static const const_72:int = 1;
      ...
      private var var_1302:Vector3d = null;
      ...
      private var var_1074:IPlaneRasterizer = null;
      
      private var var_880:PlaneMaskManager = null;
      
      private var _id:String = null;
      
      private var var_2818:Number = 0;
      
      private var var_2817:Number = 0;
      
      private var var_2819:Number = 0;
      
      private var var_2815:Number = 0;
      
      private var var_229:Map = null;
      ...
      private var var_858:Boolean = true;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_1302 = new Vector3d();
         this.var_1302.assign(param1);
         this.var_107 = new Vector3d();
         this.var_107.assign(param2);
         this.var_351 = new Vector3d();
         this.var_351.assign(param3);
         this.var_352 = new Vector3d();
         this.var_352.assign(param4);
         this._normal = Vector3d.crossProduct(this.var_351,this.var_352);
      ...
      {
         return this._isVisible && this.var_858;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_229 != null)
         {
            ...
            {
               _loc2_ = this.var_229.getWithIndex(_loc1_) as PlaneBitmapData;
               if(_loc2_ != null)
               {
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_705);
                  return param1;
               }
            }
         }
      ...
      {
         var _loc3_:PlaneBitmapData = this.var_229.remove(param1) as PlaneBitmapData;
         if(_loc3_ != null)
         {
         ...
         this.var_477 = param2;
         this.var_229.add(param1,param2);
         return true;
      }
      ...
      private function resetTextureCache(param1:BitmapData = null) : void
      {
         ...
         if(this.var_229 != null)
         {
            ...
            {
               _loc3_ = this.var_229.getWithIndex(_loc2_) as PlaneBitmapData;
               if(_loc3_ != null)
               {
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1074.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc3_ = this.var_229.getValue(_loc4_) as PlaneBitmapData;
         }
         this.updateMaskChangeStatus();
         if(this.var_858 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_407))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_351.length * param1.scale;
            ...
            if(this.var_1074 != null)
            {
               _loc3_ = this.var_1074.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_2024,this.var_2818,this.var_2817,this.var_2819,this.var_2815,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1827 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_858)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1540.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1540[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1302);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_181.z - originZ,this.var_140.z - originZ,this.var_98.z - originZ,this.var_141.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2814 = relativeDepth;
            this._isVisible = true;
            this.var_1827 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2816);
      ...
      {
         this.var_181.assign(param1.getScreenPosition(this.var_107));
         this.var_140.assign(param1.getScreenPosition(Vector3d.sum(this.var_107,this.var_352)));
         this.var_98.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_107,this.var_351),this.var_352)));
         this.var_141.assign(param1.getScreenPosition(Vector3d.sum(this.var_107,this.var_351)));
         this._offset = param1.getScreenPoint(this.var_1302);
         ...
         var _loc2_:Number = Math.min(this.var_181.x,this.var_140.x,this.var_98.x,this.var_141.x);
         var _loc3_:Number = Math.max(this.var_181.x,this.var_140.x,this.var_98.x,this.var_141.x);
         var _loc4_:Number = Math.min(this.var_181.y,this.var_140.y,this.var_98.y,this.var_141.y);
         var _loc5_:Number = Math.max(this.var_181.y,this.var_140.y,this.var_98.y,this.var_141.y);
         _loc3_ -= _loc2_;
      ...
      {
         if(this.var_181 == null || this.var_140 == null || this.var_98 == null || this.var_141 == null || param2 == null || this._bitmapData == null)
         {
            return;
         }
         var _loc3_:Number = this.var_141.x - this.var_98.x;
         var _loc4_:Number = this.var_141.y - this.var_98.y;
         var _loc5_:Number = this.var_140.x - this.var_98.x;
         var _loc6_:Number = this.var_140.y - this.var_98.y;
         if(this._type == const_72 || this._type == TYPE_LANDSCAPE)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_72 || this._type == TYPE_LANDSCAPE))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_1072)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_408.length)
            {
               _loc5_ = this.var_408[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_295.length == this.var_1073.length)
         {
            while(_loc1_ < this.var_295.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = this.var_1073[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_408.length > this.var_1624.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1072 || this.var_295.length == 0 && this.var_408.length == 0 && !this.var_407 || this.var_880 == null)
         {
            return;
         }
         ...
         if(this.var_407)
         {
            ...
            while(_loc5_ < this.var_295.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_80.width - this.var_80.width * _loc3_.leftSideLoc / this.var_351.length;
                  _loc11_ = this.var_80.height - this.var_80.height * _loc3_.rightSideLoc / this.var_352.length;
                  _loc12_ = _loc3_.type;
                  this.var_880.updateMask(this.var_80,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_1073.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_408.length)
            {
               _loc4_ = this.var_408[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_80.width - this.var_80.width * _loc4_.leftSideLoc / this.var_351.length;
                  _loc11_ = this.var_80.height - this.var_80.height * _loc4_.rightSideLoc / this.var_352.length;
                  _loc13_ = this.var_80.width * _loc4_.leftSideLength / this.var_351.length;
                  _loc14_ = this.var_80.height * _loc4_.rightSideLength / this.var_352.length;
                  this.var_80.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1624.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_407 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_254.copyChannel(param1,param1.rect,const_705,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_254.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_254,this.var_254.rect,const_705,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
