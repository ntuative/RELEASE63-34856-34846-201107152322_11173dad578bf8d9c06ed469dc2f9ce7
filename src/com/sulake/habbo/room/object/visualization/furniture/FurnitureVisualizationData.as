package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      public static const const_671:Array = new Array("a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z");
      ...
      private var var_1090:SizeData = null;
      
      private var var_2075:int = -1;
      
      private var var_2406:int = -1;
      
      private var var_2872:int = -1;
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         if(_loc2_ < this._sizes.length)
         {
            this.var_1090 = this.var_345.getValue(String(this._sizes[_loc2_])) as SizeData;
         }
         else
         {
            this.var_1090 = null;
