package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1695:String = "branded_image";
      
      private static const const_1693:int = 0;
      
      private static const const_1697:int = 1;
      
      private static const const_1694:int = 2;
      
      private static const const_1696:int = 3;
       
      
      protected var _imageUrl:String;
      
      protected var var_1431:Boolean = false;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1717 = _loc4_.getNumber(RoomObjectVariableEnum.const_527);
                  this.var_1718 = _loc4_.getNumber(RoomObjectVariableEnum.const_647);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_672);
               }
            }
         }
         if(!this.var_1431)
         {
            this.var_1431 = this.checkIfImageReady();
            if(this.var_1431)
            {
               this.checkAndCreateImageForCurrentState(param1);
               return true;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_498);
                     if(_loc4_ == 1)
                     {
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(this._imageUrl != null && _loc6_ == const_1695)
         {
