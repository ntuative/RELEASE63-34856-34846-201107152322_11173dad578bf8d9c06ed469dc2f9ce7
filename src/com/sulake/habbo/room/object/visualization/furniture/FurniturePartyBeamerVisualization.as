package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1560:int = 2;
      
      private static const const_1559:int = 1;
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_1272[param2];
         var _loc4_:int = this.var_1271[param2];
         var _loc5_:int = this.var_1274[param2];
         var _loc6_:Number = this.var_1273[param2];
         if(param1 == 32)
         {
            _loc7_ = const_1098;
         }
         ...
         this.var_1272[param2] = _loc3_;
         if(int(_loc9_) == 0)
         {
            this.var_1273[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1272.push(Math.random() * _loc2_ * 1.5);
         this.var_1272.push(Math.random() * _loc2_ * 1.5);
         this.var_1271 = new Array();
         this.var_1271.push(1);
         this.var_1271.push(-1);
         this.var_1274 = new Array();
         this.var_1274.push(const_1560);
         this.var_1274.push(const_1559);
         this.var_1273 = new Array();
         this.var_1273.push(this.getRandomAmplitudeFactor());
         this.var_1273.push(this.getRandomAmplitudeFactor());
      }
