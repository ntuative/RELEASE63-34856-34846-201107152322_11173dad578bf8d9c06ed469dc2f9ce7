package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private var var_243:FurnitureParticleSystem;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_622)
         {
            for each(_loc1_ in this.var_622)
            {
               _loc1_.dispose();
            }
            this.var_622 = null;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_243 = this.var_622[param1];
               _loc3_ = true;
            }
      ...
      override protected function setAnimation(param1:int) : void
      {
         if(this.var_243)
         {
            this.var_243.setAnimation(param1);
         }
      ...
      {
         if(this.var_243 && this.var_243.controlsSprite(param3))
         {
            return this.var_243.getSpriteYOffset(param1,param2,param3);
         }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1373);
         if(_loc3_.length == 0)
         {
