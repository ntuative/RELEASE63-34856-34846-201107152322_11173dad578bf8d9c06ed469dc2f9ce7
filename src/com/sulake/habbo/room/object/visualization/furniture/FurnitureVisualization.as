package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_2487:Number = NaN;
      ...
      private var var_2489:Number = 0.0;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1522 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1522;
            this.var_1522 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_728 != spriteCount)
         {
            createSprites(this.var_728);
         }
         if(param2)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2491;
            }
            else
            {
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_400:
               break;
            case LayerData.const_1256:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_1258:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_506 != _loc3_.getUpdateID() || param1 != var_102 || param2 != this.var_2487)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2492 = _loc3_.getNumber(RoomObjectVariableEnum.const_263);
            ...
            this.var_2491 = this.var_1223 != null;
            this.var_2489 = _loc3_.getNumber(RoomObjectVariableEnum.const_879);
      ...
      {
         if(this.var_2493 != param2 || this.var_2490 != param1)
         {
            this.var_1001 = [];
            this.var_1000 = [];
            this.var_804 = [];
            ...
            this.var_2488 = this.getSize(param1);
      ...
      {
         this.var_728 = param1;
         this.var_1523 = this.var_728 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_671.length)
         {
            return "";
         }
         ...
         {
            _loc5_ = this.var_2488;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1523)
            {
               _loc6_ = FurnitureVisualizationData.const_671[param2];
            }
            else
            {
               _loc6_ = "sd";
      ...
      {
         if(this.var_807[param3] != null && !this.var_1857)
         {
            return this.var_807[param3];
         }
         if(this._data == null)
         {
         ...
         this.var_807[param3] = _loc4_;
         return _loc4_;
      }
      
      protected function getSpriteColor(param1:int, param2:int, param3:int) : int
      {
         if(this.var_803[param2] != null)
         {
            return this.var_803[param2];
         }
         if(this._data == null)
         {
         ...
         this.var_803[param2] = _loc4_;
         return _loc4_;
      }
      
      protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         if(this.var_808[param3] != null)
         {
            return this.var_808[param3];
         }
         if(this._data == null)
         {
      ...
      {
         var _loc4_:int = 0;
         if(param3 != this.var_1523)
         {
            if(this.var_805[param3] != null)
            {
               return this.var_805[param3];
            }
            if(this._data != null)
            {
               _loc4_ = this._data.getYOffset(param1,param2,param3);
               this.var_805[param3] = _loc4_;
               return _loc4_;
            }
            return LayerData.const_555;
         }
         return Math.ceil(this.var_2489 * (param1 / 2));
      }
      
      protected function getSpriteMouseCapture(param1:int, param2:int, param3:int) : Boolean
      {
         if(this.var_809[param3] != null)
         {
            return this.var_809[param3];
         }
         if(this._data == null)
         {
            return true;
         ...
         this.var_809[param3] = _loc4_;
         return _loc4_;
      }
      
      protected function getSpriteInk(param1:int, param2:int, param3:int) : int
      {
         if(this.var_806[param3] != null)
         {
            return this.var_806[param3];
         }
         if(this._data == null)
         {
