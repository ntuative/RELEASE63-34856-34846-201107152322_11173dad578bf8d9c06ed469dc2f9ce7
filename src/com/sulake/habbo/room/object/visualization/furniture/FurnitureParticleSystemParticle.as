package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemParticle
   {
      ...
      public function init(param1:Number, param2:Number, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:int, param8:Boolean = false, param9:Array = null, param10:Boolean = false) : void
      {
         ...
         this.var_2171 = this._x - this._direction.x * param6;
         this.var_2170 = this.var_187 - this._direction.y * param6;
         this.var_2169 = this.var_186 - this._direction.z * param6;
         this.var_592 = 0;
         this.var_1382 = false;
         this.var_1122 = param7;
         this.var_2985 = param8;
         this._frames = param9;
      ...
      {
         ++this.var_592;
         if(this.var_592 == this.var_1122)
         {
            this.ignite();
         }
         if(this.var_2172)
         {
            if(this.var_592 / this.var_1122 > this.var_1711)
            {
               this._alphaMultiplier = (this.var_1122 - this.var_592) / (this.var_1122 * (1 - this.var_1711));
            }
         }
      }
      ...
      public function getAsset() : IGraphicAsset
      {
         ...
         {
            return this._frames[this.var_592 % this._frames.length];
         }
         return null;
      }
      ...
      {
         return this.var_592 <= this.var_1122;
      }
