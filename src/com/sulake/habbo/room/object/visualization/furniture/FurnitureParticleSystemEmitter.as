package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_2011:String = "cone";
      
      public static const const_1940:String = "plane";
      
      public static const const_1840:String = "sphere";
      ...
      private var var_1054:Number = 0.1;
      ...
      public function setup(param1:int, param2:int, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:String, param8:Number, param9:int, param10:int) : void
      {
         ...
         this.var_290 = param6;
         this.var_2757 = param7;
         this.var_2758 = param9;
         this._energy = param8;
         this.var_2755 = param10;
         this.reset();
      }
      ...
      public function reset() : void
      {
         ...
         this.var_1055 = 0;
         this.var_1082 = false;
         this.init(0,0,0,this._direction,this.var_2756,this.var_1054,this.var_2758,true);
      }
      ...
      {
         this.var_1082 = true;
         if(this.var_1055 < this.var_1594)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2754)
         {
            switch(this.var_2757)
            {
               case const_2011:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_1054,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1055 < this.var_1594)
         {
            if(this.age % this.var_2755 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1055 < this.var_1594)
         {
            ...
            _loc4_ = this.y;
            _loc5_ = this.z;
            this.x = (2 - this.var_290) * this.x - (1 - this.var_290) * this.lastX;
            this.y = (2 - this.var_290) * this.y - (1 - this.var_290) * this.lastY + this.var_1991 * this.var_1054 * this.var_1054;
            this.z = (2 - this.var_290) * this.z - (1 - this.var_290) * this.lastZ;
            this.lastX = _loc3_;
            this.lastY = _loc4_;
            this.lastZ = _loc5_;
         }
         ...
         for each(_loc2_ in this.var_399)
         {
            ...
            _loc4_ = _loc2_.y;
            _loc5_ = _loc2_.z;
            _loc2_.x = (2 - this.var_290) * _loc2_.x - (1 - this.var_290) * _loc2_.lastX;
            _loc2_.y = (2 - this.var_290) * _loc2_.y - (1 - this.var_290) * _loc2_.lastY + this.var_1991 * this.var_1054 * this.var_1054;
            _loc2_.z = (2 - this.var_290) * _loc2_.z - (1 - this.var_290) * _loc2_.lastZ;
            _loc2_.lastX = _loc3_;
            _loc2_.lastY = _loc4_;
            _loc2_.lastZ = _loc5_;
