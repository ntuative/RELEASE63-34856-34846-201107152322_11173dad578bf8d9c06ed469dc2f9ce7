package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_2182 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1388 = this.var_2182.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1388)
         {
            this.var_1388.procedure = this.onButtonClick;
         }
         this.var_1387 = this.var_2182.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1387)
         {
            this.var_1387.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_308 >= this.var_73.length - 1)
         {
            this.var_1387.disable();
         }
         else
         {
            this.var_1387.enable();
         }
         if(this.var_308 <= 0)
         {
            this.var_1388.disable();
         }
         else
         {
            this.var_1388.enable();
         }
      }
      ...
      {
         ++this.var_308;
         this.var_308 = Math.min(this.var_308,this.var_73.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_308;
         this.var_308 = Math.max(this.var_308,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_73[this.var_308][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_73[this.var_308][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_73[this.var_308][1]).value;
