package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1336,param1);
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1099)
         {
            if(param1.type == WindowMouseEvent.const_56 || param1.type == WindowMouseEvent.const_291)
            {
               this.var_1099 = false;
            }
         }
         if(!this.var_1099 || param1.type != WindowEvent.const_431)
         {
            return;
         }
         if(this.var_716 != 0)
      ...
      private function displaySlider() : void
      {
         ...
         {
            _loc2_.bitmap = new BitmapData(this.var_869.width,this.var_869.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_869,this.var_869.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_870 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_870.width,this.var_870.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_870,this.var_870.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_2070 = _loc1_.width - _loc2_.width;
            }
         }
