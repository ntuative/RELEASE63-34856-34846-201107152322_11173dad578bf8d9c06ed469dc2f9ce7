package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1639:int = 2;
      ...
      private var var_2068:TriggerConfs;
      
      private var var_2066:ActionTypes;
      
      private var var_2067:ConditionTypes;
      
      private var var_299:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_868:RoomObjectHightLighter;
      
      private var var_211:UserDefinedRoomEventsHelp;
      
      private var var_1326:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_2068 = new TriggerConfs();
         this.var_2066 = new ActionTypes();
         this.var_2067 = new ConditionTypes();
         this.var_299 = new Dictionary();
         super();
         this.var_94 = param1;
         this.var_868 = new RoomObjectHightLighter(param1);
         this.var_211 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_299[param1])
         {
            delete this.var_299[param1];
            this.var_868.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_37.furniLimit)
         {
            this.var_299[param1] = param2;
            this.var_868.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1326 = new SliderWindowController(this.var_94,IWindowContainer(this.find(this.var_57,"delay_slider_container")),this.var_94.assets,0,20,1);
         this.var_1326.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1326.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_868.hideAll(this.var_299);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1326.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_211.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1639) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1639 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2068);
         this.refreshConfigureElement(this.var_2066);
         this.refreshConfigureElement(this.var_2067);
