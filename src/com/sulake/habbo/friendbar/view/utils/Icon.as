package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class Icon implements IDisposable
   {
      ...
      protected static const const_2057:int = 2;
      
      protected static const const_2059:int = 3;
      
      protected static const const_125:int = 4;
      
      protected static const const_464:int = 8;
      
      protected static const const_287:int = 18;
      
      protected static const const_2058:int = 18;
      ...
      {
         this.var_1329 = const_465 | const_464;
         this.var_710 = new Point();
         super();
      }
      ...
      protected function redraw() : void
      {
         ...
         if(this.var_99 && !this.var_99.disposed)
         {
            ...
            {
               this.var_710.x = this.var_710.y = 0;
               _loc1_ = this.var_48.content as BitmapData;
               switch(this.var_1329 & const_2059)
               {
                  case const_465:
                     this.var_710.x = this.var_99.bitmap.width / 2 - _loc1_.width / 2;
                     break;
                  case const_2057:
                     this.var_710.x = this.var_99.bitmap.width - _loc1_.width;
               }
               switch(this.var_1329 & const_2058)
               {
                  case const_464:
                     this.var_710.y = this.var_99.bitmap.height / 2 - _loc1_.height / 2;
                     break;
                  case const_287:
                     this.var_710.y = this.var_99.bitmap.height - _loc1_.height;
               }
               this.var_99.bitmap.copyPixels(_loc1_,_loc1_.rect,this.var_710);
