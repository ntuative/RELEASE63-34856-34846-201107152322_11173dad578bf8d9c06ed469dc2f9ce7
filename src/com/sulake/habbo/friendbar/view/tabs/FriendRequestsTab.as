package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_2063:String = "button_accept_all";
      ...
      protected static const const_1422:String = "text_discard";
      
      private static var var_1503:FriendRequestsTab;
      
      private static const const_73:uint = 4294625561;
      
      private static const const_1063:uint = 4294957414;
      
      private static const const_1683:uint = 4289431312;
      
      private static const const_1684:uint = 4290616362;
      ...
      private var var_1349:IWindowContainer;
      ...
      {
         var _loc2_:FriendRequestsTab = !!var_1503 ? var_1503 : new FriendRequestsTab();
               ...
               if(_loc2_)
               {
                  ...
                  if(!this.var_2118)
                  {
                     ...
                     if(_loc3_)
                     {
                        ...
                        {
                           _loc4_ = this.var_1349.clone() as IWindowContainer;
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1683) : uint(const_1684);
                           _loc5_ = this._requests[_loc8_];
                           _loc4_.id = _loc5_.id;
                           _loc4_.getChildByName(const_682).caption = _loc5_.name;
      ...
      private function allocateRequestsTabWindow() : IWindowContainer
      {
         ...
         this.var_1349 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1422)).textColor = REGION_REJECT_COLOR_EXPOSED;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1040)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1422)).textColor = const_1480;
            }
         }
      }
