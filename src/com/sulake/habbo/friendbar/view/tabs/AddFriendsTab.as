package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class AddFriendsTab extends Tab
   {
      ...
      private static const const_1535:String = "add_friends_tab_xml";
      
      private static const const_1534:String = "find_friends_icon_png";
      
      private static var var_1019:int = -1;
      
      private static const const_73:uint = 6907230;
      
      private static const const_1063:uint = 9209986;
      
      private static const POOL:Array = [];
      
      private static const const_479:Array = [];
      ...
      {
         var _loc1_:IWindowContainer = false ? const_479.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1535).content as XML) as IWindowContainer;
      ...
      private function releaseEntityWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            if(const_479.indexOf(param1) == -1)
            {
               const_479.push(param1);
            }
         }
      }
