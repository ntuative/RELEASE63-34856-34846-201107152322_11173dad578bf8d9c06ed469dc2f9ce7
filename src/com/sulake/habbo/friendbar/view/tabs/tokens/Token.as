package com.sulake.habbo.friendbar.view.tabs.tokens
{
   ...
   public class Token implements IDisposable
   {
      ...
      protected static const const_2051:String = "title";
      ...
      protected var var_1416:FriendNotification;
      
      protected var var_1147:DropAnimation;
      ...
      {
         return this.var_1416.typeCode;
      }
      
      public function get viewOnce() : Boolean
      {
         return this.var_1416.viewOnce;
      }
      ...
      {
         var _loc7_:* = null;
         this._window = var_1433.buildFromXML(var_1434.getAssetByName(param3).content as XML) as IWindowContainer;
         this._window.findChildByName(const_2051).caption = param1;
         this._window.findChildByName(const_1094).caption = !!param2 ? param2 : "";
         ...
         this._icon = var_1433.create("ICON_" + this.typeCode,WindowType.const_321,WindowStyle.const_101,WindowParam.const_30,Token.const_1415) as IRegionWindow;
         this._icon.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = var_1433.create("BITMAP_" + this.typeCode,WindowType.const_453,WindowStyle.const_101,WindowParam.const_195,Token.const_1415) as IBitmapWrapperWindow;
         ...
         if(param6)
         {
            this.var_1147 = new DropAnimation(this._icon,600,32);
         }
      }
   }
}
