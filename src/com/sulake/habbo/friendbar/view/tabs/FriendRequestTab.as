package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestTab extends FriendEntityTab
   {
      ...
      protected static const const_2042:String = "friend_request_tab_xml";
      
      protected static const const_467:String = "bubble";
      
      protected static const const_1094:String = "message";
      
      protected static const const_2041:String = "button_accept";
      ...
      private static const const_1063:uint = 16767334;
      
      private static const REGION_REJECT_COLOR_EXPOSED:uint = 16770666;
      
      private static const const_1480:uint = 16777215;
      
      private static var var_1503:FriendRequestTab;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:FriendRequestTab = !!var_1503 ? var_1503 : new FriendRequestTab();
      ...
      private function allocateRequestTabWindow() : IWindowContainer
      {
         ...
         var _loc7_:IRegionWindow = WINDOWING.create("ICON",WindowType.const_321,WindowStyle.const_101,WindowParam.const_30,new Rectangle(0,0,25,25)) as IRegionWindow;
         _loc7_.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = WINDOWING.create("BITMAP",WindowType.const_453,WindowStyle.const_101,WindowParam.const_33,new Rectangle(0,0,25,25)) as IBitmapWrapperWindow;
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case const_2041:
                  var_360.acceptFriendRequest(var_170.id);
                  break;
               case const_1411:
                  if(selected)
                  {
                  ...
                  break;
               case const_1032:
                  var_360.declineFriendRequest(var_170.id);
            }
         }
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1032)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(REGION_REJECT_TEXT)).textColor = const_1480;
            }
         }
      }
