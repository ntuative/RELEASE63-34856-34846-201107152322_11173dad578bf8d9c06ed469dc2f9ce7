package com.sulake.habbo.friendbar.view
{
   ...
   public class HabboFriendBarView extends AbstractView implements IHabboFriendBarView, IAvatarImageListener
   {
      ...
      private static const const_1642:int = 127;
      
      private static const const_486:int = 1;
      
      private static const const_1638:int = 2;
      
      private static const const_711:int = 3;
      
      private static const const_1125:int = 3;
      
      private static const const_1631:Boolean = false;
      
      private static const const_712:int = 3;
      
      private static const const_1636:String = "arrow";
      
      private static const const_1634:String = "left";
      
      private static const const_1644:String = "right";
      
      private static const const_1640:String = "bar_xml";
      
      private static const const_1639:String = "toggle_xml";
      
      private static const const_76:String = "container";
      
      private static const const_1127:String = "wrapper";
      
      private static const const_1635:String = "border";
      
      private static const const_709:String = "list";
      ...
      private static const const_1643:String = "button_right";
      
      private static const const_1645:String = "button_left_page";
      
      private static const const_1632:String = "button_right_page";
      
      private static const const_1633:String = "button_left_end";
      
      private static const const_1646:String = "button_right_end";
      
      private static const const_1411:String = "button_close";
      
      private static const const_1637:String = "button_open";
      
      private static const const_1641:String = "link_friendlist";
      
      private static const const_1126:String = "messenger";
      
      private static const const_1128:String = "friendlist";
      
      private static const const_710:String = "stream";
      ...
      private var var_1333:ITab;
      
      private var var_1096:int = -1;
      
      private var _startIndex:int = 0;
      
      private var var_1651:TextCropper;
      
      private var var_575:FriendListIcon;
      
      private var var_414:MessengerIcon;
      
      private var var_876:StreamIcon;
         ...
         if(!disposed)
         {
            ...
            if(this.var_50)
            {
               if(!this.var_50.disposed)
               {
                  ...
                  {
                     this.var_50.events.removeEventListener(FriendBarUpdateEvent.const_797,this.onRefreshView);
                     this.var_50.events.removeEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
                     this.var_50.events.removeEventListener(FriendRequestUpdateEvent.const_832,this.onFriendRequestUpdate);
                     this.var_50.events.removeEventListener(NewMessageEvent.const_956,this.onNewInstantMessage);
                     this.var_50.events.removeEventListener(NotificationEvent.const_822,this.onFriendNotification);
                  }
            ...
            if(_windowManager)
            {
               if(true)
               {
                  _windowManager.getWindowContext(const_486).getDesktopWindow().removeEventListener(WindowEvent.const_40,this.onDesktopResized);
               }
            }
            this.var_1651.dispose();
            this.var_1651 = null;
            super.dispose();
         }
      }
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         if(this.var_230)
         {
            ...
            if(this.var_45)
            {
               this.var_230.x = this.var_45.x;
               this.var_230.y = this.var_45.y;
      ...
      public function populate() : void
      {
         ...
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc1_:int = this.var_1096;
         this.deSelect(false);
         var _loc2_:IWindowContainer = this.var_45.findChildByName(const_76) as IWindowContainer;
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_709) as IItemListWindow;
         ...
         var _loc9_:int = _loc6_ + (!!this.var_1650 ? 1 : 0) + (_loc7_ > 0 ? 1 : 0);
         ...
         if(this.var_1650)
         {
            ...
            {
               _loc15_ = 1;
               if(this.var_77.length + _loc15_ < const_712)
               {
                  _loc15_ = Math.min(_loc8_ - this.var_77.length,const_712 - this.var_77.length);
               }
      ...
      private function onFriendBarDataAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_50.events.addEventListener(FriendBarUpdateEvent.const_797,this.onRefreshView);
         this.var_50.events.addEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
         this.var_50.events.addEventListener(FriendRequestUpdateEvent.const_832,this.onFriendRequestUpdate);
         this.var_50.events.addEventListener(NewMessageEvent.const_956,this.onNewInstantMessage);
         this.var_50.events.addEventListener(NotificationEvent.const_822,this.onFriendNotification);
      }
      ...
      {
         var _loc2_:* = null;
         Tab.var_360 = this.var_50;
         Tab.var_504 = this;
         Tab.ASSETS = assets;
         Tab.WINDOWING = _windowManager;
         Tab.var_2214 = var_750;
         Tab.var_2218 = this.var_1651;
         Token.WINDOWING = _windowManager;
         Token.ASSETS = assets;
         var _loc1_:IAsset = assets.getAssetByName(const_1640);
         this.var_45 = _windowManager.buildFromXML(_loc1_.content as XML,const_486) as IWindowContainer;
         this.var_45.x = const_711;
         this.var_45.y = this.var_45.parent.height - (this.var_45.height + const_1638);
         this.var_45.width = this.var_45.parent.width - (const_711 + const_1125);
         this.var_45.setParamFlag(WindowParam.const_294,true);
         this.var_45.procedure = this.barWindowEventProc;
         if(const_1631)
         {
            _loc1_ = assets.getAssetByName(const_1639);
            this.var_230 = _windowManager.buildFromXML(_loc1_.content as XML,const_486) as IWindowContainer;
            this.var_230.x = this.var_45.x;
            this.var_230.y = this.var_45.y;
            this.var_230.setParamFlag(WindowParam.const_294,true);
            this.var_230.visible = false;
            this.var_230.procedure = this.toggleWindowEventProc;
         }
         _loc2_ = IWindowContainer(this.var_45.findChildByName(const_1128));
         ...
         this.var_575 = new FriendListIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         _loc2_ = IWindowContainer(this.var_45.findChildByName(const_1126));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         this.var_414 = new MessengerIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         this.var_414.enable(false);
         this.visible = true;
         _windowManager.getWindowContext(const_486).getDesktopWindow().addEventListener(WindowEvent.const_40,this.onDesktopResized);
         this.var_45.findChildByName(const_710).visible = var_966.getBoolean("friendbar.stream.enabled",false) == true;
         _loc2_ = IWindowContainer(this.var_45.findChildByName(const_710));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         this.var_876 = new StreamIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
      }
      ...
      public function getAvatarFaceBitmap(param1:String) : BitmapData
      {
         ...
         if(var_603)
         {
            _loc3_ = var_603.createAvatarImage(param1,AvatarScaleType.const_61,null,this);
            if(_loc3_)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         var _loc3_:IItemListWindow = this.var_45.findChildByName(const_709) as IItemListWindow;
      ...
      {
         return this.var_1096 == param1.id;
      }
      ...
      public function selectTab(param1:ITab, param2:Boolean) : void
      {
         if(!param1.selected)
         {
            ...
            {
               this.var_1096 = FriendEntityTab(param1).friend.id;
            }
         }
      }
      ...
      private function onFindFriendsNotification(param1:FindFriendsNotificationEvent) : void
      {
         ...
         {
            param1.dispose();
         },HabboAlertDialogFlag.const_662);
      }
      ...
      private function onFriendRequestUpdate(param1:FriendRequestUpdateEvent) : void
      {
         if(this.var_575)
         {
            this.var_575.notify(this.var_50.numFriendRequests > 0);
         }
         this.populate();
      }
      ...
      private function onNewInstantMessage(param1:NewMessageEvent) : void
      {
         if(this.var_414)
         {
            if(param1.notify)
            {
               this.var_414.notify(true);
            }
            else
            {
               this.var_414.enable(true);
            }
         }
      }
      ...
      private function barWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_46)
         {
            ...
            _loc4_ = this.var_50.numFriends + (!!this.var_1650 ? 1 : 0) + (this.var_50.numFriendRequests > 0 ? 1 : 0);
            switch(param2.name)
            {
      ...
      private function toggleArrowButtons(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc6_:IWindowContainer = this.var_45.findChildByName(const_1127) as IWindowContainer;
         _loc5_ = [];
         ...
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1634,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            if(param2)
            {
         ...
         if(!disposed)
         {
            if(this.var_45)
            {
               ...
               if(!param1)
               {
                  ...
                  {
                     if(this.var_77.length < const_712)
                     {
                        param1 = true;
                     }
                     else if(this.var_77.length < this.var_50.numFriends + (!!this.var_1650 ? 1 : 0))
                     {
                        param1 = true;
                     }
      ...
      private function get maxNumOfTabsVisible() : int
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getChildByName(const_1127) as IWindowContainer;
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_709) as IItemListWindow;
         var _loc4_:int = _loc2_.width - _loc3_.width;
         return (_loc1_.width - _loc4_) / (const_1642 + _loc3_.spacing);
      }
