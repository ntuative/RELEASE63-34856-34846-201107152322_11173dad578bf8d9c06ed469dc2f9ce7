package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1055:Boolean = false;
      
      private static const const_683:String = "Navigation";
      
      private static const const_684:String = "Friend Bar";
      
      private static const const_1449:String = "go.friendbar";
      
      private static const const_1447:String = "chat_btn_click";
      
      private static const const_1448:String = "find_friends_btn_click";
      
      private static const const_1053:String = "Toolbar";
      
      private static const const_1054:String = "open";
      
      private static const const_1052:String = "close";
      
      private static const const_1445:String = "FRIENDLIST";
      
      private static const const_1446:String = "MESSENGER";
       
      
      private var var_973:IHabboConfigurationManager;
      
      private var var_93:IHabboCommunicationManager;
      
      private var var_83:IHabboFriendList;
      
      private var var_216:IHabboMessenger;
      
      private var var_633:IHabboEventStream;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_973)
            {
               this.var_973.release(new IIDHabboConfigurationManager());
               this.var_973 = null;
            }
            if(this.var_93)
            {
            ...
            if(this.var_83)
            {
               ...
               {
                  this.var_83.events.removeEventListener(FriendRequestEvent.const_59,this.onFriendRequestEvent);
                  this.var_83.events.removeEventListener(FriendRequestEvent.const_220,this.onFriendRequestEvent);
               }
            ...
            if(this.var_216)
            {
               this.var_216.release(new IIDHabboMessenger());
               this.var_216 = null;
            }
            if(this.var_633)
            {
               this.var_633.release(new IIDHabboEventStream());
               this.var_633 = null;
            }
            this.var_113 = null;
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_93)
         {
            ...
            this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_683,const_684,const_1449));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_216)
         {
            this.var_216.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false,param1));
            if(this.var_93)
            {
               this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_683,const_684,const_1447));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_93)
         {
            ...
            this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_683,const_684,const_1448));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_83)
         {
            if(!this.var_83.disposed)
            {
               ...
               if(this.var_93)
               {
                  this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1053,const_1445,!!this.var_83.isOpen() ? const_1054 : const_1052));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_216)
         {
            ...
            {
               this.var_216.toggleMessenger();
               if(this.var_93)
               {
                  this.var_93.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1053,const_1446,!!this.var_216.isOpen() ? const_1054 : const_1052));
               }
            }
         }
      }
      ...
      public function toggleOfflineStream() : void
      {
         if(this.var_633)
         {
            if(!this.var_633.disposed)
            {
               this.var_633.visible = !this.var_633.visible;
            }
         }
      }
      ...
      {
         this.var_973 = param2 as IHabboConfigurationManager;
         this.var_2358 = this.var_973.getBoolean("friendbar.notifications.enabled",false);
         this.var_1776 = this.var_973.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      {
         this.var_216 = param2 as IHabboMessenger;
      }
      
      private function onOfflineStreamAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_633 = param2 as IHabboEventStream;
      }
      
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_83 = param2 as IHabboFriendList;
         this.var_83.events.addEventListener(FriendRequestEvent.const_59,this.onFriendRequestEvent);
         this.var_83.events.addEventListener(FriendRequestEvent.const_220,this.onFriendRequestEvent);
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_113 = !!const_317 ? this.sortByNameAndOnlineStatus(this.var_113) : this.sortByName(this.var_113);
         }
         events.dispatchEvent(new FriendBarUpdateEvent());
      }
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         this.var_779 = _loc2_.senderId;
         var _loc3_:Boolean = true;
         if(this.var_216)
         {
            if(this.var_216.isOpen())
            {
               _loc4_ = this.var_216.getActiveConversation();
               if(_loc4_)
               {
                  if(_loc4_.id == this.var_779)
                  {
                     _loc3_ = false;
                  }
               }
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_779));
            this.makeNotification(String(this.var_779),FriendNotification.const_462,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         this.var_779 = _loc2_.senderId;
         if(this.var_216 && !this.var_216.isOpen())
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_779));
            this.makeNotification(String(this.var_779),FriendNotification.const_462,null,true,false);
         }
      }
