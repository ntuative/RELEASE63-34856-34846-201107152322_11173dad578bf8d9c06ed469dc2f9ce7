package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_244 = param2;
         this.var_835 = [];
         this.var_835.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_835.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_835)
         {
         ...
         this._events.addEventListener(SongInfoReceivedEvent.const_96,this.onSongInfoReceivedEvent);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_973,this.onSoundMachinePlayEvent);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_740,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_94)
            {
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_973,this.onSoundMachinePlayEvent);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_740,this.onSoundMachineStopEvent);
               this.var_94 = null;
            }
            this._disposed = true;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_447 == param1)
         {
            this.playCurrentSongAndNotify(this.var_447);
      ...
      public function stopPlaying() : void
      {
         this.var_447 = -1;
         this.var_646 = false;
         this.var_244.stop(HabboMusicPrioritiesEnum.const_139);
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_244.playSong(param1,HabboMusicPrioritiesEnum.const_139,_loc3_,0,0,0))
         {
