package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1698:int = HabboMusicPrioritiesEnum.const_139;
      ...
      private var var_588:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_835.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_835.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_835)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_798,this.onJukeboxInit);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_298,this.onJukeboxDispose);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_948,this.onSoundMachineInit);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_869,this.onSoundMachineDispose);
         this.var_1362 = new Timer(1000);
         this.var_1362.start();
         this.var_1362.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_272)
         {
            this.var_348[_loc6_] = null;
            this.var_895[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_2147)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               for each(_loc1_ in this.var_835)
               {
            ...
            if(this.var_305)
            {
               ...
               {
                  _loc3_ = this.var_305.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_94)
            {
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_798,this.onJukeboxInit);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_298,this.onJukeboxDispose);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_948,this.onSoundMachineInit);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_869,this.onSoundMachineDispose);
            }
      ...
      {
         if(param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_272)
         {
            return false;
         }
         var _loc7_:SongStartRequestData = new SongStartRequestData(param2,param3,param4,param5,param6);
         this.var_348[param1] = _loc7_;
         this.var_895[param1] += 1;
         return true;
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         if(this.var_348[param1] == null)
         {
            return -1;
         }
         var _loc2_:SongStartRequestData = this.var_348[param1];
      ...
      {
         var _loc1_:int = this.var_348.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_348[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_305.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_272)
         {
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_727.add(param1,param2);
      ...
      {
         return this.var_416.length;
      }
      
      public function getSongDiskInventoryDiskId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_416.length)
         {
            return this.var_416.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_416.length)
         {
            return this.var_416.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_305.length)
         {
            ...
            if(_loc3_.id != this.var_1679 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_348[_loc2_] != null)
            {
               _loc3_ = this.var_348[_loc2_];
               _loc4_ = this.var_305.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_896));
         Logger.log("Requested song info\'s : " + this.var_896);
         this.var_896 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_305.add(_loc6_.id,_loc10_);
               ...
               this._events.dispatchEvent(new SongInfoReceivedEvent(SongInfoReceivedEvent.const_96,_loc6_.id));
               while(this.var_894.indexOf(_loc6_.id) != -1)
               {
                  this.var_894.splice(this.var_894.indexOf(_loc6_.id),1);
                  if(this.var_894.length == 0)
                  {
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_272)
         {
            return false;
         }
         ...
         this.var_2147 = this.getSongRequestCountAtPriority(param1);
         this.var_1679 = param2;
         if(this._priorityPlaying <= const_1698)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_139)
         {
            this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_131,param1,_loc4_.id,-1));
         }
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2953 != param1.id || _loc3_ > this.var_2952 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2953 = param1.id;
            this.var_2952 = _loc3_;
         }
      }
      ...
      private function areSamplesRequested(param1:int) : Boolean
      {
         ...
         return this.var_727.getValue(param1);
      }
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            this.var_416.add(_loc5_,_loc6_);
            if(this.var_305.getValue(_loc6_) == null)
            {
               this.var_894.push(_loc6_);
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_588 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_94,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_588 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
