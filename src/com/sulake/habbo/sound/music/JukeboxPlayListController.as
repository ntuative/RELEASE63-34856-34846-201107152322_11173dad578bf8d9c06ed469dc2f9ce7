package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      public function JukeboxPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_835 = [];
         this.var_835.push(new NowPlayingMessageEvent(this.onNowPlayingMessage));
         this.var_835.push(new JukeboxSongDisksMessageEvent(this.onJukeboxSongDisksMessage));
         this.var_835.push(new JukeboxPlayListFullMessageEvent(this.onJukeboxPlayListFullMessage));
      ...
      {
         return HabboMusicPrioritiesEnum.const_139;
      }
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_646 = _loc3_.currentSongId != -1;
         if(_loc3_.currentSongId >= 0)
         {
            this.var_244.playSong(_loc3_.currentSongId,HabboMusicPrioritiesEnum.const_139,_loc3_.syncCount / 1000,0,1,1);
            this.var_447 = _loc3_.currentSongId;
         }
         else
         {
            this.stopPlaying();
         ...
         this.var_2198 = _loc3_.currentPosition;
         this._soundManager.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_105,HabboMusicPrioritiesEnum.const_139,_loc3_.currentSongId,_loc3_.currentPosition));
      }
      ...
      private function onJukeboxSongDisksMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDisks.length)
         {
            ...
            if(_loc7_ == null)
            {
               ...
               if(this.var_919.indexOf(_loc5_) < 0)
               {
                  this.var_919.push(_loc5_);
                  this.var_244.requestSongInfoWithoutSamples(_loc5_);
               }
            }
            _loc7_.diskId = _loc6_;
            this.var_601.push(_loc7_);
            _loc4_++;
         }
         ...
         while(_loc2_ < this.length)
         {
            ...
            if(_loc4_.id == param1.id)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  this.var_601[_loc2_] = _loc6_;
               }
               break;
            }
            _loc2_++;
         }
         var _loc3_:int = this.var_919.indexOf(param1.id);
         if(_loc3_ >= 0)
         {
            this.var_919.splice(_loc3_,1);
         }
         if(this.var_919.length == 0)
         {
            this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_106));
