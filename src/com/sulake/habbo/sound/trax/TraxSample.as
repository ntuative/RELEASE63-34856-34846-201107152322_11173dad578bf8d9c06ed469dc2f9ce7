package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1815:String = "sample_44khz";
      
      public static const const_1761:String = "sample_22khz";
      
      public static const const_1784:String = "sample_11khz";
      
      public static const const_1749:String = "sample_16bit";
      
      public static const const_1968:String = "sample_8bit";
      ...
      private var var_175:int = 2;
      
      private var var_86:int = 1;
      
      private var var_659:Array;
      
      private var var_2558:uint;
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_175 * this.var_86;
         ...
         param1.position = 0;
         var _loc9_:int = 0;
         var _loc10_:int = _loc7_ / this.var_86;
         var _loc11_:int = 0;
         while(_loc11_ < _loc10_)
         {
            ...
            if(_loc11_ >= _loc10_ - 1 - const_1079)
            {
               _loc12_ *= (_loc10_ - _loc11_ - 1) / Number(const_1079);
            }
            ...
            _loc9_ *= _loc5_;
            _loc9_ += _loc14_;
            if(_loc11_ % this.var_175 == this.var_175 - 1)
            {
               this.var_133[int(_loc11_ / this.var_175)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_133.length * this.var_175 * this.var_86;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc5_:int = this.var_175 * this.var_86;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
