package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1591:int = 60;
      
      private static const const_1593:int = 25165823;
      
      private static const const_1592:int = 16777215;
      ...
      private var var_951:Number = 1.0;
      ...
      private var var_845:TraxSequencer;
      
      private var var_244:IHabboMusicController;
      
      private var var_1290:Map;
      
      private var var_1601:ByteArray;
      
      private var var_2771:Boolean = false;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_924,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_1058.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1409:
                  _loc3_ = "sound_call_for_help";
                  break;
               case HabboSoundTypesEnum.const_1984:
               ...
               case HabboSoundTypesEnum.const_1210:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1318:
                  _loc3_ = "sound_catalogue_cash";
                  break;
               case HabboSoundTypesEnum.const_2018:
            ...
            this.var_1058.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_951;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_128.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_128.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
         ...
         _loc4_.load(_loc3_);
         this.var_690.add(_loc4_,param1);
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1290.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1057.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            if(this.var_128.getBoolean("trax.player.sample.memory.purge.enabled",false))
            {
               this.var_2771 = true;
            }
         }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1057 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_128 == null || this._connection == null || this._roomEngine == null || this.var_244 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1955,this.var_846));
         this.var_846 = -1;
         this.var_845 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_951 * 100)));
         }
      }
      ...
      {
         this.var_951 = param1;
         this.var_244.updateVolume(this.var_951);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         {
            _loc2_ = this.var_690.remove(param1);
            if(this.var_291.getValue(_loc2_) == null)
            {
               this.var_1601.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1601,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1601,_loc2_,TraxSample.const_1815,TraxSample.const_1749);
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1291.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1591 && this.var_1291.length > 0)
            {
               _loc3_ = this.var_1291.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_690.length == 0 && this.var_846 != -1)
            {
               this.var_845.ready = true;
               _loc4_ = this.var_846;
               this.var_846 = -1;
               this.var_845 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_924,_loc4_));
               if(this.var_2771)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_845 == null && this.var_1290.length > 0)
         {
            _loc1_ = this.var_1290.getKey(0);
            _loc2_ = this.var_1290.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_924,_loc1_));
               }
               else
               {
                  this.var_845 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         if(_loc1_ > const_1593)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1592 && _loc9_ < _loc2_.length)
            {
