package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1581:uint = 13232628;
      
      private static var var_1973:uint = 11129827;
      ...
      private var var_1281:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_360;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_561 = param1;
         if(this.var_1974 == this.var_561)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1972 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_839)
         {
            this.var_839 = this.var_27.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_839)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_840)
         {
            this.var_840 = this.var_27.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_840)
            {
               return;
            }
            this._window.content.addChild(this.var_840);
         }
         this._window.caption = this.var_27.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_840.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_561;
         }
         this.showView(this.var_840);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this.var_27.localization.registerParameter("help.tutorial.name.available","name",this.var_561);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         this.var_1281 = new NameSuggestionListRenderer(this.var_27);
         var _loc6_:int = this.var_1281.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1581;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_561 = this.var_27.myName;
               this.showConfirmationView();
               break;
            ...
            case "select_name_button":
               ...
               if(this.var_561 != _loc5_)
               {
                  this.var_1974 = _loc5_;
            ...
            case "confirm_name_button":
               this.var_27.changeName(this.var_561);
               break;
