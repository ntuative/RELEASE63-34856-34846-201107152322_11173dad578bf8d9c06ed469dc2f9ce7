package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_839)
         {
            this.var_839 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_839)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_840)
         {
            this.var_840 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_840)
            {
               return;
            }
