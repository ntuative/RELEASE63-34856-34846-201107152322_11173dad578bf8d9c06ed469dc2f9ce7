package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTextInput extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1685:int = 30;
      
      private static const const_1508:int = 253;
      
      private static const const_1509:int = 10;
      ...
      {
         main.showUI(HabboHelpViewEnum.const_206);
      }
      ...
      private function sendCallForHelp() : void
      {
         ...
         if(inputField.text.length < const_1685)
         {
