package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1779:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201107152308));
         this.var_129 = new Map();
         this.var_129.add(HabboHelpViewEnum.const_2013,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_206,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_659,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_379,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_247,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_402,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_964,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_261,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_129.add(HabboHelpViewEnum.const_1328,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_129.add(HabboHelpViewEnum.const_1173,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_939,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(param1 == this.var_1779)
         {
            this.var_531 = new Array();
         }
         else if(param2)
         {
            if(this.var_531.length == 0 || param1 != this.var_372)
            {
               this.var_531.push(this.var_372);
            }
         }
         this.var_372 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_261:
               this.showUI(HabboHelpViewEnum.const_261);
               break;
            case CallForHelpResultEnum.const_1404:
               this.showUI(HabboHelpViewEnum.const_1173);
               break;
            case CallForHelpResultEnum.const_1351:
               this.showUI(HabboHelpViewEnum.const_1328);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_129.getValue(HabboHelpViewEnum.const_206) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_572));
      }
      ...
      {
         return this.var_129.getValue(this.var_372);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2361 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2363;
         this._window.width = _loc1_.width + this.var_2361;
      }
      ...
      {
         if(this.var_531.length > 0)
         {
            this.showUI(this.var_531.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_372 == HabboHelpViewEnum.const_206)
         {
            return;
         }
         if(this.var_634.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_634.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_634.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_373.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_634[1],this.var_634[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_634[0],this.var_634[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_372 == HabboHelpViewEnum.const_206 || this.var_531.length == 0)
         {
            return;
         }
         if(this.var_373 == null)
         {
            ...
            this.var_373 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_373.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_373.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_373 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_373 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_373 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
