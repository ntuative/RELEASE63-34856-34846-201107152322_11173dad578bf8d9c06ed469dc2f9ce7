package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            this.var_2069 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_29,RoomObjectTypeEnum.const_227,_loc3_.figureString);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_2069 && param1.type == RoomEngineObjectEvent.const_171)
         {
      ...
      public function addUnseenPets(param1:Array) : void
      {
         ...
         {
            if(this.var_573.indexOf(_loc2_) == -1)
            {
               this.var_573.push(_loc2_);
            }
         }
         this._view.update();
      }
      ...
      {
         return this.var_573.length;
      }
      
      public function isUnseen(param1:int) : Boolean
      {
         return this.var_573.indexOf(param1) > -1;
      }
   }
}
