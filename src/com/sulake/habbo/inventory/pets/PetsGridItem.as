package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_46:
               this.var_1688.setSelectedGridItem(this);
               this.var_1689 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1689 = false;
                  this.var_1688.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1473)
         {
            return;
         }
         this.var_1473.color = !!this.var_1644 ? uint(const_1437) : uint(const_1438);
