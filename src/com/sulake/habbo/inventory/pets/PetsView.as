package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_2086:int = 0;
      
      private const const_1113:int = 1;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_217 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         var _loc2_:PetsGridItem = this.var_571.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_217.removeGridItem(_loc2_.window);
      ...
      {
         if(this.var_571 == null || this.var_571.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_571.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_571.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_217.addGridItem(_loc2_.window);
            this.var_571.add(param1.id,_loc2_);
      ...
      public function updateState() : void
      {
         ...
         {
            _loc2_ = this.const_1113;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1108;
         }
         else
         {
            _loc2_ = this.const_1112;
         }
         ...
         switch(_loc2_)
         {
            case this.const_1113:
               _loc3_.visible = true;
               _loc4_.visible = false;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1108:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1112:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
               _loc6_.visible = true;
      ...
      public function getPetImage(param1:int, param2:int, param3:String, param4:int, param5:Boolean) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = _loc8_.getCroppedImage(AvatarSetType.const_58);
               }
               _loc8_.dispose();
            }
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_78.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_428) > 0;
