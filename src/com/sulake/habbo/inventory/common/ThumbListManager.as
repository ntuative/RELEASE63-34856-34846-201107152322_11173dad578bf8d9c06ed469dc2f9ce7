package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1638:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_708 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_708.width;
         this.var_106 = this.var_708.height;
         this.var_1324 = param5;
         this.var_1088 = param6;
         this.var_256 = Math.floor(this.var_1324 / this._thumbWidth);
         this.var_29 = new BitmapData(this.var_1324,this.var_1088);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_709 = this.resolveRowCountFromList();
         if(this.var_709 == 0)
         {
            this.var_29 = new BitmapData(this.var_1324,this.var_1088);
            return;
         }
         this.var_29 = new BitmapData(Math.max(this.var_256 * this._thumbWidth,this.var_1324),Math.max(this.var_709 * this.var_106,this.var_1088),true,16777215);
         this.var_29.fillRect(this.var_29.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_709)
         {
            _loc4_ = 0;
            while(_loc4_ < this.var_256)
            {
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_256 && this.var_29.height < _loc3_.y * this.var_106)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_256 - 1),this.var_106);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_256 - 1),0,this._thumbWidth,this.var_29.height);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(0,this.var_106),null,null,true);
         _loc4_ = new Rectangle(0,this.var_106,this._thumbWidth * (this.var_256 - 1),this.var_29.height - this.var_106);
      ...
      {
         var _loc1_:* = null;
         if(this.var_1638 != null)
         {
            _loc1_ = this.var_1638.getDrawableList();
         }
      ...
      private function resolveRowCountFromList() : int
      {
         ...
         return int(Math.ceil(_loc1_.length / this.var_256));
      }
      ...
      {
         var _loc2_:Point = this.resolveGridLocationFromImage(param1);
         return int(_loc2_.y * this.var_256 + _loc2_.x);
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / this.var_256);
         var _loc3_:int = param1 % this.var_256;
         return new Point(_loc3_,_loc2_);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc11_:* = null;
         var _loc12_:* = null;
         if(param1.x >= this.var_256)
         {
            return;
         }
         if(param1.y >= this.var_709)
         {
            return;
         }
         var _loc4_:int = this.var_256 - param1.x - 1;
         ...
         if(this.var_29.height < this.var_1088)
         {
            _loc12_ = new BitmapData(this.var_29.width,this.var_1088);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_708.width,this.var_708.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_708.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_708,this.var_708.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
