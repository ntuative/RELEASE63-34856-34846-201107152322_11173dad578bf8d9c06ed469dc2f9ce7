package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1606:int = 100;
      
      private static const const_1607:int = 1000;
      ...
      private var var_1614:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_476 = [];
         this.var_475 = [];
         this.var_698 = new Timer(const_1606,1);
         this.var_698.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2798 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_698.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_698.stop();
               this.var_698 = null;
            }
            if(this.var_228 != null)
            {
               this.var_228.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_228.stop();
               this.var_228 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_36)
            {
               ...
               {
                  this.var_1614 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1614;
            }
            else
            {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         if(param3 == FurniCategory.const_327)
         {
         ...
         if(this.var_853 == null)
         {
            this.var_853 = this._windowManager.buildFromXML(this.var_2798) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_853.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_853.clone() as IWindowContainer;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_228 = new Timer(param1,1);
            this.var_228.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_228.start();
         }
         else
         {
      ...
      {
         this.var_2796 = getTimer();
         this.switchCategory(const_304);
      }
      ...
      {
         this.var_27.checkCategoryInitilization(InventoryCategory.const_459);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_697.add(const_36,new Array());
         this.var_697.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_36;
            _loc5_ = this.var_476.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_45;
            _loc5_ = this.var_475.indexOf(param1.ref) > -1;
         }
         ...
         else
         {
            ...
            for(; _loc10_ < _loc8_.length; _loc10_++)
            {
               ...
               if(_loc9_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_207)
                  {
                     _loc7_ = _loc9_;
                  }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_304)
            {
      ...
      {
         return getTimer() < this.var_2796 + const_1607;
      }
      ...
      {
         return this.var_27.getSubCategoryViewId() == InventorySubCategory.const_331;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_330 || _loc3_.category == FurniCategory.const_327 || _loc3_.category == FurniCategory.const_374)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_697.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_697.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               _loc5_ = _loc4_.getTotalCount();
               if(_loc4_.category == FurniCategory.const_796)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_476.indexOf(_loc2_) == -1)
            {
               this.var_476.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_475.indexOf(_loc2_) == -1)
            {
               this.var_475.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_428:
               return this.var_476.length;
            case UnseenItemCategoryEnum.const_451:
               return this.var_475.length;
            default:
               return this.var_476.length + this.var_475.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_45:
               if(this.var_475 && this.var_475.length > 0)
               {
               ...
               break;
            case const_36:
               if(this.var_476 && this.var_476.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_428));
                  this.var_476 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
