   ...
   public class FurniGridView
   {
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_46)
         {
            ...
            this.var_78.toggleItemSelection(this._category,this.var_217.getGridItemIndex(param1.window));
            this.var_532 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_532 != null && this.var_532 == param2 && !this.var_78.isTradingOpen)
         {
