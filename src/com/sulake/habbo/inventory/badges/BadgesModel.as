package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public static const const_1989:int = -1;
      ...
      private const const_2378:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_368 = param5;
         this.var_368.events.addEventListener(BadgeImageReadyEvent.const_214,this.onBadgeImageReady);
         this._view = new BadgesView(this,param2,param4);
         this.var_734 = [];
         this.var_1383 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_368.events.removeEventListener(BadgeImageReadyEvent.const_214,this.onBadgeImageReady);
            this.var_368 = null;
         }
      }
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_903.length)
         {
            if(this.var_903[_loc2_] == param1)
            {
               this.var_903.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1383.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_734.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_368.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_263.unshift(_loc11_);
            }
            else
            {
               this.var_263.push(_loc11_);
            }
            if(param2)
            {
      ...
      private function getBadge(param1:String) : Badge
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_263.length)
         {
            _loc3_ = this.var_263[_loc2_];
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_341);
         var _loc3_:int = 0;
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_263.length)
         {
            _loc3_ = this.var_263[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_525);
         ...
         var _loc3_:Array = this.getBadges(const_341);
      ...
      {
         return this.getItemInIndex(param1,const_341);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_525);
      }
      ...
      {
         if(param1 == InventoryCategory.const_219 && this.var_27.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_734.indexOf(_loc2_) == -1)
            {
               this.var_734.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_734 && this.var_734.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1230));
            this.var_734 = [];
            for each(_loc2_ in this.var_263)
            {
