package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this.var_27 != null && this.var_27.furniModel != null && this.var_266 != null)
         {
            this.var_27.furniModel.removeLockFrom(this.var_266.id);
            this.var_266 = null;
         }
      }
      ...
      public function getItemStats() : void
      {
         ...
         this.var_2476 = _loc2_;
         this.var_2479 = this.var_266.type;
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_1851,this.var_1852);
         }
      }
      ...
      {
         if(param1 != this.var_2476 || param2 != this.var_2479)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2478);
      }
