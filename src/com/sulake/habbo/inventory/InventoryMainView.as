package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private static const const_477:int = 3;
      ...
      private var var_1726:IWindowContainer;
      
      private var var_759:String;
      
      private var var_2285:IWindowContainer;
      ...
      private const const_2064:Point = new Point(120,150);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_27.inventoryViewOpened(this.var_759);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_367 != null && this.var_367 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_367 || !this.var_27.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_759);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            ...
            case InventoryCategory.const_121:
               ...
               break;
            case InventoryCategory.const_219:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         {
            this.resetUnseenCounters(this.var_367);
         }
         ...
         _loc2_.container.removeChild(this.var_1726);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_367 == InventoryCategory.const_121)
            {
               this.toggleCategoryView(InventoryCategory.const_121);
            }
            else if(this.var_367 == InventoryCategory.const_77)
            {
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_1725)
         {
            this.var_1725 = this.createCounter("badges");
         }
         var _loc1_:int = this.var_27.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_1725,_loc1_);
      ...
      private function createCounter(param1:String) : IWindowContainer
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_.x = _loc4_.width - _loc3_.width - const_477;
            _loc3_.y = const_477;
         }
         return _loc3_;
      }
