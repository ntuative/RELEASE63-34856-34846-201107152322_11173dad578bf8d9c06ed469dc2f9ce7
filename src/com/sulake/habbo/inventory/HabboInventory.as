package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_65)
         {
            _loc1_ = this.var_65.getKeys();
            _loc2_ = 0;
            while(_loc2_ < _loc1_.length)
            {
               _loc3_ = _loc1_[_loc2_];
               _loc4_ = this.var_65.getValue(_loc3_) as IInventoryModel;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         if(this.var_15 != null)
         {
            this.var_15.events.removeEventListener(RoomSessionEvent.const_79,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionEvent.const_86,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_493,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_65.getValue(InventoryCategory.const_77));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_65.getValue(InventorySubCategory.const_331));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_65.getValue(InventoryCategory.const_142));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_65.getValue(InventoryCategory.const_219));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_65.getValue(InventorySubCategory.const_1317));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_65.getValue(InventoryCategory.const_121));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_65.getValue(InventoryCategory.const_459) as MarketplaceModel;
      }
      ...
      {
         return this.var_110.clubIsExpiring;
      }
      ...
      public function setClubStatus(param1:int, param2:int, param3:Boolean, param4:Boolean, param5:Boolean) : void
      {
         ...
         this.var_110.clubIsExpiring = param5;
      ...
      {
         this.var_368 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_79,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionEvent.const_86,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_493,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_86:
               ...
               break;
            case RoomSessionPropertyUpdateEvent.const_493:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_368 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_65.add(InventoryCategory.const_459,_loc1_);
         ...
         this.var_65.add(InventoryCategory.const_77,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_368);
         this.var_65.add(InventoryCategory.const_219,_loc3_);
         ...
         this.var_65.add(InventoryCategory.const_142,_loc4_);
         ...
         this.var_65.add(InventorySubCategory.const_331,_loc5_);
         ...
         this.var_65.add(InventorySubCategory.const_1317,_loc6_);
         ...
         this.var_65.add(InventoryCategory.const_121,_loc7_);
      ...
      {
         var _loc2_:IInventoryModel = IInventoryModel(this.var_65.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         {
            _loc3_ = this.var_65.getWithIndex(_loc2_) as IInventoryModel;
            _loc3_.subCategorySwitch(param1);
            _loc2_++;
         }
         switch(param1)
         {
            case InventorySubCategory.const_331:
      ...
      public function closingInventoryView() : void
      {
         ...
         {
            _loc2_ = this.var_65.getWithIndex(_loc1_) as IInventoryModel;
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_1047.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1047.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1047.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         var _loc2_:IInventoryModel = this.var_65.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2357);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_295));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2715)
         {
            this.var_2715 = _loc1_;
