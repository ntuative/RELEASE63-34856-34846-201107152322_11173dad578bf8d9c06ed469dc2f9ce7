package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_320:uint = 3;
      
      public static const const_669:uint = 4;
      
      public static const const_296:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_1021 = new Map();
         this.var_1239 = false;
         this.var_2097 = param6;
         this.var_908 = true;
         this.state = const_234;
         this.var_58.setup(param1,param3,param4,param6);
         this.var_58.updateItemList(this.var_819);
         this.var_58.updateItemList(this.var_1545);
      ...
      public function close() : void
      {
         if(this.var_908)
         {
            if(this._state != const_218 && this._state != const_296)
            {
      ...
      {
         this.var_58.setMinimized(param1 != InventoryCategory.const_77);
         this.var_12.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_820 + " OTHER: " + this.var_1239);
         ...
         {
            case const_218:
               if(param1 == const_234 || param1 == const_296)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_58.alertPopup(TradingView.const_1195);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_819)
            {
               this.var_820 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1239 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_58.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_819)
            {
               this.var_58.alertPopup(TradingView.const_1396);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_282.length < const_1878)
         {
