package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_954:ConversationsTabView;
      
      private var var_955:ITextFieldWindow;
      
      private var var_16:IFrameWindow;
      
      private var var_1447:ConversationView;
      ...
      public function refresh() : void
      {
         ...
         this.var_954.refresh();
         this.var_1447.refresh();
         if(this.var_159.conversations.openConversations.length < 1)
         {
            this.var_16.visible = false;
         }
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1447.addMessage(param2);
      }
      ...
      private function prepareContent() : void
      {
         ...
         this.var_954 = new ConversationsTabView(this.var_159,this.var_16);
         this.var_954.refresh();
         this.var_955 = ITextFieldWindow(this.var_16.findChildByName("message_input"));
         this.var_955.addEventListener(WindowKeyboardEvent.const_185,this.onMessageInput);
         this.var_1447 = new ConversationView(this.var_159,this.var_16);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_828,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1217,true);
         this.var_16.center();
      }
      ...
      private function onMessageInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc2_ = 120;
            _loc3_ = this.var_955.text;
            if(_loc3_.length > _loc2_)
            {
               this.var_955.text = _loc3_.substring(0,_loc2_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_955.text;
         ...
         this.var_955.text = "";
         this.var_159.conversations.addMessageAndUpdateView(new Message(Message.const_800,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      
      public function getTabCount() : int
      {
         return this.var_954 == null ? 7 : int(this.var_954.getTabCount());
      }
   }
}
