package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1465:int = 20;
       
      
      private var var_159:HabboMessenger;
      
      private var var_2395:IScrollbarWindow;
      
      private var var_1809:IContainerButtonWindow;
      
      private var var_64:IItemListWindow;
      
      private var var_534:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_159 = param1;
         this.var_1809 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_64 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2395 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1058 + const_1465)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1466;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_534 == null || _loc1_.id != this.var_534.id)
         {
            this.var_534 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_534.followingAllowed)
         {
            this.var_1809.enable();
         }
         else
         {
            this.var_1809.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_64.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_534.messages.length - const_1058);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_534.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_534.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_800 || param3.type == Message.const_837 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_534.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_159.send(new FollowFriendMessageComposer(this.var_534.id));
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_1185)
         {
            return 4294927974;
         }
         if(param1 == Message.const_815)
         {
            return 4293454056;
         }
