package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_206:MessengerView;
      ...
      {
         if(this._windowManager && this._communication && this.var_128 && this._localization && this._friendList && this.var_603 && this._soundManager)
         {
            unlock();
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_206 = new MessengerView(this);
      ...
      public function startConversation(param1:int) : void
      {
         ...
         else
         {
            ...
            this.var_206.openMessenger();
            this.var_206.refresh();
         }
      }
      ...
      public function getAvatarFaceBitmap(param1:String) : BitmapData
      {
         ...
         if(_loc2_)
         {
            _loc3_ = _loc2_.getImage(AvatarSetType.const_58,true);
            _loc2_.dispose();
            return _loc3_;
         }
         return null;
      ...
      {
         return this.var_206 && this.var_206.isMessengerOpen();
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_206)
         {
            if(this.var_206.isMessengerOpen())
            {
               this.var_206.close();
            }
            else
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = this.var_128.getKey("url.prefix",_loc2_);
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_837,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1268,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function addMsg(param1:Message) : void
      {
         ...
         if(!this.var_206.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
               this._soundManager.playSound(HabboSoundTypesEnum.const_1259);
            }
         }
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1185,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
