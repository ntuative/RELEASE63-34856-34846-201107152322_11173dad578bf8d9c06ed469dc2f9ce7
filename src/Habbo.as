package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_18:String = "client.init.start";
      ...
      {
         trackLoginStep(const_10);
         reportCrash("Failed to finalize main swf preloading: " + param1.text + " / HTTP status: " + this.var_8,const_8,null);
      }
